 ...
 *
 * Original C version: Copyright (c) 2009-2010 TJ Holowaychuk <tj@vision-media.ca>
 *                     and clibs contributors.
 * TypeScript translation: Copyright (c) 2026 Scott Moore.
 * Licensed under the MIT License.
 */
import { list_iterator_new, list_iterator_next, list_iterator_destroy } from "./list_iterator.js";
...
export const LIST_HEAD: number = 0;
export const LIST_TAIL: number = 1;

type list_direction_t = number;
// BRIDGE: struct-as-class — C17 §6.7.2.1 / C++20 [class]
export class list_node {
  prev: list_node | null;
  next: list_node | null;
  val: any | null;
  constructor() {
...
(list_node as any).__fieldTypes = ["int64","int64","int64"];
(list_node as any).__fieldNames = ["prev","next","val"];
(list_node as any).__fieldOffsets = [0,8,16];

// BRIDGE: struct-as-class — C17 §6.7.2.1 / C++20 [class]
export class list_t {
  head: list_node_t | null;
  tail: list_node_t | null;
  len: number;
  free: (arg0: any | null) => void;
  match: (arg0: any | null, arg1: any | null) => number;
  constructor() {
    this.head = null;
    this.tail = null;
    this.len = 0;
...
(list_t as any).__fieldTypes = ["int64","int64","int32","int32","int32"];
(list_t as any).__fieldNames = ["head","tail","len","free","match"];
(list_t as any).__fieldOffsets = [0,8,16,24,32];

// BRIDGE: struct-as-class — C17 §6.7.2.1 / C++20 [class]
export class list_iterator_t {
  next: list_node_t | null;
  direction: list_direction_t;
  constructor() {
    this.next = null;
    this.direction = undefined;
  }
}
(list_iterator_t as any).__fieldTypes = ["int64","int32"];
(list_iterator_t as any).__fieldNames = ["next","direction"];
(list_iterator_t as any).__fieldOffsets = [0,8];

export function list_new(): list_t | null {
  let self = null;
  if (!(self = (new list_t()))) {
    return null;
  }
  (__struct_ptr_at(self, 0)).head = null;
  (__struct_ptr_at(self, 0)).tail = null;
  (__struct_ptr_at(self, 0)).free = null;
  (__struct_ptr_at(self, 0)).match = null;
  (__struct_ptr_at(self, 0)).len = ((0) >>> 0);
  return self;
}

export function list_destroy(self: list_t | null): void {
  let len = (((__struct_ptr_at(self, 0)).len) >>> 0);
  let next = null;
  let curr = (__struct_ptr_at(self, 0)).head; /* &ref */
  while ((() => { const _t = len; len = u32(len - 1); return _t; })()) {
    next = (__struct_ptr_at(curr, 0)).next;
    if ((__struct_ptr_at(self, 0)).free) {
      (__struct_ptr_at(self, 0)).free((__struct_ptr_at(curr, 0)).val);
    }
    free(curr);
    curr = next;
  }
...
export function list_rpush(self: list_t | null, node: list_node_t | null): list_node_t | null {
  if (!node) {
    return null;
  }
  if ((((__struct_ptr_at(self, 0)).len) >>> 0)) {
    (__struct_ptr_at(node, 0)).prev = (__struct_ptr_at(self, 0)).tail;
    (__struct_ptr_at(node, 0)).next = null;
    (__struct_ptr_at((__struct_ptr_at(self, 0)).tail, 0)).next = node;
    (__struct_ptr_at(self, 0)).tail = node;
  } else {
    (__struct_ptr_at(self, 0)).head = (__struct_ptr_at(self, 0)).tail = node;
    (__struct_ptr_at(node, 0)).prev = (__struct_ptr_at(node, 0)).next = null;
  }
  ((__struct_ptr_at(self, 0)).len = u32((__struct_ptr_at(self, 0)).len + 1));
  return node;
}

export function list_rpop(self: list_t | null): list_node_t | null {
  if (!(((__struct_ptr_at(self, 0)).len) >>> 0)) {
    return null;
  }
  let node = (__struct_ptr_at(self, 0)).tail; /* &ref */
  if (((__struct_ptr_at(self, 0)).len = u32((__struct_ptr_at(self, 0)).len - 1))) {
    ((__struct_ptr_at(self, 0)).tail = (__struct_ptr_at(node, 0)).prev).next = null;
  } else {
    (__struct_ptr_at(self, 0)).tail = (__struct_ptr_at(self, 0)).head = null;
  }
  (__struct_ptr_at(node, 0)).next = (__struct_ptr_at(node, 0)).prev = null;
  return node;
}

export function list_lpop(self: list_t | null): list_node_t | null {
  if (!(((__struct_ptr_at(self, 0)).len) >>> 0)) {
    return null;
  }
  let node = (__struct_ptr_at(self, 0)).head; /* &ref */
  if (((__struct_ptr_at(self, 0)).len = u32((__struct_ptr_at(self, 0)).len - 1))) {
    ((__struct_ptr_at(self, 0)).head = (__struct_ptr_at(node, 0)).next).prev = null;
  } else {
    (__struct_ptr_at(self, 0)).head = (__struct_ptr_at(self, 0)).tail = null;
  }
  (__struct_ptr_at(node, 0)).next = (__struct_ptr_at(node, 0)).prev = null;
  return node;
}

export function list_lpush(self: list_t | null, node: list_node_t | null): list_node_t | null {
  if (!node) {
    return null;
  }
  if ((((__struct_ptr_at(self, 0)).len) >>> 0)) {
    (__struct_ptr_at(node, 0)).next = (__struct_ptr_at(self, 0)).head;
    (__struct_ptr_at(node, 0)).prev = null;
    (__struct_ptr_at((__struct_ptr_at(self, 0)).head, 0)).prev = node;
    (__struct_ptr_at(self, 0)).head = node;
  } else {
    (__struct_ptr_at(self, 0)).head = (__struct_ptr_at(self, 0)).tail = node;
    (__struct_ptr_at(node, 0)).prev = (__struct_ptr_at(node, 0)).next = null;
  }
...
export function list_find(self: list_t | null, val: any | null): list_node_t | null {
  let it = list_iterator_new(self, LIST_HEAD); /* &ref */
  let node = null;
  while ((node = list_iterator_next(it))) {
    if ((__struct_ptr_at(self, 0)).match) {
      if ((__struct_ptr_at(self, 0)).match(val, (__struct_ptr_at(node, 0)).val)) {
        list_iterator_destroy(it);
        return node;
      }
    } else {
      if (cptr_eq(val, (__struct_ptr_at(node, 0)).val)) {
        list_iterator_destroy(it);
        return node;
      }
    }
...
export function list_at(self: list_t | null, index: number): list_node_t | null {
  let direction = LIST_HEAD;
  if (index < 0) {
    direction = LIST_TAIL;
    index = ~index;
  }
  if (((Math.trunc(+(index))) >>> 0) < (((__struct_ptr_at(self, 0)).len) >>> 0)) {
    let it = list_iterator_new(self, direction); /* &ref */
    let node = list_iterator_next(it); /* &ref */
    while (index--) {
...
export function list_remove(self: list_t | null, node: list_node_t | null): void {
  ((__struct_ptr_at(node, 0)).prev ? ((__struct_ptr_at((__struct_ptr_at(node, 0)).prev, 0)).next = (__struct_ptr_at(node, 0)).next) : ((__struct_ptr_at(self, 0)).head = (__struct_ptr_at(node, 0)).next));
  ((__struct_ptr_at(node, 0)).next ? ((__struct_ptr_at((__struct_ptr_at(node, 0)).next, 0)).prev = (__struct_ptr_at(node, 0)).prev) : ((__struct_ptr_at(self, 0)).tail = (__struct_ptr_at(node, 0)).prev));
  if ((__struct_ptr_at(self, 0)).free) {
    (__struct_ptr_at(self, 0)).free((__struct_ptr_at(node, 0)).val);
  }
  free(node);
  ((__struct_ptr_at(self, 0)).len = u32((__struct_ptr_at(self, 0)).len - 1));
}