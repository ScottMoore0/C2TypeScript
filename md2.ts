...
export class MD2_CTX {
  [k: string]: any;
  data: any = cptr_create(16);
  state: any = cptr_create(48);
  checksum: any = cptr_create(16);
  len: number;
  constructor() {
    this.data = cptr_create(16);
    this.state = cptr_create(48);
    this.checksum = cptr_create(16);
    this.len = 0;
  }
}
(MD2_CTX as any).__fieldTypes = ["bytes","bytes","bytes","int32"];
(MD2_CTX as any).__fieldNames = ["data","state","checksum","len"];
(MD2_CTX as any).__fieldOffsets = [0,128,512,640];

let s = (() => { const __b = cptr_create(256); __b.buf[0] = (((41) & 0xFF)) & 0xFF; __b.buf[1] = (((46) & 0xFF)) & 0xFF; __b.buf[2] = (((67) & 0xFF)) & 0xFF; __b.buf[3] = (((201) & 0xFF)) & 0xFF; __b.buf[4] = (((162) & 0xFF)) & 0xFF; __b.buf[5] = (((216) & 0xFF)) & 0xFF; __b.buf[6] = (((124) & 0xFF)) & 0xFF; __b.buf[7] = (((1) & 0xFF)) & 0xFF; __b.buf[8] = (((61) & 0xFF)) & 0xFF; __b.buf[9] = (((54) & 0xFF)) & 0xFF; __b.buf[10] = (((84) & 0xFF)) & 0xFF; __b.buf[11] = (((161) & 0xFF)) & 0xFF; __b.buf[12] = (((236) & 0xFF)) & 0xFF; __b.buf[13] = (((240) & 0xFF)) & 0xFF; __b.buf[14] = (((6) & 0xFF)) & 0xFF; __b.buf[15] = (((19) & 0xFF)) & 0xFF; __b.buf[16] = (((98) & 0xFF)) & 0xFF; __b.buf[17] = (((167) & 0xFF)) & 0xFF; __b.buf[18] = (((5) & 0xFF)) & 0xFF; __b.buf[19] = (((243) & 0xFF)) & 0xFF; __b.buf[20] = (((192) & 0xFF)) & 0xFF; __b.buf[21] = (((199) & 0xFF)) & 0xFF; __b.buf[22] = (((115) & 0xFF)) & 0xFF; __b.buf[23] = (((140) & 0xFF)) & 0xFF; __b.buf[24] = (((152) & 0xFF)) & 0xFF; __b.buf[25] = (((147) & 0xFF)) & 0xFF; __b.buf[26] = (((43) & 0xFF)) & 0xFF; __b.buf[27] = (((217) & 0xFF)) & 0xFF; __b.buf[28] = (((188) & 0xFF)) & 0xFF; __b.buf[29] = (((76) & 0xFF)) & 0xFF; __b.buf[30] = (((130) & 0xFF)) & 0xFF; __b.buf[31] = (((202) & 0xFF)) & 0xFF; __b.buf[32] = (((30) & 0xFF)) & 0xFF; __b.buf[33] = (((155) & 0xFF)) & 0xFF; __b.buf[34] = (((87) & 0xFF)) & 0xFF; __b.buf[35] = (((60) & 0xFF)) & 0xFF; __b.buf[36] = (((253) & 0xFF)) & 0xFF; __b.buf[37] = (((212) & 0xFF)) & 0xFF; __b.buf[38] = (((224) & 0xFF)) & 0xFF; __b.buf[39] = (((22) & 0xFF)) & 0xFF; __b.buf[40] = (((103) & 0xFF)) & 0xFF; __b.buf[41] = (((66) & 0xFF)) & 0xFF; __b.buf[42] = (((111) & 0xFF)) & 0xFF; __b.buf[43] = (((24) & 0xFF)) & 0xFF; __b.buf[44] = (((138) & 0xFF)) & 0xFF; __b.buf[45] = (((23) & 0xFF)) & 0xFF; __b.buf[46] = (((229) & 0xFF)) & 0xFF; __b.buf[47] = (((18) & 0xFF)) & 0xFF; __b.buf[48] = (((190) & 0xFF)) & 0xFF; __b.buf[49] = (((78) & 0xFF)) & 0xFF; __b.buf[50] = (((196) & 0xFF)) & 0xFF; __b.buf[51] = (((214) & 0xFF)) & 0xFF; __b.buf[52] = (((218) & 0xFF)) & 0xFF; __b.buf[53] = (((158) & 0xFF)) & 0xFF; __b.buf[54] = (((222) & 0xFF)) & 0xFF; __b.buf[55] = (((73) & 0xFF)) & 0xFF; __b.buf[56] = (((160) & 0xFF)) & 0xFF; __b.buf[57] = (((251) & 0xFF)) & 0xFF; __b.buf[58] = (((245) & 0xFF)) & 0xFF; __b.buf[59] = (((142) & 0xFF)) & 0xFF; __b.buf[60] = (((187) & 0xFF)) & 0xFF; __b.buf[61] = (((47) & 0xFF)) & 0xFF; __b.buf[62] = (((238) & 0xFF)) & 0xFF; __b.buf[63] = (((122) & 0xFF)) & 0xFF; __b.buf[64] = (((169) & 0xFF)) & 0xFF; __b.buf[65] = (((104) & 0xFF)) & 0xFF; __b.buf[66] = (((121) & 0xFF)) & 0xFF; __b.buf[67] = (((145) & 0xFF)) & 0xFF; __b.buf[68] = (((21) & 0xFF)) & 0xFF; __b.buf[69] = (((178) & 0xFF)) & 0xFF; __b.buf[70] = (((7) & 0xFF)) & 0xFF; __b.buf[71] = (((63) & 0xFF)) & 0xFF; __b.buf[72] = (((148) & 0xFF)) & 0xFF; __b.buf[73] = (((194) & 0xFF)) & 0xFF; __b.buf[74] = (((16) & 0xFF)) & 0xFF; __b.buf[75] = (((137) & 0xFF)) & 0xFF; __b.buf[76] = (((11) & 0xFF)) & 0xFF; __b.buf[77] = (((34) & 0xFF)) & 0xFF; __b.buf[78] = (((95) & 0xFF)) & 0xFF; __b.buf[79] = (((33) & 0xFF)) & 0xFF; __b.buf[80] = (((128) & 0xFF)) & 0xFF; __b.buf[81] = (((127) & 0xFF)) & 0xFF; __b.buf[82] = (((93) & 0xFF)) & 0xFF; __b.buf[83] = (((154) & 0xFF)) & 0xFF; __b.buf[84] = (((90) & 0xFF)) & 0xFF; __b.buf[85] = (((144) & 0xFF)) & 0xFF; __b.buf[86] = (((50) & 0xFF)) & 0xFF; __b.buf[87] = (((39) & 0xFF)) & 0xFF; __b.buf[88] = (((53) & 0xFF)) & 0xFF; __b.buf[89] = (((62) & 0xFF)) & 0xFF; __b.buf[90] = (((204) & 0xFF)) & 0xFF; __b.buf[91] = (((231) & 0xFF)) & 0xFF; __b.buf[92] = (((191) & 0xFF)) & 0xFF; __b.buf[93] = (((247) & 0xFF)) & 0xFF; __b.buf[94] = (((151) & 0xFF)) & 0xFF; __b.buf[95] = (((3) & 0xFF)) & 0xFF; __b.buf[96] = (((255) & 0xFF)) & 0xFF; __b.buf[97] = (((25) & 0xFF)) & 0xFF; __b.buf[98] = (((48) & 0xFF)) & 0xFF; __b.buf[99] = (((179) & 0xFF)) & 0xFF; __b.buf[100] = (((72) & 0xFF)) & 0xFF; __b.buf[101] = (((165) & 0xFF)) & 0xFF; __b.buf[102] = (((181) & 0xFF)) & 0xFF; __b.buf[103] = (((209) & 0xFF)) & 0xFF; __b.buf[104] = (((215) & 0xFF)) & 0xFF; __b.buf[105] = (((94) & 0xFF)) & 0xFF; __b.buf[106] = (((146) & 0xFF)) & 0xFF; __b.buf[107] = (((42) & 0xFF)) & 0xFF; __b.buf[108] = (((172) & 0xFF)) & 0xFF; __b.buf[109] = (((86) & 0xFF)) & 0xFF; __b.buf[110] = (((170) & 0xFF)) & 0xFF; __b.buf[111] = (((198) & 0xFF)) & 0xFF; __b.buf[112] = (((79) & 0xFF)) & 0xFF; __b.buf[113] = (((184) & 0xFF)) & 0xFF; __b.buf[114] = (((56) & 0xFF)) & 0xFF; __b.buf[115] = (((210) & 0xFF)) & 0xFF; __b.buf[116] = (((150) & 0xFF)) & 0xFF; __b.buf[117] = (((164) & 0xFF)) & 0xFF; __b.buf[118] = (((125) & 0xFF)) & 0xFF; __b.buf[119] = (((182) & 0xFF)) & 0xFF; __b.buf[120] = (((118) & 0xFF)) & 0xFF; __b.buf[121] = (((252) & 0xFF)) & 0xFF; __b.buf[122] = (((107) & 0xFF)) & 0xFF; __b.buf[123] = (((226) & 0xFF)) & 0xFF; __b.buf[124] = (((156) & 0xFF)) & 0xFF; __b.buf[125] = (((116) & 0xFF)) & 0xFF; __b.buf[126] = (((4) & 0xFF)) & 0xFF; __b.buf[127] = (((241) & 0xFF)) & 0xFF; __b.buf[128] = (((69) & 0xFF)) & 0xFF; __b.buf[129] = (((157) & 0xFF)) & 0xFF; __b.buf[130] = (((112) & 0xFF)) & 0xFF; __b.buf[131] = (((89) & 0xFF)) & 0xFF; __b.buf[132] = (((100) & 0xFF)) & 0xFF; __b.buf[133] = (((113) & 0xFF)) & 0xFF; __b.buf[134] = (((135) & 0xFF)) & 0xFF; __b.buf[135] = (((32) & 0xFF)) & 0xFF; __b.buf[136] = (((134) & 0xFF)) & 0xFF; __b.buf[137] = (((91) & 0xFF)) & 0xFF; __b.buf[138] = (((207) & 0xFF)) & 0xFF; __b.buf[139] = (((101) & 0xFF)) & 0xFF; __b.buf[140] = (((230) & 0xFF)) & 0xFF; __b.buf[141] = (((45) & 0xFF)) & 0xFF; __b.buf[142] = (((168) & 0xFF)) & 0xFF; __b.buf[143] = (((2) & 0xFF)) & 0xFF; __b.buf[144] = (((27) & 0xFF)) & 0xFF; __b.buf[145] = (((96) & 0xFF)) & 0xFF; __b.buf[146] = (((37) & 0xFF)) & 0xFF; __b.buf[147] = (((173) & 0xFF)) & 0xFF; __b.buf[148] = (((174) & 0xFF)) & 0xFF; __b.buf[149] = (((176) & 0xFF)) & 0xFF; __b.buf[150] = (((185) & 0xFF)) & 0xFF; __b.buf[151] = (((246) & 0xFF)) & 0xFF; __b.buf[152] = (((28) & 0xFF)) & 0xFF; __b.buf[153] = (((70) & 0xFF)) & 0xFF; __b.buf[154] = (((97) & 0xFF)) & 0xFF; __b.buf[155] = (((105) & 0xFF)) & 0xFF; __b.buf[156] = (((52) & 0xFF)) & 0xFF; __b.buf[157] = (((64) & 0xFF)) & 0xFF; __b.buf[158] = (((126) & 0xFF)) & 0xFF; __b.buf[159] = (((15) & 0xFF)) & 0xFF; __b.buf[160] = (((85) & 0xFF)) & 0xFF; __b.buf[161] = (((71) & 0xFF)) & 0xFF; __b.buf[162] = (((163) & 0xFF)) & 0xFF; __b.buf[163] = (((35) & 0xFF)) & 0xFF; __b.buf[164] = (((221) & 0xFF)) & 0xFF; __b.buf[165] = (((81) & 0xFF)) & 0xFF; __b.buf[166] = (((175) & 0xFF)) & 0xFF; __b.buf[167] = (((58) & 0xFF)) & 0xFF; __b.buf[168] = (((195) & 0xFF)) & 0xFF; __b.buf[169] = (((92) & 0xFF)) & 0xFF; __b.buf[170] = (((249) & 0xFF)) & 0xFF; __b.buf[171] = (((206) & 0xFF)) & 0xFF; __b.buf[172] = (((186) & 0xFF)) & 0xFF; __b.buf[173] = (((197) & 0xFF)) & 0xFF; __b.buf[174] = (((234) & 0xFF)) & 0xFF; __b.buf[175] = (((38) & 0xFF)) & 0xFF; __b.buf[176] = (((44) & 0xFF)) & 0xFF; __b.buf[177] = (((83) & 0xFF)) & 0xFF; __b.buf[178] = (((13) & 0xFF)) & 0xFF; __b.buf[179] = (((110) & 0xFF)) & 0xFF; __b.buf[180] = (((133) & 0xFF)) & 0xFF; __b.buf[181] = (((40) & 0xFF)) & 0xFF; __b.buf[182] = (((132) & 0xFF)) & 0xFF; __b.buf[183] = (((9) & 0xFF)) & 0xFF; __b.buf[184] = (((211) & 0xFF)) & 0xFF; __b.buf[185] = (((223) & 0xFF)) & 0xFF; __b.buf[186] = (((205) & 0xFF)) & 0xFF; __b.buf[187] = (((244) & 0xFF)) & 0xFF; __b.buf[188] = (((65) & 0xFF)) & 0xFF; __b.buf[189] = (((129) & 0xFF)) & 0xFF; __b.buf[190] = (((77) & 0xFF)) & 0xFF; __b.buf[191] = (((82) & 0xFF)) & 0xFF; __b.buf[192] = (((106) & 0xFF)) & 0xFF; __b.buf[193] = (((220) & 0xFF)) & 0xFF; __b.buf[194] = (((55) & 0xFF)) & 0xFF; __b.buf[195] = (((200) & 0xFF)) & 0xFF; __b.buf[196] = (((108) & 0xFF)) & 0xFF; __b.buf[197] = (((193) & 0xFF)) & 0xFF; __b.buf[198] = (((171) & 0xFF)) & 0xFF; __b.buf[199] = (((250) & 0xFF)) & 0xFF; __b.buf[200] = (((36) & 0xFF)) & 0xFF; __b.buf[201] = (((225) & 0xFF)) & 0xFF; __b.buf[202] = (((123) & 0xFF)) & 0xFF; __b.buf[203] = (((8) & 0xFF)) & 0xFF; __b.buf[204] = (((12) & 0xFF)) & 0xFF; __b.buf[205] = (((189) & 0xFF)) & 0xFF; __b.buf[206] = (((177) & 0xFF)) & 0xFF; __b.buf[207] = (((74) & 0xFF)) & 0xFF; __b.buf[208] = (((120) & 0xFF)) & 0xFF; __b.buf[209] = (((136) & 0xFF)) & 0xFF; __b.buf[210] = (((149) & 0xFF)) & 0xFF; __b.buf[211] = (((139) & 0xFF)) & 0xFF; __b.buf[212] = (((227) & 0xFF)) & 0xFF; __b.buf[213] = (((99) & 0xFF)) & 0xFF; __b.buf[214] = (((232) & 0xFF)) & 0xFF; __b.buf[215] = (((109) & 0xFF)) & 0xFF; __b.buf[216] = (((233) & 0xFF)) & 0xFF; __b.buf[217] = (((203) & 0xFF)) & 0xFF; __b.buf[218] = (((213) & 0xFF)) & 0xFF; __b.buf[219] = (((254) & 0xFF)) & 0xFF; __b.buf[220] = (((59) & 0xFF)) & 0xFF; __b.buf[221] = (((0) & 0xFF)) & 0xFF; __b.buf[222] = (((29) & 0xFF)) & 0xFF; __b.buf[223] = (((57) & 0xFF)) & 0xFF; __b.buf[224] = (((242) & 0xFF)) & 0xFF; __b.buf[225] = (((239) & 0xFF)) & 0xFF; __b.buf[226] = (((183) & 0xFF)) & 0xFF; __b.buf[227] = (((14) & 0xFF)) & 0xFF; __b.buf[228] = (((102) & 0xFF)) & 0xFF; __b.buf[229] = (((88) & 0xFF)) & 0xFF; __b.buf[230] = (((208) & 0xFF)) & 0xFF; __b.buf[231] = (((228) & 0xFF)) & 0xFF; __b.buf[232] = (((166) & 0xFF)) & 0xFF; __b.buf[233] = (((119) & 0xFF)) & 0xFF; __b.buf[234] = (((114) & 0xFF)) & 0xFF; __b.buf[235] = (((248) & 0xFF)) & 0xFF; __b.buf[236] = (((235) & 0xFF)) & 0xFF; __b.buf[237] = (((117) & 0xFF)) & 0xFF; __b.buf[238] = (((75) & 0xFF)) & 0xFF; __b.buf[239] = (((10) & 0xFF)) & 0xFF; __b.buf[240] = (((49) & 0xFF)) & 0xFF; __b.buf[241] = (((68) & 0xFF)) & 0xFF; __b.buf[242] = (((80) & 0xFF)) & 0xFF; __b.buf[243] = (((180) & 0xFF)) & 0xFF; __b.buf[244] = (((143) & 0xFF)) & 0xFF; __b.buf[245] = (((237) & 0xFF)) & 0xFF; __b.buf[246] = (((31) & 0xFF)) & 0xFF; __b.buf[247] = (((26) & 0xFF)) & 0xFF; __b.buf[248] = (((219) & 0xFF)) & 0xFF; __b.buf[249] = (((153) & 0xFF)) & 0xFF; __b.buf[250] = (((141) & 0xFF)) & 0xFF; __b.buf[251] = (((51) & 0xFF)) & 0xFF; __b.buf[252] = (((159) & 0xFF)) & 0xFF; __b.buf[253] = (((17) & 0xFF)) & 0xFF; __b.buf[254] = (((131) & 0xFF)) & 0xFF; __b.buf[255] = (((20) & 0xFF)) & 0xFF; return __b; })();
export function md2_transform(ctx: MD2_CTX | null, data: any | null): void {
  ...
  let t = 0;
  for (j = 0; (j < 16 ? 1 : 0); ++j) {
    (__struct_ptr_at(ctx, 0)).state.buf[((__struct_ptr_at(ctx, 0)).state.off ?? 0) + i32(j + 16)] = ((data.buf[(data.off ?? 0) + j]) & 0xFF);
    (__struct_ptr_at(ctx, 0)).state.buf[((__struct_ptr_at(ctx, 0)).state.off ?? 0) + i32(j + 32)] = ((((((__struct_ptr_at(ctx, 0)).state.buf[((__struct_ptr_at(ctx, 0)).state.off ?? 0) + i32(j + 16)]) & 0xFF) ^ (((__struct_ptr_at(ctx, 0)).state.buf[((__struct_ptr_at(ctx, 0)).state.off ?? 0) + j]) & 0xFF))) & 0xFF);
  }
  t = 0;
  for (j = 0; (j < 18 ? 1 : 0); ++j) {
    for (k = 0; (k < 48 ? 1 : 0); ++k) {
      (__struct_ptr_at(ctx, 0)).state.buf[((__struct_ptr_at(ctx, 0)).state.off ?? 0) + k] ^= ((s.buf[(s.off ?? 0) + t]) & 0xFF);
      t = (((__struct_ptr_at(ctx, 0)).state.buf[((__struct_ptr_at(ctx, 0)).state.off ?? 0) + k]) & 0xFF);
    }
    t = (i32(t + j)) & 255;
  }
  t = (((__struct_ptr_at(ctx, 0)).checksum.buf[((__struct_ptr_at(ctx, 0)).checksum.off ?? 0) + 15]) & 0xFF);
  for (j = 0; (j < 16 ? 1 : 0); ++j) {
    (__struct_ptr_at(ctx, 0)).checksum.buf[((__struct_ptr_at(ctx, 0)).checksum.off ?? 0) + j] ^= ((s.buf[(s.off ?? 0) + ((data.buf[(data.off ?? 0) + j]) & 0xFF) ^ t]) & 0xFF);
    t = (((__struct_ptr_at(ctx, 0)).checksum.buf[((__struct_ptr_at(ctx, 0)).checksum.off ?? 0) + j]) & 0xFF);
  }
}

export function md2_init(ctx: MD2_CTX | null): void {
  let i = 0;
  for (i = 0; (i < 48 ? 1 : 0); ++i) {
    (__struct_ptr_at(ctx, 0)).state.buf[((__struct_ptr_at(ctx, 0)).state.off ?? 0) + i] = ((0) & 0xFF);
  }
  for (i = 0; (i < 16 ? 1 : 0); ++i) {
    (__struct_ptr_at(ctx, 0)).checksum.buf[((__struct_ptr_at(ctx, 0)).checksum.off ?? 0) + i] = ((0) & 0xFF);
  }
  (__struct_ptr_at(ctx, 0)).len = 0;
}

export function md2_update(ctx: MD2_CTX | null, data: any | null, len: number): void {
  if (typeof data === 'string') data = cptr_from_string(data);

  let i = 0;
  for (i = ((0) >>> 0); (((i) >>> 0) < ((len) >>> 0) ? 1 : 0); (i = u32(i + 1))) {
    (__struct_ptr_at(ctx, 0)).data.buf[((__struct_ptr_at(ctx, 0)).data.off ?? 0) + (__struct_ptr_at(ctx, 0)).len] = ((data.buf[(data.off ?? 0) + ((i) >>> 0)]) & 0xFF);
    (__struct_ptr_at(ctx, 0)).len++;
    if (((__struct_ptr_at(ctx, 0)).len == 16 ? 1 : 0)) {
      md2_transform(ctx, (__struct_ptr_at(ctx, 0)).data);
      (__struct_ptr_at(ctx, 0)).len = 0;
    }
  }
}

export function md2_final(ctx: MD2_CTX | null, hash: any | null): void {
  let to_pad = 0;
  to_pad = i32(16 - (__struct_ptr_at(ctx, 0)).len);
  while (((__struct_ptr_at(ctx, 0)).len < 16 ? 1 : 0)) {
    (__struct_ptr_at(ctx, 0)).data.buf[((__struct_ptr_at(ctx, 0)).data.off ?? 0) + (__struct_ptr_at(ctx, 0)).len++] = ((to_pad) & 0xFF);
  }
  md2_transform(ctx, (__struct_ptr_at(ctx, 0)).data);
  md2_transform(ctx, (__struct_ptr_at(ctx, 0)).checksum);
  memcpy(hash, (__struct_ptr_at(ctx, 0)).state, 16);
}
