...
export let SetToOneToFailInTearDown = 0;
export let SetToOneMeanWeAlreadyCheckedThisGuy = 0;
...
export function test_TheseShouldAllPass(Num: number): void {
}

export function test_TheseShouldAllFail(Num: number): void {
  if (undefined /* recovery */) {
  }
  if (undefined /* recovery */) {
...
export function test_TheseAreEveryOther(Num: number): void {
  if (Num & 1) {
    if (undefined /* recovery */) {
    }
    if (undefined /* recovery */) {
...
export function test_NormalPassesStillWork(): void {
}

export function test_NormalFailsStillWork(): void {
  if (undefined /* recovery */) {
  }
  if (undefined /* recovery */) {
    SetToOneMeanWeAlreadyCheckedThisGuy = 1;
