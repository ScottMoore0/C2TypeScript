...
export function AssertEqualExampleStruct(expected: number, actual: number, line: number): void {
  UNITY_TEST_ASSERT_EQUAL_INT(undefined /* recovery */, undefined /* recovery */, line, "Example Struct Failed For Field x");
  UNITY_TEST_ASSERT_EQUAL_INT(undefined /* recovery */, undefined /* recovery */, line, "Example Struct Failed For Field y");
}
