...
import { UnityAssertEqualNumber, UnityBegin, UnityDefaultTestRun, UnityEnd } from './unity.js';
...
function parse_hex4_should_parse_all_combinations(): void {
  let number = ((0) >>> 0);
  let digits_lower = cptr_create(6);
  let digits_upper = cptr_create(6);
  for (number = ((0) >>> 0); ((number) >>> 0) <= ((65535) >>> 0); (() => { const _t = number; number = u32(number + 1); return _t; })()) {
    UnityAssertEqualNumber(__i64(__as_bigint(((4)))), __i64(__as_bigint((((() => { const __s = printf_format("%.4x", ((number) >>> 0)); strcpy((digits_lower), __s); return __s.length; })())))), (("sprintf failed.")), __u64(__as_bigint((39))), UNITY_DISPLAY_STYLE_INT);
    UnityAssertEqualNumber(__i64(__as_bigint(((4)))), __i64(__as_bigint((((() => { const __s = printf_format("%.4X", ((number) >>> 0)); strcpy((digits_upper), __s); return __s.length; })())))), (("sprintf failed.")), __u64(__as_bigint((40))), UNITY_DISPLAY_STYLE_INT);
    UnityAssertEqualNumber(__i64(__as_bigint(((((number))) >>> 0))), __i64(__as_bigint(((parse_hex4(cptr_clone(digits_lower)))))), (("Failed to parse lowercase digits.")), __u64(__as_bigint((42))), UNITY_DISPLAY_STYLE_INT);
    UnityAssertEqualNumber(__i64(__as_bigint(((((number))) >>> 0))), __i64(__as_bigint(((parse_hex4(cptr_clone(digits_upper)))))), (("Failed to parse uppercase digits.")), __u64(__as_bigint((43))), UNITY_DISPLAY_STYLE_INT);
  }
}

function parse_hex4_should_parse_mixed_case(): void {
  UnityAssertEqualNumber(__i64(__as_bigint(((48879)))), __i64(__as_bigint(((parse_hex4(("beef")))))), null, __u64(__as_bigint((49))), UNITY_DISPLAY_STYLE_INT);
  UnityAssertEqualNumber(__i64(__as_bigint(((48879)))), __i64(__as_bigint(((parse_hex4(("beeF")))))), null, __u64(__as_bigint((50))), UNITY_DISPLAY_STYLE_INT);
  UnityAssertEqualNumber(__i64(__as_bigint(((48879)))), __i64(__as_bigint(((parse_hex4(("beEf")))))), null, __u64(__as_bigint((51))), UNITY_DISPLAY_STYLE_INT);
  UnityAssertEqualNumber(__i64(__as_bigint(((48879)))), __i64(__as_bigint(((parse_hex4(("beEF")))))), null, __u64(__as_bigint((52))), UNITY_DISPLAY_STYLE_INT);
  UnityAssertEqualNumber(__i64(__as_bigint(((48879)))), __i64(__as_bigint(((parse_hex4(("bEef")))))), null, __u64(__as_bigint((53))), UNITY_DISPLAY_STYLE_INT);
  UnityAssertEqualNumber(__i64(__as_bigint(((48879)))), __i64(__as_bigint(((parse_hex4(("bEeF")))))), null, __u64(__as_bigint((54))), UNITY_DISPLAY_STYLE_INT);
  UnityAssertEqualNumber(__i64(__as_bigint(((48879)))), __i64(__as_bigint(((parse_hex4(("bEEf")))))), null, __u64(__as_bigint((55))), UNITY_DISPLAY_STYLE_INT);
  UnityAssertEqualNumber(__i64(__as_bigint(((48879)))), __i64(__as_bigint(((parse_hex4(("bEEF")))))), null, __u64(__as_bigint((56))), UNITY_DISPLAY_STYLE_INT);
  UnityAssertEqualNumber(__i64(__as_bigint(((48879)))), __i64(__as_bigint(((parse_hex4(("Beef")))))), null, __u64(__as_bigint((57))), UNITY_DISPLAY_STYLE_INT);
  UnityAssertEqualNumber(__i64(__as_bigint(((48879)))), __i64(__as_bigint(((parse_hex4(("BeeF")))))), null, __u64(__as_bigint((58))), UNITY_DISPLAY_STYLE_INT);
  UnityAssertEqualNumber(__i64(__as_bigint(((48879)))), __i64(__as_bigint(((parse_hex4(("BeEf")))))), null, __u64(__as_bigint((59))), UNITY_DISPLAY_STYLE_INT);
  UnityAssertEqualNumber(__i64(__as_bigint(((48879)))), __i64(__as_bigint(((parse_hex4(("BeEF")))))), null, __u64(__as_bigint((60))), UNITY_DISPLAY_STYLE_INT);
  UnityAssertEqualNumber(__i64(__as_bigint(((48879)))), __i64(__as_bigint(((parse_hex4(("BEef")))))), null, __u64(__as_bigint((61))), UNITY_DISPLAY_STYLE_INT);
  UnityAssertEqualNumber(__i64(__as_bigint(((48879)))), __i64(__as_bigint(((parse_hex4(("BEeF")))))), null, __u64(__as_bigint((62))), UNITY_DISPLAY_STYLE_INT);
  UnityAssertEqualNumber(__i64(__as_bigint(((48879)))), __i64(__as_bigint(((parse_hex4(("BEEf")))))), null, __u64(__as_bigint((63))), UNITY_DISPLAY_STYLE_INT);
  UnityAssertEqualNumber(__i64(__as_bigint(((48879)))), __i64(__as_bigint(((parse_hex4(("BEEF")))))), null, __u64(__as_bigint((64))), UNITY_DISPLAY_STYLE_INT);
}

export function main(): number {
  UnityBegin("tests/real-world/cjson/tests/parse_hex4.c");
  UnityDefaultTestRun((parse_hex4_should_parse_all_combinations), "parse_hex4_should_parse_all_combinations", (70));
  UnityDefaultTestRun((parse_hex4_should_parse_mixed_case), "parse_hex4_should_parse_mixed_case", (71));
  return UnityEnd();
}
