...
import { cJSONUtils_ApplyPatchesCaseSensitive, cJSONUtils_GeneratePatchesCaseSensitive } from './cJSON_Utils.js';
...
function parse_test_file(filename: string): cJSON | null {
  let file = null; /* &ref */
  let json = null; /* &ref */
  file = read_file(cptr_clone(filename));
  if ((!cptr_eq(((file)), (null)))) {
  } else {
    UnityFail((((("Failed to read file.")))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((38))))))))));
  }
  json = cJSON_Parse(cptr_clone(file));
  if ((((json)) != (null))) {
  } else {
    UnityFail((((("Failed to parse test json.")))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((41))))))))));
  }
  if ((cJSON_IsArray(json))) {
  } else {
    UnityFail(((("Json is not an array."))), __u64(__as_bigint((__u64(__as_bigint((42)))))));
  }
  free(file);
  return json;
}

function test_apply_patch(test: cJSON | null): cJSON_bool {
  let doc = null; /* &ref */
  let patch = null; /* &ref */
  let expected = null; /* &ref */
  let error_element = null; /* &ref */
  let comment = null; /* &ref */
  let disabled = null; /* &ref */
  let object = null; /* &ref */
  let successful = (Math.trunc(+(0)));
  comment = cJSON_GetObjectItemCaseSensitive(test, "comment");
  if (cJSON_IsString(comment)) {
    printf("Testing \"%s\"\n", cptr_clone((__struct_ptr_at(comment, 0)).valuestring));
  } else {
  ...
  if ((((doc)) != (null))) {
    ...
    UnityFail((((("No \"doc\" in the test.")))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((80))))))))));
  }
  patch = cJSON_GetObjectItemCaseSensitive(test, "patch");
  if ((((patch)) != (null))) {
  } else {
    UnityFail((((("No \"patch\"in the test.")))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((82))))))))));
  }
  object = cJSON_Duplicate(doc, (Math.trunc(+(1))));
  if ((((object)) != (null))) {
  } else {
    UnityFail((((" Expected Non-NULL"))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((85))))))))));
  }
  expected = cJSON_GetObjectItemCaseSensitive(test, "expected");
  error_element = cJSON_GetObjectItemCaseSensitive(test, "error");
  if (error_element != (null)) {
    if ((0 != cJSONUtils_ApplyPatchesCaseSensitive(object, patch))) {
    } else {
      UnityFail(((("Test didn't fail as it's supposed to."))), __u64(__as_bigint((__u64(__as_bigint((92)))))));
    }
    successful = (Math.trunc(+(1)));
  } else {
    UnityAssertEqualNumber(__i64(__as_bigint(((0)))), __i64(__as_bigint(((cJSONUtils_ApplyPatchesCaseSensitive(object, patch))))), (("Failed to apply patches.")), __u64(__as_bigint((99))), UNITY_DISPLAY_STYLE_INT);
    successful = (Math.trunc(+(1)));
    if (expected != (null)) {
      successful = cJSON_Compare(object, expected, (Math.trunc(+(1))));
    }
  }
  cJSON_Delete(object);
  if (successful) {
...
function test_generate_test(test: cJSON | null): cJSON_bool {
  let doc = null; /* &ref */
  let patch = null; /* &ref */
  let expected = null; /* &ref */
  let disabled = null; /* &ref */
  ...
  if ((((doc)) != (null))) {
    ...
    UnityFail((((("No \"doc\" in the test.")))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((142))))))))));
  }
  object = cJSON_Duplicate(doc, (Math.trunc(+(1))));
  if ((((object)) != (null))) {
  } else {
    UnityFail((((" Expected Non-NULL"))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((146))))))))));
  }
  expected = cJSON_GetObjectItemCaseSensitive(test, "expected");
  if (expected == (null)) {
    cJSON_Delete(object);
  ...
  if ((((patch)) != (null))) {
    ...
    UnityFail((((("Failed to generate patches.")))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((157))))))))));
  }
  printed_patch = cJSON_Print(patch);
  printf("%s\n", cptr_clone(printed_patch));
  free(printed_patch);
  UnityAssertEqualNumber(__i64(__as_bigint(((0)))), __i64(__as_bigint(((cJSONUtils_ApplyPatchesCaseSensitive(object, patch))))), (("Failed to apply generated patch.")), __u64(__as_bigint((164))), UNITY_DISPLAY_STYLE_INT);
  successful = cJSON_Compare(object, expected, (Math.trunc(+(1))));
  cJSON_Delete(patch);
  cJSON_Delete(object);
  if (successful) {
...
function cjson_utils_should_pass_json_patch_test_tests(): void {
  let tests = parse_test_file("json-patch-tests/tests.json"); /* &ref */
  let test = null; /* &ref */
  let failed = (Math.trunc(+(0)));
  for (test = ((tests != (null)) ? (__struct_ptr_at((tests), 0)).child : null); test != (null); test = (__struct_ptr_at(test, 0)).next) {
  ...
  if (!(failed)) {
    ...
    UnityFail(((("Some tests failed."))), __u64(__as_bigint((__u64(__as_bigint((197)))))));
  }
}

function cjson_utils_should_pass_json_patch_test_spec_tests(): void {
  let tests = parse_test_file("json-patch-tests/spec_tests.json"); /* &ref */
  let test = null; /* &ref */
  let failed = (Math.trunc(+(0)));
  for (test = ((tests != (null)) ? (__struct_ptr_at((tests), 0)).child : null); test != (null); test = (__struct_ptr_at(test, 0)).next) {
    failed |= !test_apply_patch(test);
  ...
  if (!(failed)) {
    ...
    UnityFail(((("Some tests failed."))), __u64(__as_bigint((__u64(__as_bigint((214)))))));
  }
}

function cjson_utils_should_pass_json_patch_test_cjson_utils_tests(): void {
  let tests = parse_test_file("json-patch-tests/cjson-utils-tests.json"); /* &ref */
  let test = null; /* &ref */
  let failed = (Math.trunc(+(0)));
  for (test = ((tests != (null)) ? (__struct_ptr_at((tests), 0)).child : null); test != (null); test = (__struct_ptr_at(test, 0)).next) {
    failed |= !test_apply_patch(test);
  ...
  if (!(failed)) {
    ...
    UnityFail(((("Some tests failed."))), __u64(__as_bigint((__u64(__as_bigint((231)))))));
  }
}

export function main(): number {
  UnityBegin("tests/real-world/cjson/tests/json_patch_tests.c");
  UnityDefaultTestRun((cjson_utils_should_pass_json_patch_test_tests), "cjson_utils_should_pass_json_patch_test_tests", (238));
  UnityDefaultTestRun((cjson_utils_should_pass_json_patch_test_spec_tests), "cjson_utils_should_pass_json_patch_test_spec_tests", (239));
  UnityDefaultTestRun((cjson_utils_should_pass_json_patch_test_cjson_utils_tests), "cjson_utils_should_pass_json_patch_test_cjson_utils_tests", (240));
  return UnityEnd();
}
