...
let item = new cJSON();
function assert_is_object(object_item: cJSON | null): void {
  if ((((object_item)) != (null))) {
  } else {
    UnityFail((((("Item is NULL.")))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((35))))))))));
  }
  if (((((__struct_ptr_at(object_item, 0)).next)) == (null))) {
  } else {
    UnityFail((((("Linked list next pointer is not NULL.")))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((37))))))))));
  }
  if (((((__struct_ptr_at(object_item, 0)).prev)) == (null))) {
  } else {
    UnityFail((((("Linked list previous pointer is not NULL.")))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((37))))))))));
  }
  UnityAssertBits(__i64(__as_bigint(((255)))), __i64(__as_bigint((((((1 << 6) | 0)))))), __i64(__as_bigint((((__struct_ptr_at(object_item, 0)).type)))), (("Item doesn't have expected type.")), __u64(__as_bigint((38))));
  UnityAssertBits(__i64(__as_bigint(((256)))), __i64(__as_bigint(((0)))), __i64(__as_bigint((((__struct_ptr_at(object_item, 0)).type)))), (("Item should not have a string as reference.")), __u64(__as_bigint((39))));
  UnityAssertBits(__i64(__as_bigint(((512)))), __i64(__as_bigint(((0)))), __i64(__as_bigint((((__struct_ptr_at(object_item, 0)).type)))), (("Item should not have a const string.")), __u64(__as_bigint((40))));
  if ((cptr_eq((((__struct_ptr_at(object_item, 0)).valuestring)), (null)))) {
  } else {
    UnityFail((((("Valuestring is not NULL.")))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((41))))))))));
  }
  if ((cptr_eq((((__struct_ptr_at(object_item, 0)).string)), (null)))) {
  } else {
    UnityFail((((("String is not NULL.")))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((42))))))))));
  }
}

function assert_is_child(child_item: cJSON | null, name: string, type: number): void {
  if ((((child_item)) != (null))) {
  } else {
    UnityFail((((("Child item is NULL.")))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((47))))))))));
  }
  if ((!cptr_eq((((__struct_ptr_at(child_item, 0)).string)), (null)))) {
  } else {
    UnityFail((((("Child item doesn't have a name.")))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((48))))))))));
  }
  UnityAssertEqualString(cptr_clone((((name)))), cptr_clone(((((__struct_ptr_at(child_item, 0)).string)))), (("Child item has the wrong name.")), __u64(__as_bigint((49))));
  UnityAssertBits(__i64(__as_bigint(((255)))), __i64(__as_bigint(((type)))), __i64(__as_bigint((((__struct_ptr_at(child_item, 0)).type)))), null, __u64(__as_bigint((50))));
}

function assert_not_object(json: string): void {
  let parsebuffer = Object.assign(new parse_buffer(), { content: null, length: ((0) >>> 0), offset: ((0) >>> 0), depth: ((0) >>> 0), hooks: Object.assign(new internal_hooks(), { allocate: null, deallocate: null, reallocate: null }) });
  parsebuffer.content = (json);
  parsebuffer.length = strlen(cptr_clone(json)) + 1;
  Object.assign(parsebuffer.hooks, global_hooks);
  if (!(parse_object(item, parsebuffer))) {
  } else {
    UnityFail(((" Expected FALSE Was TRUE")), __u64(__as_bigint((__u64(__as_bigint((60)))))));
  }
  UnityAssertBits(__i64(__as_bigint(((255)))), __i64(__as_bigint((((0))))), __i64(__as_bigint((((__struct_ptr_at(item, 0)).type)))), (("Item doesn't have expected type.")), __u64(__as_bigint((61))));
  if (((((__struct_ptr_at(item, 0)).next)) == (null))) {
  } else {
    UnityFail((((("Linked list next pointer is not NULL.")))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((61))))))))));
  }
  if (((((__struct_ptr_at(item, 0)).prev)) == (null))) {
  } else {
    UnityFail((((("Linked list previous pointer is not NULL.")))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((61))))))))));
  }
  if (((((__struct_ptr_at(item, 0)).child)) == (null))) {
  } else {
    UnityFail((((("Item has a child.")))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((61))))))))));
  }
  if ((cptr_eq((((__struct_ptr_at(item, 0)).string)), (null)))) {
  } else {
    UnityFail((((("String is not NULL.")))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((61))))))))));
  }
  if ((cptr_eq((((__struct_ptr_at(item, 0)).valuestring)), (null)))) {
  } else {
    UnityFail((((("Valuestring is not NULL.")))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((61))))))))));
  }
  reset(item);
}

function assert_parse_object(json: string): void {
  let parsebuffer = Object.assign(new parse_buffer(), { content: null, length: ((0) >>> 0), offset: ((0) >>> 0), depth: ((0) >>> 0), hooks: Object.assign(new internal_hooks(), { allocate: null, deallocate: null, reallocate: null }) });
  parsebuffer.content = (json);
  parsebuffer.length = strlen(cptr_clone(json)) + 1;
  Object.assign(parsebuffer.hooks, global_hooks);
  if ((parse_object(item, parsebuffer))) {
    ...
    UnityFail(((" Expected TRUE Was FALSE")), __u64(__as_bigint((__u64(__as_bigint((72)))))));
  }
  assert_is_object(item);
}

function parse_object_should_parse_empty_objects(): void {
  assert_parse_object("{}");
  if (((((__struct_ptr_at(item, 0)).child)) == (null))) {
  } else {
    UnityFail((((("Item has a child.")))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((79))))))))));
  }
  reset(item);
  assert_parse_object("{\n\t}");
  if (((((__struct_ptr_at(item, 0)).child)) == (null))) {
  } else {
    UnityFail((((("Item has a child.")))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((83))))))))));
  }
  reset(item);
}

function parse_object_should_parse_objects_with_one_element(): void {
  assert_parse_object("{\"one\":1}");
  assert_is_child((__struct_ptr_at(item, 0)).child, "one", (((1 << 3) | 0)));
  reset(item);
  assert_parse_object("{\"hello\":\"world!\"}");
  assert_is_child((__struct_ptr_at(item, 0)).child, "hello", (((1 << 4) | 0)));
  reset(item);
  assert_parse_object("{\"array\":[]}");
  assert_is_child((__struct_ptr_at(item, 0)).child, "array", (((1 << 5) | 0)));
  reset(item);
  assert_parse_object("{\"null\":null}");
  assert_is_child((__struct_ptr_at(item, 0)).child, "null", (((1 << 2) | 0)));
  reset(item);
}

function parse_object_should_parse_objects_with_multiple_elements(): void {
  assert_parse_object("{\"one\":1\t,\t\"two\"\n:2, \"three\":3}");
  assert_is_child((__struct_ptr_at(item, 0)).child, "one", (((1 << 3) | 0)));
  assert_is_child((__struct_ptr_at((__struct_ptr_at(item, 0)).child, 0)).next, "two", (((1 << 3) | 0)));
  assert_is_child((__struct_ptr_at((__struct_ptr_at((__struct_ptr_at(item, 0)).child, 0)).next, 0)).next, "three", (((1 << 3) | 0)));
  reset(item);
  {
    let i = ((0) >>> 0);
    let node = null; /* &ref */
    let expected_types = [(((1 << 3) | 0)), (((1 << 2) | 0)), (((1 << 1) | 0)), (((1 << 0) | 0)), (((1 << 5) | 0)), (((1 << 4) | 0)), (((1 << 6) | 0))];
    let expected_names = ["one", "NULL", "TRUE", "FALSE", "array", "world", "object"]; /* &ref */
    ...
    for (i = ((0) >>> 0); (((((i) >>> 0) < (__safe_div(28, 4))) && (node != (null))) ? 1 : 0); ((() => { const _t = i; i = u32(i + 1); return _t; })()), node = (__struct_ptr_at(node, 0)).next) {
      assert_is_child(node, cptr_clone(expected_names[((i) >>> 0)]), expected_types[((i) >>> 0)]);
    }
    UnityAssertEqualNumber(__i64(__as_bigint(((((i))) >>> 0))), __i64(__as_bigint(((7)))), null, __u64(__as_bigint((149))), UNITY_DISPLAY_STYLE_INT);
    reset(item);
  }
}

function parse_object_should_not_parse_non_objects(): void {
  assert_not_object("");
  assert_not_object("{");
  assert_not_object("}");
...
export function main(): number {
  memset(item, 0, 64);
  UnityBegin("tests/real-world/cjson/tests/parse_object.c");
  UnityDefaultTestRun((parse_object_should_parse_empty_objects), "parse_object_should_parse_empty_objects", (171));
  UnityDefaultTestRun((parse_object_should_not_parse_non_objects), "parse_object_should_not_parse_non_objects", (172));
  UnityDefaultTestRun((parse_object_should_parse_objects_with_multiple_elements), "parse_object_should_parse_objects_with_multiple_elements", (173));
  UnityDefaultTestRun((parse_object_should_parse_objects_with_one_element), "parse_object_should_parse_objects_with_one_element", (174));
  return UnityEnd();
}
