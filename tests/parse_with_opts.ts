...
import { UnityAssertEqualNumber, UnityBegin, UnityDefaultTestRun, UnityEnd, UnityFail } from './unity.js';
...
function parse_with_opts_should_handle_null(): void {
  let error_pointer = null; /* &ref */
  let item = null; /* &ref */
  if (((((() => { const _box0 = { value: error_pointer }; const _r = cJSON_ParseWithOpts(null, _box0, (Math.trunc(+(0)))); error_pointer = _box0.value; return _r; })())) == (null))) {
  } else {
    UnityFail((((("Failed to handle NULL input.")))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((31))))))))));
  }
  item = cJSON_ParseWithOpts("{}", { value: null }, (Math.trunc(+(0))));
  if ((((item)) != (null))) {
  } else {
    UnityFail((((("Failed to handle NULL error pointer.")))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((33))))))))));
  }
  cJSON_Delete(item);
  if ((((cJSON_ParseWithOpts(null, { value: null }, (Math.trunc(+(0)))))) == (null))) {
  } else {
    UnityFail((((("Failed to handle both NULL.")))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((35))))))))));
  }
  if ((((cJSON_ParseWithOpts("{", { value: null }, (Math.trunc(+(0)))))) == (null))) {
  } else {
    UnityFail((((("Failed to handle NULL error pointer with parse error.")))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((36))))))))));
  }
}

function parse_with_opts_should_handle_empty_strings(): void {
  let empty_string = (() => { const __b = cptr_create(1); const __s = ""; for (let __i = 0; __i < __s.length; __i++) __b.buf[__i] = __s.charCodeAt(__i); return __b; })();
  let error_pointer = null; /* &ref */
  if ((((cJSON_ParseWithOpts(cptr_clone(empty_string), { value: null }, (Math.trunc(+(0)))))) == (null))) {
  } else {
    UnityFail((((" Expected NULL"))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((44))))))))));
  }
  UnityAssertEqualNumber(Math.trunc(+(__rt_ptr_to_intptr(((empty_string))))), Math.trunc(+(__rt_ptr_to_intptr(((cJSON_GetErrorPtr()))))), null, __u64(__as_bigint((45))), UNITY_DISPLAY_STYLE_HEX64);
  if (((((() => { const _box0 = { value: error_pointer }; const _r = cJSON_ParseWithOpts(cptr_clone(empty_string), _box0, (Math.trunc(+(0)))); error_pointer = _box0.value; return _r; })())) == (null))) {
  } else {
    UnityFail((((" Expected NULL"))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((47))))))))));
  }
  UnityAssertEqualNumber(Math.trunc(+(__rt_ptr_to_intptr(((empty_string))))), Math.trunc(+(__rt_ptr_to_intptr(((error_pointer))))), null, __u64(__as_bigint((48))), UNITY_DISPLAY_STYLE_HEX64);
  UnityAssertEqualNumber(Math.trunc(+(__rt_ptr_to_intptr(((empty_string))))), Math.trunc(+(__rt_ptr_to_intptr(((cJSON_GetErrorPtr()))))), null, __u64(__as_bigint((49))), UNITY_DISPLAY_STYLE_HEX64);
}

function parse_with_opts_should_handle_incomplete_json(): void {
  let json = (() => { const __b = cptr_create(11); const __s = "{ \"name\": "; for (let __i = 0; __i < __s.length; __i++) __b.buf[__i] = __s.charCodeAt(__i); return __b; })();
  let parse_end = null; /* &ref */
  if (((((() => { const _box0 = { value: parse_end }; const _r = cJSON_ParseWithOpts(cptr_clone(json), _box0, (Math.trunc(+(0)))); parse_end = _box0.value; return _r; })())) == (null))) {
  } else {
    UnityFail((((" Expected NULL"))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((57))))))))));
  }
  UnityAssertEqualNumber(Math.trunc(+(__rt_ptr_to_intptr(((cptr_offset(json, strlen(cptr_clone(json)))))))), Math.trunc(+(__rt_ptr_to_intptr(((parse_end))))), null, __u64(__as_bigint((58))), UNITY_DISPLAY_STYLE_HEX64);
  (() => { const __rtl_0_4 = UNITY_DISPLAY_STYLE_HEX64; const __rtl_0_3 = __u64(__as_bigint((59))); const __rtl_0_2 = null; const __rtl_0_1 = Math.trunc(+(__rt_ptr_to_intptr(((cJSON_GetErrorPtr()))))); const __rtl_0_0 = Math.trunc(+(__rt_ptr_to_intptr(((cptr_offset(json, strlen(cptr_clone(json)))))))); return UnityAssertEqualNumber(__rtl_0_0, __rtl_0_1, __rtl_0_2, __rtl_0_3, __rtl_0_4); })();
}

function parse_with_opts_should_require_null_if_requested(): void {
  let item = cJSON_ParseWithOpts("{}", { value: null }, (Math.trunc(+(1)))); /* &ref */
  if ((((item)) != (null))) {
  } else {
    UnityFail((((" Expected Non-NULL"))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((65))))))))));
  }
  cJSON_Delete(item);
  item = cJSON_ParseWithOpts("{} \n", { value: null }, (Math.trunc(+(1))));
  if ((((item)) != (null))) {
  } else {
    UnityFail((((" Expected Non-NULL"))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((68))))))))));
  }
  cJSON_Delete(item);
  if ((((cJSON_ParseWithOpts("{}x", { value: null }, (Math.trunc(+(1)))))) == (null))) {
  } else {
    UnityFail((((" Expected NULL"))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((70))))))))));
  }
}

function parse_with_opts_should_return_parse_end(): void {
  let json = (() => { const __b = cptr_create(18); const __s = "[] empty array XD"; for (let __i = 0; __i < __s.length; __i++) __b.buf[__i] = __s.charCodeAt(__i); return __b; })();
  let parse_end = null; /* &ref */
  let item = (() => { const _box0 = { value: parse_end }; const _r = cJSON_ParseWithOpts(cptr_clone(json), _box0, (Math.trunc(+(0)))); parse_end = _box0.value; return _r; })(); /* &ref */
  if ((((item)) != (null))) {
  } else {
    UnityFail((((" Expected Non-NULL"))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((79))))))))));
  }
  UnityAssertEqualNumber(Math.trunc(+(__rt_ptr_to_intptr(((cptr_offset(json, 2)))))), Math.trunc(+(__rt_ptr_to_intptr(((parse_end))))), null, __u64(__as_bigint((80))), UNITY_DISPLAY_STYLE_HEX64);
  cJSON_Delete(item);
}

function parse_with_opts_should_parse_utf8_bom(): void {
  let with_bom = null; /* &ref */
  let without_bom = null; /* &ref */
  with_bom = cJSON_ParseWithOpts("\xEF\xBB\xBF{}", { value: null }, (Math.trunc(+(1))));
  if ((((with_bom)) != (null))) {
  } else {
    UnityFail((((" Expected Non-NULL"))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((90))))))))));
  }
  without_bom = cJSON_ParseWithOpts("{}", { value: null }, (Math.trunc(+(1))));
  if ((((with_bom)) != (null))) {
  } else {
    UnityFail((((" Expected Non-NULL"))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((92))))))))));
  }
  if ((cJSON_Compare(with_bom, without_bom, (Math.trunc(+(1)))))) {
  } else {
...
export function main(): number {
  UnityBegin("tests/real-world/cjson/tests/parse_with_opts.c");
  UnityDefaultTestRun((parse_with_opts_should_handle_null), "parse_with_opts_should_handle_null", (104));
  UnityDefaultTestRun((parse_with_opts_should_handle_empty_strings), "parse_with_opts_should_handle_empty_strings", (105));
  UnityDefaultTestRun((parse_with_opts_should_handle_incomplete_json), "parse_with_opts_should_handle_incomplete_json", (106));
  UnityDefaultTestRun((parse_with_opts_should_require_null_if_requested), "parse_with_opts_should_require_null_if_requested", (107));
  UnityDefaultTestRun((parse_with_opts_should_return_parse_end), "parse_with_opts_should_return_parse_end", (108));
  UnityDefaultTestRun((parse_with_opts_should_parse_utf8_bom), "parse_with_opts_should_parse_utf8_bom", (109));
  return UnityEnd();
}
