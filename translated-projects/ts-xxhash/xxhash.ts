function __builtin_prefetch(..._args: any[]): void { /* cache hint; no runtime effect */ }
function __builtin_unreachable(): never { throw new Error('__builtin_unreachable reached (C17 §6.5.2.2 UB)'); }
function __builtin_assume(_cond: any): void { /* optimizer hint; no runtime effect */ }
function __builtin_rotateleft64(x: any, n: any): bigint { const xb = typeof x === 'bigint' ? x : BigInt(Math.trunc(Number(x))); const nv = (typeof n === 'object' && n !== null && typeof n.valueOf === 'function') ? Number(n.valueOf()) : Number(n); const nb = typeof n === 'bigint' ? Number(n & 63n) : (nv & 63); const m = (1n << 64n) - 1n; const xu = xb & m; return ((xu << BigInt(nb)) | (xu >> BigInt(64 - nb))) & m; }
function __builtin_rotateleft32(x: number, n: number): number { const s = n & 31; return ((x << s) | (x >>> (32 - s))) >>> 0; }
...
export const XXH_OK: number = 0;
export const XXH_ERROR: number = undefined /* UNSUPPORTED: unhandled expression node kind FullComment */;
...
type int_least64_t = any;
type uint_least64_t = any;
...
type int_fast64_t = any;
type uint_fast64_t = any;
type XXH32_hash_t = number;
type XXH32_state_t = any;
// BRIDGE: struct-as-class — C17 §6.7.2.1 / C++20 [class]
export class XXH32_canonical_t {
  digest: any = cptr_create(4);
  constructor() {
    this.digest = cptr_create(4);
  }
}
(XXH32_canonical_t as any).__fieldTypes = ["bytes"];
(XXH32_canonical_t as any).__fieldNames = ["digest"];
(XXH32_canonical_t as any).__fieldOffsets = [0];

type XXH64_hash_t = any;
type XXH64_state_t = any;
// BRIDGE: struct-as-class — C17 §6.7.2.1 / C++20 [class]
export class XXH64_canonical_t {
  digest: any = cptr_create(8);
  constructor() {
    this.digest = cptr_create(8);
  }
}
(XXH64_canonical_t as any).__fieldTypes = ["bytes"];
(XXH64_canonical_t as any).__fieldNames = ["digest"];
(XXH64_canonical_t as any).__fieldOffsets = [0];
...
(XXH128_hash_t as any).__fieldTypes = ["int32","int32"];
(XXH128_hash_t as any).__fieldNames = ["low64","high64"];
(XXH128_hash_t as any).__fieldOffsets = [0,8];
...
(XXH128_canonical_t as any).__fieldTypes = ["bytes"];
(XXH128_canonical_t as any).__fieldNames = ["digest"];
(XXH128_canonical_t as any).__fieldOffsets = [0];

// BRIDGE: struct-as-class — C17 §6.7.2.1 / C++20 [class]
export class XXH32_state_s {
  total_len_32: XXH32_hash_t;
  large_len: XXH32_hash_t;
  v: any = new Array(4).fill(0);
  mem32: any = new Array(4).fill(0);
...
(XXH32_state_s as any).__fieldTypes = ["int32","int32","bytes","bytes","int32","int32"];
(XXH32_state_s as any).__fieldNames = ["total_len_32","large_len","v","mem32","memsize","reserved"];
(XXH32_state_s as any).__fieldOffsets = [0,8,16,48,80,88];

// BRIDGE: struct-as-class — C17 §6.7.2.1 / C++20 [class]
export class XXH64_state_s {
  total_len: XXH64_hash_t;
  v: any = new Array(4).fill(0);
  mem64: any = new Array(4).fill(0);
  memsize: XXH32_hash_t;
...
(XXH64_state_s as any).__fieldTypes = ["int32","bytes","bytes","int32","int32","int32"];
(XXH64_state_s as any).__fieldNames = ["total_len","v","mem64","memsize","reserved32","reserved64"];
(XXH64_state_s as any).__fieldOffsets = [0,8,40,72,80,88];

// BRIDGE: struct-as-class — C17 §6.7.2.1 / C++20 [class]
export class XXH3_state_s {
  acc: any = new Array(8).fill(0);
  customSecret: any = cptr_create(192);
  buffer: any = cptr_create(256);
...
(XXH3_state_s as any).__fieldTypes = ["bytes","bytes","bytes","int32","int32","int64","int32","int64","int64","int32","int32","int64"];
(XXH3_state_s as any).__fieldNames = ["acc","customSecret","buffer","bufferedSize","useSeed","nbStripesSoFar","totalLen","nbStripesPerBlock","secretLimit","seed","reserved64","extSecret"];
(XXH3_state_s as any).__fieldOffsets = [0,64,256,512,520,528,536,544,552,560,568,576];
...
function XXH_malloc(s: number): any | null {
  return cptr_clone(malloc(((s) >>> 0)));
}

function XXH_free(p: any | null): void {
  free(p);
}
...
function XXH_memcpy(dest: any | null, src: any | null, size: number): any | null {
  return cptr_clone(memcpy(dest, src, ((size) >>> 0)));
}

type xxh_u8 = number;
type xxh_u32 = XXH32_hash_t;
function XXH_read32(ptr: any | null): xxh_u32 {
  return ((cptr_read_uint32(((ptr)))) >>> 0);
}

function XXH_swap32(x: xxh_u32): xxh_u32 {
  return (((((((((x) >>> 0) << 24) >>> 0) & 4278190080) >>> 0) | ((((((x) >>> 0) << 8) >>> 0) & ((16711680) >>> 0)) >>> 0)) >>> 0 | ((((((x) >>> 0) >>> 8) >>> 0) & ((65280) >>> 0)) >>> 0)) >>> 0 | ((((((x) >>> 0) >>> 24) >>> 0) & ((255) >>> 0)) >>> 0)) >>> 0;
}

export const XXH_aligned: number = undefined /* UNSUPPORTED: unhandled expression node kind FullComment */;
export const XXH_unaligned: number = undefined /* UNSUPPORTED: unhandled expression node kind FullComment */;

type XXH_alignment = number;
function XXH_readLE32(ptr: any | null): xxh_u32 {
  return (1 ? XXH_read32(ptr) : XXH_swap32(XXH_read32(ptr)));
}

function XXH_readBE32(ptr: any | null): xxh_u32 {
  return (1 ? XXH_swap32(XXH_read32(ptr)) : XXH_read32(ptr));
}

function XXH_readLE32_align(ptr: any | null, align: XXH_alignment): xxh_u32 {
...
export function XXH_versionNumber(): number {
  return (((i32(i32(Math.imul(Math.imul(0, 100), 100) + Math.imul(8, 100)) + 2))) >>> 0);
}

function XXH32_round(acc: xxh_u32, input: xxh_u32): xxh_u32 {
...
function XXH32_avalanche(hash: xxh_u32): xxh_u32 {
  hash ^= (((hash) >>> 0) >>> 15) >>> 0;
...
function XXH32_finalize(hash: xxh_u32, ptr: any, len: number, align: XXH_alignment): xxh_u32 {
  if (typeof ptr === 'string') ptr = cptr_from_string(ptr);
...
function XXH32_endian_align(input: xxh_u8 | null, len: number, seed: xxh_u32, align: XXH_alignment): xxh_u32 {
  let h32 = 0;
  ...
  if ((((len) >>> 0) >= ((16) >>> 0) ? 1 : 0)) {
    ...
    do {
      ...
      input = cptr_offset(input, 4);
    } while ((((__l: any, __r: any) => { const __lb = __l && __l.buf; const __rb = __r && __r.buf; if (__lb && __rb && __lb === __rb) return ((__l.off ?? 0) < (__r.off ?? 0)); if (__lb || __rb) return (__rt_ptr_to_intptr(__l) < __rt_ptr_to_intptr(__r)); return ((__l ?? 0) < (__r ?? 0)); })(input, limit) ? 1 : 0));
...
export function XXH32(input: any | null, len: number, seed: XXH32_hash_t): XXH32_hash_t {
  if (0) {
...
export function XXH32_createState(): XXH32_state_t | null {
  return (new XXH32_state_s());
}

export function XXH32_freeState(statePtr: XXH32_state_t | null): XXH_errorcode {
  XXH_free(statePtr);
  return XXH_OK;
}

export function XXH32_copyState(dstState: XXH32_state_t | null, srcState: XXH32_state_t | null): void {
  XXH_memcpy(dstState, srcState, 96);
}

export function XXH32_reset(statePtr: XXH32_state_t | null, seed: XXH32_hash_t): XXH_errorcode {
...
export function XXH32_update(state: XXH32_state_t | null, input: any | null, len: number): XXH_errorcode {
  if ((cptr_eq(input, (null)) ? 1 : 0)) {
    __builtin_assume(((((len) >>> 0) == ((0) >>> 0) ? 1 : 0) ? 1 : 0));
    return XXH_OK;
  }
  {
    ...
    if ((((__l: any, __r: any) => { const __lb = __l && __l.buf; const __rb = __r && __r.buf; if (__lb && __rb && __lb === __rb) return ((__l.off ?? 0) <= (__r.off ?? 0)); if (__lb || __rb) return (__rt_ptr_to_intptr(__l) <= __rt_ptr_to_intptr(__r)); return ((__l ?? 0) <= (__r ?? 0)); })(p, cptr_offset(bEnd, -(16))) ? 1 : 0)) {
      ...
      do {
        ...
        p = cptr_offset(p, 4);
      } while ((((__l: any, __r: any) => { const __lb = __l && __l.buf; const __rb = __r && __r.buf; if (__lb && __rb && __lb === __rb) return ((__l.off ?? 0) <= (__r.off ?? 0)); if (__lb || __rb) return (__rt_ptr_to_intptr(__l) <= __rt_ptr_to_intptr(__r)); return ((__l ?? 0) <= (__r ?? 0)); })(p, limit) ? 1 : 0));
    }
    if ((((__l: any, __r: any) => { const __lb = __l && __l.buf; const __rb = __r && __r.buf; if (__lb && __rb && __lb === __rb) return ((__l.off ?? 0) < (__r.off ?? 0)); if (__lb || __rb) return (__rt_ptr_to_intptr(__l) < __rt_ptr_to_intptr(__r)); return ((__l ?? 0) < (__r ?? 0)); })(p, bEnd) ? 1 : 0)) {
      XXH_memcpy((__struct_ptr_at(state, 0)).mem32, p, ((Math.trunc(+((((__lp: any, __rp: any) => { const __lb = __lp && __lp.buf; const __rb = __rp && __rp.buf; if (__lb && __rb && __lb !== __rb) return (__rt_ptr_to_intptr(__lp) - __rt_ptr_to_intptr(__rp)); return (((__x) => __x == null ? 0 : (typeof __x === 'string' ? 0 : (__x && __x.__field_ref === true ? ((__x.__field_offset ?? 0) + (__x.__byte_delta ?? 0)) : (typeof __x === 'object' && __x.off === undefined ? 0 : (__x.off ?? __x)))))(__lp) - ((__x) => __x == null ? 0 : (typeof __x === 'string' ? 0 : (__x && __x.__field_ref === true ? ((__x.__field_offset ?? 0) + (__x.__byte_delta ?? 0)) : (typeof __x === 'object' && __x.off === undefined ? 0 : (__x.off ?? __x)))))(__rp)); })(bEnd, p))))) >>> 0));
      (__struct_ptr_at(state, 0)).memsize = ((Math.trunc(+((((__lp: any, __rp: any) => { const __lb = __lp && __lp.buf; const __rb = __rp && __rp.buf; if (__lb && __rb && __lb !== __rb) return (__rt_ptr_to_intptr(__lp) - __rt_ptr_to_intptr(__rp)); return (((__x) => __x == null ? 0 : (typeof __x === 'string' ? 0 : (__x && __x.__field_ref === true ? ((__x.__field_offset ?? 0) + (__x.__byte_delta ?? 0)) : (typeof __x === 'object' && __x.off === undefined ? 0 : (__x.off ?? __x)))))(__lp) - ((__x) => __x == null ? 0 : (typeof __x === 'string' ? 0 : (__x && __x.__field_ref === true ? ((__x.__field_offset ?? 0) + (__x.__byte_delta ?? 0)) : (typeof __x === 'object' && __x.off === undefined ? 0 : (__x.off ?? __x)))))(__rp)); })(bEnd, p))))) >>> 0);
    }
  }
  return XXH_OK;
}

export function XXH32_digest(state: XXH32_state_t | null): XXH32_hash_t {
  let h32 = 0;
...
export function XXH32_canonicalFromHash(dst: XXH32_canonical_t | null, hash: XXH32_hash_t): void {
  do {
  } while (0);
  if (1) {
...
export function XXH32_hashFromCanonical(src: XXH32_canonical_t | null): XXH32_hash_t {
  return XXH_readBE32(src);
}

type xxh_u64 = XXH64_hash_t;
function XXH_read64(ptr: any | null): xxh_u64 {
  return cptr_read_uint64(((ptr)));
}

function XXH_swap64(x: xxh_u64): xxh_u64 {
...
function XXH_readLE64(ptr: any | null): xxh_u64 {
  return (1 ? XXH_read64(ptr) : XXH_swap64(XXH_read64(ptr)));
}

function XXH_readBE64(ptr: any | null): xxh_u64 {
  return (1 ? XXH_swap64(XXH_read64(ptr)) : XXH_read64(ptr));
}

function XXH_readLE64_align(ptr: any | null, align: XXH_alignment): xxh_u64 {
  if ((((align) >>> 0) == ((XXH_unaligned) >>> 0) ? 1 : 0)) {
...
function XXH64_round(acc: xxh_u64, input: xxh_u64): xxh_u64 {
...
function XXH64_mergeRound(acc: xxh_u64, val: xxh_u64): xxh_u64 {
...
function XXH64_avalanche(hash: xxh_u64): xxh_u64 {
...
function XXH64_finalize(hash: xxh_u64, ptr: any, len: number, align: XXH_alignment): xxh_u64 {
  if (typeof ptr === 'string') ptr = cptr_from_string(ptr);
  ...
  len &= ((31) >>> 0);
  while ((((len) >>> 0) >= ((8) >>> 0) ? 1 : 0)) {
    let k1: any = XXH64_round(0, XXH_readLE64_align(ptr, align));
...
function XXH64_endian_align(input: xxh_u8 | null, len: number, seed: xxh_u64, align: XXH_alignment): xxh_u64 {
  let h64: any = 0;
  if ((cptr_eq(input, (null)) ? 1 : 0)) {
    __builtin_assume(((((len) >>> 0) == ((0) >>> 0) ? 1 : 0) ? 1 : 0));
  }
  if ((((len) >>> 0) >= ((32) >>> 0) ? 1 : 0)) {
    ...
    let v1: any = __u64(__as_bigint(__u64(__as_bigint(seed) + __as_bigint(11400714785074694791n))) + __as_bigint(14029467366897019727n));
    let v2: any = __u64(__as_bigint(seed) + __as_bigint(14029467366897019727n));
    let v3: any = __u64(__as_bigint(seed) + __as_bigint(0));
    let v4: any = __u64(__as_bigint(seed) - __as_bigint(11400714785074694791n));
    do {
...
export function XXH64(input: any | null, len: number, seed: XXH64_hash_t): XXH64_hash_t {
  if (0) {
...
export function XXH64_createState(): XXH64_state_t | null {
  return (new XXH64_state_s());
}

export function XXH64_freeState(statePtr: XXH64_state_t | null): XXH_errorcode {
  XXH_free(statePtr);
  return XXH_OK;
}

export function XXH64_copyState(dstState: XXH64_state_t | null, srcState: XXH64_state_t | null): void {
  XXH_memcpy(dstState, srcState, 96);
}

export function XXH64_reset(statePtr: XXH64_state_t | null, seed: XXH64_hash_t): XXH_errorcode {
  __builtin_assume(((statePtr != (null) ? 1 : 0) ? 1 : 0));
  memset(statePtr, 0, 96);
...
export function XXH64_update(state: XXH64_state_t | null, input: any | null, len: number): XXH_errorcode {
  if ((cptr_eq(input, (null)) ? 1 : 0)) {
    __builtin_assume(((((len) >>> 0) == ((0) >>> 0) ? 1 : 0) ? 1 : 0));
    return XXH_OK;
  }
  {
    ...
    if ((((__l: any, __r: any) => { const __lb = __l && __l.buf; const __rb = __r && __r.buf; if (__lb && __rb && __lb === __rb) return ((__l.off ?? 0) <= (__r.off ?? 0)); if (__lb || __rb) return (__rt_ptr_to_intptr(__l) <= __rt_ptr_to_intptr(__r)); return ((__l ?? 0) <= (__r ?? 0)); })(cptr_offset(p, 32), bEnd) ? 1 : 0)) {
    ...
    if ((((__l: any, __r: any) => { const __lb = __l && __l.buf; const __rb = __r && __r.buf; if (__lb && __rb && __lb === __rb) return ((__l.off ?? 0) < (__r.off ?? 0)); if (__lb || __rb) return (__rt_ptr_to_intptr(__l) < __rt_ptr_to_intptr(__r)); return ((__l ?? 0) < (__r ?? 0)); })(p, bEnd) ? 1 : 0)) {
      XXH_memcpy((__struct_ptr_at(state, 0)).mem64, p, ((Math.trunc(+((((__lp: any, __rp: any) => { const __lb = __lp && __lp.buf; const __rb = __rp && __rp.buf; if (__lb && __rb && __lb !== __rb) return (__rt_ptr_to_intptr(__lp) - __rt_ptr_to_intptr(__rp)); return (((__x) => __x == null ? 0 : (typeof __x === 'string' ? 0 : (__x && __x.__field_ref === true ? ((__x.__field_offset ?? 0) + (__x.__byte_delta ?? 0)) : (typeof __x === 'object' && __x.off === undefined ? 0 : (__x.off ?? __x)))))(__lp) - ((__x) => __x == null ? 0 : (typeof __x === 'string' ? 0 : (__x && __x.__field_ref === true ? ((__x.__field_offset ?? 0) + (__x.__byte_delta ?? 0)) : (typeof __x === 'object' && __x.off === undefined ? 0 : (__x.off ?? __x)))))(__rp)); })(bEnd, p))))) >>> 0));
      (__struct_ptr_at(state, 0)).memsize = ((Math.trunc(+((((__lp: any, __rp: any) => { const __lb = __lp && __lp.buf; const __rb = __rp && __rp.buf; if (__lb && __rb && __lb !== __rb) return (__rt_ptr_to_intptr(__lp) - __rt_ptr_to_intptr(__rp)); return (((__x) => __x == null ? 0 : (typeof __x === 'string' ? 0 : (__x && __x.__field_ref === true ? ((__x.__field_offset ?? 0) + (__x.__byte_delta ?? 0)) : (typeof __x === 'object' && __x.off === undefined ? 0 : (__x.off ?? __x)))))(__lp) - ((__x) => __x == null ? 0 : (typeof __x === 'string' ? 0 : (__x && __x.__field_ref === true ? ((__x.__field_offset ?? 0) + (__x.__byte_delta ?? 0)) : (typeof __x === 'object' && __x.off === undefined ? 0 : (__x.off ?? __x)))))(__rp)); })(bEnd, p))))) >>> 0);
    }
  }
  return XXH_OK;
...
export function XXH64_digest(state: XXH64_state_t | null): XXH64_hash_t {
  let h64: any = 0;
...
export function XXH64_canonicalFromHash(dst: XXH64_canonical_t | null, hash: XXH64_hash_t): void {
  do {
  } while (0);
  if (1) {
...
export function XXH64_hashFromCanonical(src: XXH64_canonical_t | null): XXH64_hash_t {
...
const PRIME_MX1: any = 1609587791953885689n;
const PRIME_MX2: any = 11507291218515648293n;
function XXH_mult64to128(lhs: xxh_u64, rhs: xxh_u64): XXH128_hash_t {
...
function XXH3_mul128_fold64(lhs: xxh_u64, rhs: xxh_u64): xxh_u64 {
  let product = XXH_mult64to128(lhs, rhs);
  return __u64(__as_bigint(product.low64) ^ __as_bigint(product.high64));
}

function XXH_xorshift64(v64: xxh_u64, shift: number): xxh_u64 {
...
function XXH3_avalanche(h64: xxh_u64): XXH64_hash_t {
...
function XXH3_rrmxmx(h64: xxh_u64, len: xxh_u64): XXH64_hash_t {
...
function XXH3_len_1to3_64b(input: any, len: number, secret: xxh_u8 | null, seed: XXH64_hash_t): XXH64_hash_t {
  ...
  __builtin_assume(((!cptr_eq(secret, (null)) ? 1 : 0) ? 1 : 0));
  {
    ...
    let bitflip: any = __u64(__as_bigint(((XXH_readLE32(secret) ^ XXH_readLE32(cptr_offset(secret, 4))) >>> 0)) + __as_bigint(seed));
    let keyed: any = __u64(__as_bigint(__u64(__as_bigint(((combined) >>> 0)))) ^ __as_bigint(bitflip));
    return XXH64_avalanche(keyed);
  }
}

function XXH3_len_4to8_64b(input: xxh_u8 | null, len: number, secret: xxh_u8 | null, seed: XXH64_hash_t): XXH64_hash_t {
  __builtin_assume(((!cptr_eq(input, (null)) ? 1 : 0) ? 1 : 0));
  __builtin_assume(((!cptr_eq(secret, (null)) ? 1 : 0) ? 1 : 0));
  ...
  seed = __u64(__as_bigint(seed) ^ __as_bigint(__u64(__as_bigint(__u64(__as_bigint(XXH_swap32(Number(BigInt.asIntN(32, __as_bigint(seed))))))) << __as_bigint(32))));
  {
    ...
    let bitflip: any = __u64(__as_bigint((__u64(__as_bigint(XXH_readLE64(cptr_offset(secret, 8))) ^ __as_bigint(XXH_readLE64(cptr_offset(secret, 16)))))) - __as_bigint(seed));
    let input64: any = __u64(__as_bigint(((input2) >>> 0)) + __as_bigint((__u64(__as_bigint((__u64(__as_bigint(((input1) >>> 0))))) << __as_bigint(32)))));
    let keyed: any = __u64(__as_bigint(input64) ^ __as_bigint(bitflip));
    return XXH3_rrmxmx(keyed, __as_bigint(((len) >>> 0)));
  }
}

function XXH3_len_9to16_64b(input: xxh_u8 | null, len: number, secret: xxh_u8 | null, seed: XXH64_hash_t): XXH64_hash_t {
  __builtin_assume(((!cptr_eq(input, (null)) ? 1 : 0) ? 1 : 0));
  __builtin_assume(((!cptr_eq(secret, (null)) ? 1 : 0) ? 1 : 0));
  __builtin_assume(((((((9) >>> 0) <= ((len) >>> 0) ? 1 : 0) && (((len) >>> 0) <= ((16) >>> 0) ? 1 : 0)) ? 1 : 0) ? 1 : 0));
  {
    let bitflip1: any = __u64(__as_bigint((__u64(__as_bigint(XXH_readLE64(cptr_offset(secret, 24))) ^ __as_bigint(XXH_readLE64(cptr_offset(secret, 32)))))) + __as_bigint(seed));
    let bitflip2: any = __u64(__as_bigint((__u64(__as_bigint(XXH_readLE64(cptr_offset(secret, 40))) ^ __as_bigint(XXH_readLE64(cptr_offset(secret, 48)))))) - __as_bigint(seed));
    let input_lo: any = __u64(__as_bigint(XXH_readLE64(input)) ^ __as_bigint(bitflip1));
    let input_hi: any = __u64(__as_bigint(XXH_readLE64(cptr_offset(cptr_offset(input, ((len) >>> 0)), -(8)))) ^ __as_bigint(bitflip2));
    let acc: any = __u64(__as_bigint(__u64(__as_bigint(__u64(__as_bigint(((len) >>> 0)) + __as_bigint(XXH_swap64(input_lo)))) + __as_bigint(input_hi))) + __as_bigint(XXH3_mul128_fold64(input_lo, input_hi)));
    return XXH3_avalanche(acc);
  }
}

function XXH3_len_0to16_64b(input: xxh_u8 | null, len: number, secret: xxh_u8 | null, seed: XXH64_hash_t): XXH64_hash_t {
...
function XXH3_mix16B(input: xxh_u8 | null, secret: xxh_u8 | null, seed64: xxh_u64): xxh_u64 {
  {
    let input_lo: any = XXH_readLE64(input);
    let input_hi: any = XXH_readLE64(cptr_offset(input, 8));
...
function XXH3_len_17to128_64b(input: xxh_u8 | null, len: number, secret: xxh_u8 | null, secretSize: number, seed: XXH64_hash_t): XXH64_hash_t {
  __builtin_assume(((((secretSize) >>> 0) >= ((136) >>> 0) ? 1 : 0) ? 1 : 0));
  (((secretSize) >>> 0));
  __builtin_assume(((((((16) >>> 0) < ((len) >>> 0) ? 1 : 0) && (((len) >>> 0) <= ((128) >>> 0) ? 1 : 0)) ? 1 : 0) ? 1 : 0));
  {
    let acc: any = __u64(__as_bigint(((len) >>> 0)) * __as_bigint(11400714785074694791n));
    if ((((len) >>> 0) > ((32) >>> 0) ? 1 : 0)) {
      if ((((len) >>> 0) > ((64) >>> 0) ? 1 : 0)) {
        if ((((len) >>> 0) > ((96) >>> 0) ? 1 : 0)) {
...
function XXH3_len_129to240_64b(input: xxh_u8 | null, len: number, secret: xxh_u8 | null, secretSize: number, seed: XXH64_hash_t): XXH64_hash_t {
  __builtin_assume(((((secretSize) >>> 0) >= ((136) >>> 0) ? 1 : 0) ? 1 : 0));
  (((secretSize) >>> 0));
...
function XXH_writeLE64(dst: any | null, v64: xxh_u64): void {
  if ((!1 ? 1 : 0)) {
    v64 = XXH_swap64(v64);
  }
...
type xxh_i64 = any;
function XXH_mult32to64_add64(lhs: xxh_u64, rhs: xxh_u64, acc: xxh_u64): xxh_u64 {
...
function XXH3_scalarRound(acc: any | null, input: any | null, secret: any | null, lane: number): void {
  ...
  {
    let data_val: any = XXH_readLE64(cptr_offset(xinput, ((lane) >>> 0) * ((8) >>> 0)));
    let data_key: any = __u64(__as_bigint(data_val) ^ __as_bigint(XXH_readLE64(cptr_offset(xsecret, ((lane) >>> 0) * ((8) >>> 0)))));
...
function XXH3_accumulate_512_scalar(acc: any | null, input: any | null, secret: any | null): void {
  let i = 0;
...
function XXH3_accumulate_scalar(acc: xxh_u64 | null, input: xxh_u8 | null, secret: xxh_u8 | null, nbStripes: number): void {
  let n = 0;
...
function XXH3_scalarScrambleRound(acc: any | null, secret: any | null, lane: number): void {
  let xacc = cptr_clone((acc)); /* &ref */
  let xsecret = cptr_clone(cptr_clone((secret))); /* &ref */
  __builtin_assume(((((((Math.trunc(+(__rt_ptr_to_intptr(acc)))) >>> 0)) & (((i32(8 - 1))) >>> 0)) == ((0) >>> 0) ? 1 : 0) ? 1 : 0));
  __builtin_assume(((((lane) >>> 0) < (__safe_div(64, 8)) ? 1 : 0) ? 1 : 0));
  {
    let key64: any = XXH_readLE64(cptr_offset(xsecret, ((lane) >>> 0) * ((8) >>> 0)));
    let acc64: any = cptr_read_uint64(xacc, ((lane) >>> 0));
...
function XXH3_scrambleAcc_scalar(acc: any | null, secret: any | null): void {
  let i = 0;
  for (i = ((0) >>> 0); (((i) >>> 0) < (__safe_div(64, 8)) ? 1 : 0); (() => { const _t = i; i = u32(i + 1); return _t; })()) {
...
function XXH3_initCustomSecret_scalar(customSecret: any | null, seed64: xxh_u64): void {
  ...
  } while (0);
  {
    ...
    for (i = 0; (i < nbRounds ? 1 : 0); i++) {
      let lo: any = __u64(__as_bigint(XXH_readLE64(cptr_offset(kSecretPtr, Math.imul(16, i)))) + __as_bigint(seed64));
      let hi: any = __u64(__as_bigint(XXH_readLE64(cptr_offset(cptr_offset(kSecretPtr, Math.imul(16, i)), 8))) - __as_bigint(seed64));
...
type XXH3_f_accumulate = (...args: any[]) => any;
type XXH3_f_scrambleAcc = (...args: any[]) => any;
type XXH3_f_initCustomSecret = (...args: any[]) => any;
function XXH3_hashLong_internal_loop(acc: xxh_u64 | null, input: xxh_u8 | null, len: number, secret: xxh_u8 | null, secretSize: number, f_acc: XXH3_f_accumulate, f_scramble: XXH3_f_scrambleAcc): void {
...
function XXH3_mix2Accs(acc: xxh_u64 | null, secret: xxh_u8 | null): xxh_u64 {
...
function XXH3_mergeAccs(acc: xxh_u64 | null, secret: xxh_u8 | null, start: xxh_u64): XXH64_hash_t {
  let result64: any = start;
  let i = ((0) >>> 0);
...
function XXH3_hashLong_64b_internal(input: any | null, len: number, secret: any | null, secretSize: number, f_acc: XXH3_f_accumulate, f_scramble: XXH3_f_scrambleAcc): XXH64_hash_t {
...
function XXH3_hashLong_64b_withSecret(input: any | null, len: number, seed64: XXH64_hash_t, secret: xxh_u8 | null, secretLen: number): XXH64_hash_t {
  (seed64);
  return XXH3_hashLong_64b_internal(input, ((len) >>> 0), secret, ((secretLen) >>> 0), XXH3_accumulate_scalar, XXH3_scrambleAcc_scalar);
}

function XXH3_hashLong_64b_default(input: any | null, len: number, seed64: XXH64_hash_t, secret: xxh_u8 | null, secretLen: number): XXH64_hash_t {
  (seed64);
  (secret);
  (((secretLen) >>> 0));
...
function XXH3_hashLong_64b_withSeed_internal(input: any | null, len: number, seed: XXH64_hash_t, f_acc: XXH3_f_accumulate, f_scramble: XXH3_f_scrambleAcc, f_initSec: XXH3_f_initCustomSecret): XXH64_hash_t {
  if ((seed == 0 ? 1 : 0)) {
...
function XXH3_hashLong_64b_withSeed(input: any | null, len: number, seed: XXH64_hash_t, secret: xxh_u8 | null, secretLen: number): XXH64_hash_t {
  (secret);
  (((secretLen) >>> 0));
...
type XXH3_hashLong64_f = (...args: any[]) => any;
function XXH3_64bits_internal(input: any | null, len: number, seed64: XXH64_hash_t, secret: any | null, secretLen: number, f_hashLong: XXH3_hashLong64_f): XXH64_hash_t {
...
export function XXH3_64bits(input: any | null, length: number): XXH64_hash_t {
  return XXH3_64bits_internal(input, ((length) >>> 0), 0, XXH3_kSecret, 1536, XXH3_hashLong_64b_default);
}

export function XXH3_64bits_withSecret(input: any | null, length: number, secret: any | null, secretSize: number): XXH64_hash_t {
  return XXH3_64bits_internal(input, ((length) >>> 0), 0, secret, ((secretSize) >>> 0), XXH3_hashLong_64b_withSecret);
}

export function XXH3_64bits_withSeed(input: any | null, length: number, seed: XXH64_hash_t): XXH64_hash_t {
  return XXH3_64bits_internal(input, ((length) >>> 0), seed, XXH3_kSecret, 1536, XXH3_hashLong_64b_withSeed);
}

export function XXH3_64bits_withSecretandSeed(input: any | null, length: number, secret: any | null, secretSize: number, seed: XXH64_hash_t): XXH64_hash_t {
...
function XXH_alignedMalloc(s: number, align: number): any | null {
...
function XXH_alignedFree(p: any | null): void {
...
export function XXH3_createState(): XXH3_state_t | null {
...
export function XXH3_freeState(statePtr: XXH3_state_t | null): XXH_errorcode {
  XXH_alignedFree(statePtr);
  return XXH_OK;
}

export function XXH3_copyState(dst_state: XXH3_state_t | null, src_state: XXH3_state_t | null): void {
  XXH_memcpy(dst_state, src_state, 584);
}

function XXH3_reset_internal(statePtr: XXH3_state_t | null, seed: XXH64_hash_t, secret: any | null, secretSize: number): void {
  let initStart = 0;
...
export function XXH3_64bits_reset(statePtr: XXH3_state_t | null): XXH_errorcode {
...
export function XXH3_64bits_reset_withSecret(statePtr: XXH3_state_t | null, secret: any | null, secretSize: number): XXH_errorcode {
  if ((statePtr == (null) ? 1 : 0)) {
    return XXH_ERROR;
  }
...
export function XXH3_64bits_reset_withSeed(statePtr: XXH3_state_t | null, seed: XXH64_hash_t): XXH_errorcode {
  if ((statePtr == (null) ? 1 : 0)) {
    return XXH_ERROR;
  }
  if ((seed == 0 ? 1 : 0)) {
...
export function XXH3_64bits_reset_withSecretandSeed(statePtr: XXH3_state_t | null, secret: any, secretSize: number, seed64: XXH64_hash_t): XXH_errorcode {
  if ((statePtr == (null) ? 1 : 0)) {
    return XXH_ERROR;
  }
  if ((cptr_eq(secret, (null)) ? 1 : 0)) {
...
function XXH3_consumeStripes(acc: xxh_u64 | null, nbStripesSoFarPtr: COutParam<number | null>, nbStripesPerBlock: number, input: xxh_u8 | null, nbStripes: number, secret: xxh_u8 | null, secretLimit: number, f_acc: XXH3_f_accumulate, f_scramble: XXH3_f_scrambleAcc): xxh_u8 | null {
...
function XXH3_update(state: XXH3_state_t | null, input: xxh_u8 | null, len: number, f_acc: XXH3_f_accumulate, f_scramble: XXH3_f_scrambleAcc): XXH_errorcode {
  if ((cptr_eq(input, (null)) ? 1 : 0)) {
    __builtin_assume(((((len) >>> 0) == ((0) >>> 0) ? 1 : 0) ? 1 : 0));
    return XXH_OK;
  }
  __builtin_assume(((state != (null) ? 1 : 0) ? 1 : 0));
  {
    ...
    __builtin_assume(((((__l: any, __r: any) => { const __lb = __l && __l.buf; const __rb = __r && __r.buf; if (__lb && __rb && __lb === __rb) return ((__l.off ?? 0) < (__r.off ?? 0)); if (__lb || __rb) return (__rt_ptr_to_intptr(__l) < __rt_ptr_to_intptr(__r)); return ((__l ?? 0) < (__r ?? 0)); })(input, bEnd) ? 1 : 0) ? 1 : 0));
    if ((((__lp: any, __rp: any) => { const __lb = __lp && __lp.buf; const __rb = __rp && __rp.buf; if (__lb && __rb && __lb !== __rb) return (__rt_ptr_to_intptr(__lp) - __rt_ptr_to_intptr(__rp)); return (((__x) => __x == null ? 0 : (typeof __x === 'string' ? 0 : (__x && __x.__field_ref === true ? ((__x.__field_offset ?? 0) + (__x.__byte_delta ?? 0)) : (typeof __x === 'object' && __x.off === undefined ? 0 : (__x.off ?? __x)))))(__lp) - ((__x) => __x == null ? 0 : (typeof __x === 'string' ? 0 : (__x && __x.__field_ref === true ? ((__x.__field_offset ?? 0) + (__x.__byte_delta ?? 0)) : (typeof __x === 'object' && __x.off === undefined ? 0 : (__x.off ?? __x)))))(__rp)); })(bEnd, input) > 256 ? 1 : 0)) {
      let nbStripes = __safe_div(((Math.trunc(+((((__lp: any, __rp: any) => { const __lb = __lp && __lp.buf; const __rb = __rp && __rp.buf; if (__lb && __rb && __lb !== __rb) return (__rt_ptr_to_intptr(__lp) - __rt_ptr_to_intptr(__rp)); return (((__x) => __x == null ? 0 : (typeof __x === 'string' ? 0 : (__x && __x.__field_ref === true ? ((__x.__field_offset ?? 0) + (__x.__byte_delta ?? 0)) : (typeof __x === 'object' && __x.off === undefined ? 0 : (__x.off ?? __x)))))(__lp) - ((__x) => __x == null ? 0 : (typeof __x === 'string' ? 0 : (__x && __x.__field_ref === true ? ((__x.__field_offset ?? 0) + (__x.__byte_delta ?? 0)) : (typeof __x === 'object' && __x.off === undefined ? 0 : (__x.off ?? __x)))))(__rp)); })(cptr_offset(bEnd, -(1)), input))))) >>> 0), ((64) >>> 0));
    ...
    __builtin_assume(((((__l: any, __r: any) => { const __lb = __l && __l.buf; const __rb = __r && __r.buf; if (__lb && __rb && __lb === __rb) return ((__l.off ?? 0) < (__r.off ?? 0)); if (__lb || __rb) return (__rt_ptr_to_intptr(__l) < __rt_ptr_to_intptr(__r)); return ((__l ?? 0) < (__r ?? 0)); })(input, bEnd) ? 1 : 0) ? 1 : 0));
    __builtin_assume(((((__lp: any, __rp: any) => { const __lb = __lp && __lp.buf; const __rb = __rp && __rp.buf; if (__lb && __rb && __lb !== __rb) return (__rt_ptr_to_intptr(__lp) - __rt_ptr_to_intptr(__rp)); return (((__x) => __x == null ? 0 : (typeof __x === 'string' ? 0 : (__x && __x.__field_ref === true ? ((__x.__field_offset ?? 0) + (__x.__byte_delta ?? 0)) : (typeof __x === 'object' && __x.off === undefined ? 0 : (__x.off ?? __x)))))(__lp) - ((__x) => __x == null ? 0 : (typeof __x === 'string' ? 0 : (__x && __x.__field_ref === true ? ((__x.__field_offset ?? 0) + (__x.__byte_delta ?? 0)) : (typeof __x === 'object' && __x.off === undefined ? 0 : (__x.off ?? __x)))))(__rp)); })(bEnd, input) <= 256 ? 1 : 0) ? 1 : 0));
    __builtin_assume((((((__struct_ptr_at(state, 0)).bufferedSize) >>> 0) == ((0) >>> 0) ? 1 : 0) ? 1 : 0));
    XXH_memcpy((__struct_ptr_at(state, 0)).buffer, input, ((Math.trunc(+((((__lp: any, __rp: any) => { const __lb = __lp && __lp.buf; const __rb = __rp && __rp.buf; if (__lb && __rb && __lb !== __rb) return (__rt_ptr_to_intptr(__lp) - __rt_ptr_to_intptr(__rp)); return (((__x) => __x == null ? 0 : (typeof __x === 'string' ? 0 : (__x && __x.__field_ref === true ? ((__x.__field_offset ?? 0) + (__x.__byte_delta ?? 0)) : (typeof __x === 'object' && __x.off === undefined ? 0 : (__x.off ?? __x)))))(__lp) - ((__x) => __x == null ? 0 : (typeof __x === 'string' ? 0 : (__x && __x.__field_ref === true ? ((__x.__field_offset ?? 0) + (__x.__byte_delta ?? 0)) : (typeof __x === 'object' && __x.off === undefined ? 0 : (__x.off ?? __x)))))(__rp)); })(bEnd, input))))) >>> 0));
    (__struct_ptr_at(state, 0)).bufferedSize = Math.trunc(+((((__lp: any, __rp: any) => { const __lb = __lp && __lp.buf; const __rb = __rp && __rp.buf; if (__lb && __rb && __lb !== __rb) return (__rt_ptr_to_intptr(__lp) - __rt_ptr_to_intptr(__rp)); return (((__x) => __x == null ? 0 : (typeof __x === 'string' ? 0 : (__x && __x.__field_ref === true ? ((__x.__field_offset ?? 0) + (__x.__byte_delta ?? 0)) : (typeof __x === 'object' && __x.off === undefined ? 0 : (__x.off ?? __x)))))(__lp) - ((__x) => __x == null ? 0 : (typeof __x === 'string' ? 0 : (__x && __x.__field_ref === true ? ((__x.__field_offset ?? 0) + (__x.__byte_delta ?? 0)) : (typeof __x === 'object' && __x.off === undefined ? 0 : (__x.off ?? __x)))))(__rp)); })(bEnd, input))));
  }
  return XXH_OK;
}

export function XXH3_64bits_update(state: XXH3_state_t | null, input: any | null, len: number): XXH_errorcode {
  return XXH3_update(state, (input), ((len) >>> 0), XXH3_accumulate_scalar, XXH3_scrambleAcc_scalar);
}

function XXH3_digest_long(acc: XXH64_hash_t | null, state: XXH3_state_t | null, secret: any | null): void {
...
export function XXH3_64bits_digest(state: XXH3_state_t | null): XXH64_hash_t {
  let secret = (((cptr_eq((__struct_ptr_at(state, 0)).extSecret, (null)) ? 1 : 0)) ? (__struct_ptr_at(state, 0)).customSecret : (__struct_ptr_at(state, 0)).extSecret); /* &ref */
...
function XXH3_len_1to3_128b(input: any, len: number, secret: xxh_u8 | null, seed: XXH64_hash_t): XXH128_hash_t {
  if (typeof input === 'string') input = cptr_from_string(input);
  ...
  __builtin_assume(((!cptr_eq(secret, (null)) ? 1 : 0) ? 1 : 0));
  {
    ...
    let bitflipl: any = __u64(__as_bigint(((XXH_readLE32(secret) ^ XXH_readLE32(cptr_offset(secret, 4))) >>> 0)) + __as_bigint(seed));
    let bitfliph: any = __u64(__as_bigint(((XXH_readLE32(cptr_offset(secret, 8)) ^ XXH_readLE32(cptr_offset(secret, 12))) >>> 0)) - __as_bigint(seed));
    let keyed_lo: any = __u64(__as_bigint(__u64(__as_bigint(((combinedl) >>> 0)))) ^ __as_bigint(bitflipl));
    let keyed_hi: any = __u64(__as_bigint(__u64(__as_bigint(((combinedh) >>> 0)))) ^ __as_bigint(bitfliph));
...
function XXH3_len_4to8_128b(input: xxh_u8 | null, len: number, secret: xxh_u8 | null, seed: XXH64_hash_t): XXH128_hash_t {
  __builtin_assume(((!cptr_eq(input, (null)) ? 1 : 0) ? 1 : 0));
  __builtin_assume(((!cptr_eq(secret, (null)) ? 1 : 0) ? 1 : 0));
  __builtin_assume(((((((4) >>> 0) <= ((len) >>> 0) ? 1 : 0) && (((len) >>> 0) <= ((8) >>> 0) ? 1 : 0)) ? 1 : 0) ? 1 : 0));
  seed = __u64(__as_bigint(seed) ^ __as_bigint(__u64(__as_bigint(__u64(__as_bigint(XXH_swap32(Number(BigInt.asIntN(32, __as_bigint(seed))))))) << __as_bigint(32))));
  {
    ...
    let input_64: any = __u64(__as_bigint(((input_lo) >>> 0)) + __as_bigint((__u64(__as_bigint(__u64(__as_bigint(((input_hi) >>> 0)))) << __as_bigint(32)))));
    let bitflip: any = __u64(__as_bigint((__u64(__as_bigint(XXH_readLE64(cptr_offset(secret, 16))) ^ __as_bigint(XXH_readLE64(cptr_offset(secret, 24)))))) + __as_bigint(seed));
    let keyed: any = __u64(__as_bigint(input_64) ^ __as_bigint(bitflip));
...
function XXH3_len_9to16_128b(input: xxh_u8 | null, len: number, secret: xxh_u8 | null, seed: XXH64_hash_t): XXH128_hash_t {
  __builtin_assume(((!cptr_eq(input, (null)) ? 1 : 0) ? 1 : 0));
  __builtin_assume(((!cptr_eq(secret, (null)) ? 1 : 0) ? 1 : 0));
  __builtin_assume(((((((9) >>> 0) <= ((len) >>> 0) ? 1 : 0) && (((len) >>> 0) <= ((16) >>> 0) ? 1 : 0)) ? 1 : 0) ? 1 : 0));
  {
    let bitflipl: any = __u64(__as_bigint((__u64(__as_bigint(XXH_readLE64(cptr_offset(secret, 32))) ^ __as_bigint(XXH_readLE64(cptr_offset(secret, 40)))))) - __as_bigint(seed));
    let bitfliph: any = __u64(__as_bigint((__u64(__as_bigint(XXH_readLE64(cptr_offset(secret, 48))) ^ __as_bigint(XXH_readLE64(cptr_offset(secret, 56)))))) + __as_bigint(seed));
    let input_lo: any = XXH_readLE64(input);
    let input_hi: any = XXH_readLE64(cptr_offset(cptr_offset(input, ((len) >>> 0)), -(8)));
...
function XXH3_len_0to16_128b(input: xxh_u8 | null, len: number, secret: xxh_u8 | null, seed: XXH64_hash_t): XXH128_hash_t {
  __builtin_assume(((((len) >>> 0) <= ((16) >>> 0) ? 1 : 0) ? 1 : 0));
  {
    if ((((len) >>> 0) > ((8) >>> 0) ? 1 : 0)) {
    ...
    }
    {
      {
        let h128 = new XXH128_hash_t();
        let bitflipl: any = __u64(__as_bigint(XXH_readLE64(cptr_offset(secret, 64))) ^ __as_bigint(XXH_readLE64(cptr_offset(secret, 72))));
        let bitfliph: any = __u64(__as_bigint(XXH_readLE64(cptr_offset(secret, 80))) ^ __as_bigint(XXH_readLE64(cptr_offset(secret, 88))));
...
function XXH128_mix32B(acc: XXH128_hash_t, input_1: xxh_u8 | null, input_2: xxh_u8 | null, secret: xxh_u8 | null, seed: XXH64_hash_t): XXH128_hash_t {
...
function XXH3_len_17to128_128b(input: xxh_u8 | null, len: number, secret: xxh_u8 | null, secretSize: number, seed: XXH64_hash_t): XXH128_hash_t {
  __builtin_assume(((((secretSize) >>> 0) >= ((136) >>> 0) ? 1 : 0) ? 1 : 0));
  (((secretSize) >>> 0));
  __builtin_assume(((((((16) >>> 0) < ((len) >>> 0) ? 1 : 0) && (((len) >>> 0) <= ((128) >>> 0) ? 1 : 0)) ? 1 : 0) ? 1 : 0));
  {
...
function XXH3_len_129to240_128b(input: xxh_u8 | null, len: number, secret: xxh_u8 | null, secretSize: number, seed: XXH64_hash_t): XXH128_hash_t {
  __builtin_assume(((((secretSize) >>> 0) >= ((136) >>> 0) ? 1 : 0) ? 1 : 0));
  (((secretSize) >>> 0));
  __builtin_assume(((((((128) >>> 0) < ((len) >>> 0) ? 1 : 0) && (((len) >>> 0) <= ((240) >>> 0) ? 1 : 0)) ? 1 : 0) ? 1 : 0));
  {
...
function XXH3_hashLong_128b_internal(input: any | null, len: number, secret: xxh_u8 | null, secretSize: number, f_acc: XXH3_f_accumulate, f_scramble: XXH3_f_scrambleAcc): XXH128_hash_t {
  /* BRIDGE: _Alignas(8) — C11 §6.7.5 alignment requirement; JS naturally satisfies fundamental alignments (≤8 bytes), over-alignment must be enforced via alloy_aligned_alloc / SIMD-aware path */
  let acc = [3266489917, 11400714785074694791n, 14029467366897019727n, 1609587929392839161n, 9650029242287828579n, 2246822519, 2870177450012600261n, 2654435761];
  XXH3_hashLong_internal_loop(acc, (input), ((len) >>> 0), secret, ((secretSize) >>> 0), f_acc, f_scramble);
  do {
...
function XXH3_hashLong_128b_default(input: any | null, len: number, seed64: XXH64_hash_t, secret: any | null, secretLen: number): XXH128_hash_t {
  (seed64);
  (secret);
  (((secretLen) >>> 0));
...
function XXH3_hashLong_128b_withSecret(input: any | null, len: number, seed64: XXH64_hash_t, secret: any | null, secretLen: number): XXH128_hash_t {
  (seed64);
  return XXH3_hashLong_128b_internal(input, ((len) >>> 0), (secret), ((secretLen) >>> 0), XXH3_accumulate_scalar, XXH3_scrambleAcc_scalar);
}

function XXH3_hashLong_128b_withSeed_internal(input: any | null, len: number, seed64: XXH64_hash_t, f_acc: XXH3_f_accumulate, f_scramble: XXH3_f_scrambleAcc, f_initSec: XXH3_f_initCustomSecret): XXH128_hash_t {
  if ((seed64 == 0 ? 1 : 0)) {
...
function XXH3_hashLong_128b_withSeed(input: any | null, len: number, seed64: XXH64_hash_t, secret: any | null, secretLen: number): XXH128_hash_t {
  (secret);
  (((secretLen) >>> 0));
...
type XXH3_hashLong128_f = (...args: any[]) => any;
function XXH3_128bits_internal(input: any | null, len: number, seed64: XXH64_hash_t, secret: any | null, secretLen: number, f_hl128: XXH3_hashLong128_f): XXH128_hash_t {
  __builtin_assume(((((secretLen) >>> 0) >= ((136) >>> 0) ? 1 : 0) ? 1 : 0));
  if ((((len) >>> 0) <= ((16) >>> 0) ? 1 : 0)) {
...
export function XXH3_128bits(input: any | null, len: number): XXH128_hash_t {
  return XXH3_128bits_internal(input, ((len) >>> 0), 0, XXH3_kSecret, 1536, XXH3_hashLong_128b_default);
}

export function XXH3_128bits_withSecret(input: any | null, len: number, secret: any | null, secretSize: number): XXH128_hash_t {
  return XXH3_128bits_internal(input, ((len) >>> 0), 0, (secret), ((secretSize) >>> 0), XXH3_hashLong_128b_withSecret);
}

export function XXH3_128bits_withSeed(input: any | null, len: number, seed: XXH64_hash_t): XXH128_hash_t {
  return XXH3_128bits_internal(input, ((len) >>> 0), seed, XXH3_kSecret, 1536, XXH3_hashLong_128b_withSeed);
}

export function XXH3_128bits_withSecretandSeed(input: any | null, len: number, secret: any | null, secretSize: number, seed: XXH64_hash_t): XXH128_hash_t {
  if ((((len) >>> 0) <= ((240) >>> 0) ? 1 : 0)) {
...
export function XXH128(input: any | null, len: number, seed: XXH64_hash_t): XXH128_hash_t {
  return XXH3_128bits_withSeed(input, ((len) >>> 0), seed);
}

export function XXH3_128bits_reset(statePtr: XXH3_state_t | null): XXH_errorcode {
  return XXH3_64bits_reset(statePtr);
}

export function XXH3_128bits_reset_withSecret(statePtr: XXH3_state_t | null, secret: any | null, secretSize: number): XXH_errorcode {
  return XXH3_64bits_reset_withSecret(statePtr, secret, ((secretSize) >>> 0));
}

export function XXH3_128bits_reset_withSeed(statePtr: XXH3_state_t | null, seed: XXH64_hash_t): XXH_errorcode {
  return XXH3_64bits_reset_withSeed(statePtr, seed);
}

export function XXH3_128bits_reset_withSecretandSeed(statePtr: XXH3_state_t | null, secret: any | null, secretSize: number, seed: XXH64_hash_t): XXH_errorcode {
  return XXH3_64bits_reset_withSecretandSeed(statePtr, secret, ((secretSize) >>> 0), seed);
}

export function XXH3_128bits_update(state: XXH3_state_t | null, input: any | null, len: number): XXH_errorcode {
  return XXH3_64bits_update(state, input, ((len) >>> 0));
}

export function XXH3_128bits_digest(state: XXH3_state_t | null): XXH128_hash_t {
  let secret = (((cptr_eq((__struct_ptr_at(state, 0)).extSecret, (null)) ? 1 : 0)) ? (__struct_ptr_at(state, 0)).customSecret : (__struct_ptr_at(state, 0)).extSecret); /* &ref */
  if (((__as_bigint((__struct_ptr_at(state, 0)).totalLen) > __as_bigint(240)) ? 1 : 0)) {
    /* BRIDGE: _Alignas(8) — C11 §6.7.5 alignment requirement; JS naturally satisfies fundamental alignments (≤8 bytes), over-alignment must be enforced via alloy_aligned_alloc / SIMD-aware path */
    let acc = new Array(8).fill(0);
...
export function XXH128_isEqual(h1: XXH128_hash_t, h2: XXH128_hash_t): number {
  return ((!(memcmp(h1, h2, 16)) ? 1 : 0) ? 1 : 0);
}

export function XXH128_cmp(h128_1: any | null, h128_2: any | null): number {
...
export function XXH128_canonicalFromHash(dst: XXH128_canonical_t | null, hash: XXH128_hash_t): void {
  do {
  } while (0);
  if (1) {
...
export function XXH128_hashFromCanonical(src: XXH128_canonical_t | null): XXH128_hash_t {
...
function XXH3_combine16(dst: any | null, h128: XXH128_hash_t): void {
...
export function XXH3_generateSecret(secretBuffer: any | null, secretSize: number, customSeed: any | null, customSeedSize: number): XXH_errorcode {
...
export function XXH3_generateSecret_fromSeed(secretBuffer: any, seed: XXH64_hash_t): void {
  /* BRIDGE: _Alignas(8) — C11 §6.7.5 alignment requirement; JS naturally satisfies fundamental alignments (≤8 bytes), over-alignment must be enforced via alloy_aligned_alloc / SIMD-aware path */
  let secret = cptr_create(192);
