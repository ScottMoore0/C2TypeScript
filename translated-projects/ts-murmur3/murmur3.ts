let h: any = null; // BRIDGE: dropped-file-scope-static — see Rule 41j (lvalue without decl)
let k: any = null; // BRIDGE: dropped-file-scope-static — see Rule 41j (lvalue without decl)
...
export function rotl32(x: number, r: number): number {
  return (((((x) >>> 0) << ((r) << 24 >> 24)) >>> 0) | ((((x) >>> 0) >>> (i32(32 - ((r) << 24 >> 24)))) >>> 0)) >>> 0;
}

export function rotl64(x: number, r: number): number {
  return __u64(__as_bigint((__u64(__as_bigint(/* WARNING: 64-bit integer may lose precision beyond 2^53 */ x) << __as_bigint(((r) << 24 >> 24))))) | __as_bigint((__u64(__u64(__as_bigint(/* WARNING: 64-bit integer may lose precision beyond 2^53 */ x)) >> __as_bigint((i32(64 - ((r) << 24 >> 24))))))));
}
...
export function fmix64(k: number): number {
  k = __u64(__as_bigint(k) ^ __as_bigint(__u64(__u64(__as_bigint(/* WARNING: 64-bit integer may lose precision beyond 2^53 */ k)) >> __as_bigint(33))));
  k = __u64(__as_bigint(k) * __as_bigint((18397679294719823053n)));
  k = __u64(__as_bigint(k) ^ __as_bigint(__u64(__u64(__as_bigint(/* WARNING: 64-bit integer may lose precision beyond 2^53 */ k)) >> __as_bigint(33))));
  k = __u64(__as_bigint(k) * __as_bigint((14181476777654086739n)));
  k = __u64(__as_bigint(k) ^ __as_bigint(__u64(__u64(__as_bigint(/* WARNING: 64-bit integer may lose precision beyond 2^53 */ k)) >> __as_bigint(33))));
  return /* WARNING: 64-bit integer may lose precision beyond 2^53 */ k;
}

export function MurmurHash3_x86_32(key: any | null, len: number, seed: number, out: any | null): void {
  let data = cptr_clone(cptr_clone((key))); /* &ref */
  let nblocks = __safe_div(len, 4);
  let i = 0;
  let h1 = ((seed) >>> 0);
  let c1 = 3432918353;
  let c2 = ((461845907) >>> 0);
  let blocks = ((cptr_offset(data, Math.imul(nblocks, 4)))); /* &ref */
  for (i = -nblocks; i; i++) {
    let k1 = (((cptr_read_uint32(blocks, i))) >>> 0);
    k1 = (Math.imul(k1, ((c1) >>> 0)) >>> 0);
    k1 = rotl32(((k1) >>> 0), ((15) << 24 >> 24));
    k1 = (Math.imul(k1, ((c2) >>> 0)) >>> 0);
    h1 = (h1 ^ ((k1) >>> 0)) >>> 0;
    h1 = rotl32(((h1) >>> 0), ((13) << 24 >> 24));
    h1 = u32((Math.imul(((h1) >>> 0), ((5) >>> 0)) >>> 0) + 3864292196);
  }
  let tail = ((cptr_offset(data, Math.imul(nblocks, 4)))); /* &ref */
  let k1 = ((0) >>> 0);
  switch (len & 3) {
    case 3:
    {
      k1 = (k1 ^ ((((((tail.buf[(tail.off ?? 0) + 2]) & 0xFF) << 16) | 0)) >>> 0)) >>> 0;
    }
    case 2:
    {
      k1 = (k1 ^ ((((((tail.buf[(tail.off ?? 0) + 1]) & 0xFF) << 8) | 0)) >>> 0)) >>> 0;
    }
    case 1:
    {
      k1 = (k1 ^ ((((tail.buf[(tail.off ?? 0) + 0]) & 0xFF)) >>> 0)) >>> 0;
    k1 = (Math.imul(k1, ((c1) >>> 0)) >>> 0);
    k1 = rotl32(((k1) >>> 0), ((15) << 24 >> 24));
    k1 = (Math.imul(k1, ((c2) >>> 0)) >>> 0);
    h1 = (h1 ^ ((k1) >>> 0)) >>> 0;
  ...
  h1 = (h1 ^ ((len) >>> 0)) >>> 0;
  h1 = fmix32(((h1) >>> 0));
  (() => { const __p: any = ((out)); const __v: any = (((h1) >>> 0)); if (__p && __p.__field_ref === true) { __p.value = __v; } else { cptr_write_uint32(__p, 0, __v); } return __v; })();
}

export function MurmurHash3_x86_128(key: any | null, len: number, seed: number, out: any | null): void {
  let data = cptr_clone(cptr_clone((key))); /* &ref */
  let nblocks = __safe_div(len, 16);
  let i = 0;
  let h1 = ((seed) >>> 0);
  let h2 = ((seed) >>> 0);
  let h3 = ((seed) >>> 0);
  ...
  let c3 = ((951274213) >>> 0);
  let c4 = 2716044179;
  let blocks = ((cptr_offset(data, Math.imul(nblocks, 16)))); /* &ref */
  for (i = -nblocks; i; i++) {
    let k1 = (((cptr_read_uint32(blocks, i32(Math.imul(i, 4) + 0)))) >>> 0);
    let k2 = (((cptr_read_uint32(blocks, i32(Math.imul(i, 4) + 1)))) >>> 0);
    let k3 = (((cptr_read_uint32(blocks, i32(Math.imul(i, 4) + 2)))) >>> 0);
    let k4 = (((cptr_read_uint32(blocks, i32(Math.imul(i, 4) + 3)))) >>> 0);
    k1 = (Math.imul(k1, ((c1) >>> 0)) >>> 0);
    k1 = rotl32(((k1) >>> 0), ((15) << 24 >> 24));
    k1 = (Math.imul(k1, ((c2) >>> 0)) >>> 0);
    h1 = (h1 ^ ((k1) >>> 0)) >>> 0;
    h1 = rotl32(((h1) >>> 0), ((19) << 24 >> 24));
    h1 = u32(h1 + ((h2) >>> 0));
    h1 = u32((Math.imul(((h1) >>> 0), ((5) >>> 0)) >>> 0) + ((1444728091) >>> 0));
    k2 = (Math.imul(k2, ((c2) >>> 0)) >>> 0);
    k2 = rotl32(((k2) >>> 0), ((16) << 24 >> 24));
    k2 = (Math.imul(k2, ((c3) >>> 0)) >>> 0);
    h2 = (h2 ^ ((k2) >>> 0)) >>> 0;
    h2 = rotl32(((h2) >>> 0), ((17) << 24 >> 24));
    h2 = u32(h2 + ((h3) >>> 0));
    h2 = u32((Math.imul(((h2) >>> 0), ((5) >>> 0)) >>> 0) + ((197830471) >>> 0));
    k3 = (Math.imul(k3, ((c3) >>> 0)) >>> 0);
    k3 = rotl32(((k3) >>> 0), ((17) << 24 >> 24));
    k3 = (Math.imul(k3, ((c4) >>> 0)) >>> 0);
    h3 = (h3 ^ ((k3) >>> 0)) >>> 0;
    h3 = rotl32(((h3) >>> 0), ((15) << 24 >> 24));
    h3 = u32(h3 + ((h4) >>> 0));
    h3 = u32((Math.imul(((h3) >>> 0), ((5) >>> 0)) >>> 0) + 2530024501);
    k4 = (Math.imul(k4, ((c4) >>> 0)) >>> 0);
    k4 = rotl32(((k4) >>> 0), ((18) << 24 >> 24));
    k4 = (Math.imul(k4, ((c1) >>> 0)) >>> 0);
    h4 = (h4 ^ ((k4) >>> 0)) >>> 0;
    h4 = rotl32(((h4) >>> 0), ((13) << 24 >> 24));
    h4 = u32(h4 + ((h1) >>> 0));
    h4 = u32((Math.imul(((h4) >>> 0), ((5) >>> 0)) >>> 0) + ((850148119) >>> 0));
  }
  let tail = ((cptr_offset(data, Math.imul(nblocks, 16)))); /* &ref */
  let k1 = ((0) >>> 0);
  let k2 = ((0) >>> 0);
  let k3 = ((0) >>> 0);
  let k4 = ((0) >>> 0);
  switch (len & 15) {
    case 15:
    {
      k4 = (k4 ^ ((((((tail.buf[(tail.off ?? 0) + 14]) & 0xFF) << 16) | 0)) >>> 0)) >>> 0;
    }
    case 14:
    {
      k4 = (k4 ^ ((((((tail.buf[(tail.off ?? 0) + 13]) & 0xFF) << 8) | 0)) >>> 0)) >>> 0;
    }
    case 13:
    {
      k4 = (k4 ^ ((((((tail.buf[(tail.off ?? 0) + 12]) & 0xFF) << 0) | 0)) >>> 0)) >>> 0;
    k4 = (Math.imul(k4, ((c4) >>> 0)) >>> 0);
    k4 = rotl32(((k4) >>> 0), ((18) << 24 >> 24));
    k4 = (Math.imul(k4, ((c1) >>> 0)) >>> 0);
    h4 = (h4 ^ ((k4) >>> 0)) >>> 0;
    ...
    case 12:
    {
      k3 = (k3 ^ ((((((tail.buf[(tail.off ?? 0) + 11]) & 0xFF) << 24) | 0)) >>> 0)) >>> 0;
    }
    case 11:
    {
      k3 = (k3 ^ ((((((tail.buf[(tail.off ?? 0) + 10]) & 0xFF) << 16) | 0)) >>> 0)) >>> 0;
    }
    case 10:
    {
      k3 = (k3 ^ ((((((tail.buf[(tail.off ?? 0) + 9]) & 0xFF) << 8) | 0)) >>> 0)) >>> 0;
    }
    case 9:
    {
      k3 = (k3 ^ ((((((tail.buf[(tail.off ?? 0) + 8]) & 0xFF) << 0) | 0)) >>> 0)) >>> 0;
    k3 = (Math.imul(k3, ((c3) >>> 0)) >>> 0);
    k3 = rotl32(((k3) >>> 0), ((17) << 24 >> 24));
    k3 = (Math.imul(k3, ((c4) >>> 0)) >>> 0);
    h3 = (h3 ^ ((k3) >>> 0)) >>> 0;
    ...
    case 8:
    {
      k2 = (k2 ^ ((((((tail.buf[(tail.off ?? 0) + 7]) & 0xFF) << 24) | 0)) >>> 0)) >>> 0;
    }
    case 7:
    {
      k2 = (k2 ^ ((((((tail.buf[(tail.off ?? 0) + 6]) & 0xFF) << 16) | 0)) >>> 0)) >>> 0;
    }
    case 6:
    {
      k2 = (k2 ^ ((((((tail.buf[(tail.off ?? 0) + 5]) & 0xFF) << 8) | 0)) >>> 0)) >>> 0;
    }
    case 5:
    {
      k2 = (k2 ^ ((((((tail.buf[(tail.off ?? 0) + 4]) & 0xFF) << 0) | 0)) >>> 0)) >>> 0;
    k2 = (Math.imul(k2, ((c2) >>> 0)) >>> 0);
    k2 = rotl32(((k2) >>> 0), ((16) << 24 >> 24));
    k2 = (Math.imul(k2, ((c3) >>> 0)) >>> 0);
    h2 = (h2 ^ ((k2) >>> 0)) >>> 0;
    ...
    case 4:
    {
      k1 = (k1 ^ ((((((tail.buf[(tail.off ?? 0) + 3]) & 0xFF) << 24) | 0)) >>> 0)) >>> 0;
    }
    case 3:
    {
      k1 = (k1 ^ ((((((tail.buf[(tail.off ?? 0) + 2]) & 0xFF) << 16) | 0)) >>> 0)) >>> 0;
    ...
    case 1:
    {
      k1 = (k1 ^ ((((((tail.buf[(tail.off ?? 0) + 0]) & 0xFF) << 0) | 0)) >>> 0)) >>> 0;
    k1 = (Math.imul(k1, ((c1) >>> 0)) >>> 0);
    k1 = rotl32(((k1) >>> 0), ((15) << 24 >> 24));
    k1 = (Math.imul(k1, ((c2) >>> 0)) >>> 0);
    h1 = (h1 ^ ((k1) >>> 0)) >>> 0;
  ...
  h3 = u32(h3 + ((h1) >>> 0));
  h4 = u32(h4 + ((h1) >>> 0));
  cptr_write_uint32(((out)), 0, ((h1) >>> 0));
  cptr_write_uint32(((out)), 1, ((h2) >>> 0));
  cptr_write_uint32(((out)), 2, ((h3) >>> 0));
  cptr_write_uint32(((out)), 3, ((h4) >>> 0));
}

export function MurmurHash3_x64_128(key: any | null, len: number, seed: number, out: any | null): void {
  let data = cptr_clone(cptr_clone((key))); /* &ref */
  let nblocks = __safe_div(len, 16);
  let i = 0;
  let h1: any = /* WARNING: 64-bit integer may lose precision beyond 2^53 */ ((seed) >>> 0);
  let h2: any = /* WARNING: 64-bit integer may lose precision beyond 2^53 */ ((seed) >>> 0);
  let c1: any = (9782798678568883157n);
  let c2: any = (5545529020109919103n);
  let blocks = cptr_clone(((data))); /* &ref */
  for (i = 0; (i < nblocks ? 1 : 0); i++) {
    let k1: any = /* WARNING: 64-bit integer may lose precision beyond 2^53 */ (cptr_read_uint64(blocks, i32(Math.imul(i, 2) + 0)));
    let k2: any = /* WARNING: 64-bit integer may lose precision beyond 2^53 */ (cptr_read_uint64(blocks, i32(Math.imul(i, 2) + 1)));
    k1 = __u64(__as_bigint(k1) * __as_bigint(/* WARNING: 64-bit integer may lose precision beyond 2^53 */ c1));
    k1 = rotl64(/* WARNING: 64-bit integer may lose precision beyond 2^53 */ k1, ((31) << 24 >> 24));
    k1 = __u64(__as_bigint(k1) * __as_bigint(/* WARNING: 64-bit integer may lose precision beyond 2^53 */ c2));
    h1 = __u64(__as_bigint(h1) ^ __as_bigint(/* WARNING: 64-bit integer may lose precision beyond 2^53 */ k1));
    h1 = rotl64(/* WARNING: 64-bit integer may lose precision beyond 2^53 */ h1, ((27) << 24 >> 24));
    h1 = __u64(__as_bigint(h1) + __as_bigint(/* WARNING: 64-bit integer may lose precision beyond 2^53 */ h2));
    h1 = __u64(__as_bigint(__u64(__as_bigint(/* WARNING: 64-bit integer may lose precision beyond 2^53 */ h1) * __as_bigint(/* WARNING: 64-bit integer may lose precision beyond 2^53 */ 5))) + __as_bigint(/* WARNING: 64-bit integer may lose precision beyond 2^53 */ 1390208809));
    k2 = __u64(__as_bigint(k2) * __as_bigint(/* WARNING: 64-bit integer may lose precision beyond 2^53 */ c2));
    k2 = rotl64(/* WARNING: 64-bit integer may lose precision beyond 2^53 */ k2, ((33) << 24 >> 24));
    k2 = __u64(__as_bigint(k2) * __as_bigint(/* WARNING: 64-bit integer may lose precision beyond 2^53 */ c1));
    h2 = __u64(__as_bigint(h2) ^ __as_bigint(/* WARNING: 64-bit integer may lose precision beyond 2^53 */ k2));
    h2 = rotl64(/* WARNING: 64-bit integer may lose precision beyond 2^53 */ h2, ((31) << 24 >> 24));
    h2 = __u64(__as_bigint(h2) + __as_bigint(/* WARNING: 64-bit integer may lose precision beyond 2^53 */ h1));
    h2 = __u64(__as_bigint(__u64(__as_bigint(/* WARNING: 64-bit integer may lose precision beyond 2^53 */ h2) * __as_bigint(/* WARNING: 64-bit integer may lose precision beyond 2^53 */ 5))) + __as_bigint(/* WARNING: 64-bit integer may lose precision beyond 2^53 */ 944331445));
  }
  let tail = ((cptr_offset(data, Math.imul(nblocks, 16)))); /* &ref */
  let k1: any = /* WARNING: 64-bit integer may lose precision beyond 2^53 */ 0;
  let k2: any = /* WARNING: 64-bit integer may lose precision beyond 2^53 */ 0;
  switch (len & 15) {
    case 15:
    {
      k2 = __u64(__as_bigint(k2) ^ __as_bigint(__u64(__as_bigint(__u64(__as_bigint((((tail.buf[(tail.off ?? 0) + 14])) & 0xFF)))) << __as_bigint(48))));
    }
    case 14:
    {
      k2 = __u64(__as_bigint(k2) ^ __as_bigint(__u64(__as_bigint(__u64(__as_bigint((((tail.buf[(tail.off ?? 0) + 13])) & 0xFF)))) << __as_bigint(40))));
    }
    case 13:
    {
      k2 = __u64(__as_bigint(k2) ^ __as_bigint(__u64(__as_bigint(__u64(__as_bigint((((tail.buf[(tail.off ?? 0) + 12])) & 0xFF)))) << __as_bigint(32))));
    }
    case 12:
    {
      k2 = __u64(__as_bigint(k2) ^ __as_bigint(__u64(__as_bigint(__u64(__as_bigint((((tail.buf[(tail.off ?? 0) + 11])) & 0xFF)))) << __as_bigint(24))));
    }
    case 11:
    {
      k2 = __u64(__as_bigint(k2) ^ __as_bigint(__u64(__as_bigint(__u64(__as_bigint((((tail.buf[(tail.off ?? 0) + 10])) & 0xFF)))) << __as_bigint(16))));
    }
    case 10:
    {
      k2 = __u64(__as_bigint(k2) ^ __as_bigint(__u64(__as_bigint(__u64(__as_bigint((((tail.buf[(tail.off ?? 0) + 9])) & 0xFF)))) << __as_bigint(8))));
    }
    case 9:
    {
      k2 = __u64(__as_bigint(k2) ^ __as_bigint(__u64(__as_bigint(__u64(__as_bigint((((tail.buf[(tail.off ?? 0) + 8])) & 0xFF)))) << __as_bigint(0))));
    k2 = __u64(__as_bigint(k2) * __as_bigint(/* WARNING: 64-bit integer may lose precision beyond 2^53 */ c2));
    k2 = rotl64(/* WARNING: 64-bit integer may lose precision beyond 2^53 */ k2, ((33) << 24 >> 24));
    k2 = __u64(__as_bigint(k2) * __as_bigint(/* WARNING: 64-bit integer may lose precision beyond 2^53 */ c1));
    h2 = __u64(__as_bigint(h2) ^ __as_bigint(/* WARNING: 64-bit integer may lose precision beyond 2^53 */ k2));
    ...
    case 8:
    {
      k1 = __u64(__as_bigint(k1) ^ __as_bigint(__u64(__as_bigint(__u64(__as_bigint((((tail.buf[(tail.off ?? 0) + 7])) & 0xFF)))) << __as_bigint(56))));
    }
    case 7:
    {
      k1 = __u64(__as_bigint(k1) ^ __as_bigint(__u64(__as_bigint(__u64(__as_bigint((((tail.buf[(tail.off ?? 0) + 6])) & 0xFF)))) << __as_bigint(48))));
    }
    case 6:
    {
      k1 = __u64(__as_bigint(k1) ^ __as_bigint(__u64(__as_bigint(__u64(__as_bigint((((tail.buf[(tail.off ?? 0) + 5])) & 0xFF)))) << __as_bigint(40))));
    }
    case 5:
    {
      k1 = __u64(__as_bigint(k1) ^ __as_bigint(__u64(__as_bigint(__u64(__as_bigint((((tail.buf[(tail.off ?? 0) + 4])) & 0xFF)))) << __as_bigint(32))));
    }
    case 4:
    {
      k1 = __u64(__as_bigint(k1) ^ __as_bigint(__u64(__as_bigint(__u64(__as_bigint((((tail.buf[(tail.off ?? 0) + 3])) & 0xFF)))) << __as_bigint(24))));
    }
    case 3:
    {
      k1 = __u64(__as_bigint(k1) ^ __as_bigint(__u64(__as_bigint(__u64(__as_bigint((((tail.buf[(tail.off ?? 0) + 2])) & 0xFF)))) << __as_bigint(16))));
    }
    case 2:
    {
      k1 = __u64(__as_bigint(k1) ^ __as_bigint(__u64(__as_bigint(__u64(__as_bigint((((tail.buf[(tail.off ?? 0) + 1])) & 0xFF)))) << __as_bigint(8))));
    }
    case 1:
    {
      k1 = __u64(__as_bigint(k1) ^ __as_bigint(__u64(__as_bigint(__u64(__as_bigint((((tail.buf[(tail.off ?? 0) + 0])) & 0xFF)))) << __as_bigint(0))));
    k1 = __u64(__as_bigint(k1) * __as_bigint(/* WARNING: 64-bit integer may lose precision beyond 2^53 */ c1));
    k1 = rotl64(/* WARNING: 64-bit integer may lose precision beyond 2^53 */ k1, ((31) << 24 >> 24));
    k1 = __u64(__as_bigint(k1) * __as_bigint(/* WARNING: 64-bit integer may lose precision beyond 2^53 */ c2));
    h1 = __u64(__as_bigint(h1) ^ __as_bigint(/* WARNING: 64-bit integer may lose precision beyond 2^53 */ k1));
  ...
  h1 = __u64(__as_bigint(h1) ^ __as_bigint(/* WARNING: 64-bit integer may lose precision beyond 2^53 */ len));
  h2 = __u64(__as_bigint(h2) ^ __as_bigint(/* WARNING: 64-bit integer may lose precision beyond 2^53 */ len));
  h1 = __u64(__as_bigint(h1) + __as_bigint(/* WARNING: 64-bit integer may lose precision beyond 2^53 */ h2));
  h2 = __u64(__as_bigint(h2) + __as_bigint(/* WARNING: 64-bit integer may lose precision beyond 2^53 */ h1));
  h1 = fmix64(/* WARNING: 64-bit integer may lose precision beyond 2^53 */ h1);
  h2 = fmix64(/* WARNING: 64-bit integer may lose precision beyond 2^53 */ h2);
  h1 = __u64(__as_bigint(h1) + __as_bigint(/* WARNING: 64-bit integer may lose precision beyond 2^53 */ h2));
  h2 = __u64(__as_bigint(h2) + __as_bigint(/* WARNING: 64-bit integer may lose precision beyond 2^53 */ h1));
  cptr_write_uint64(((out)), 0, /* WARNING: 64-bit integer may lose precision beyond 2^53 */ h1);
  cptr_write_uint64(((out)), 1, /* WARNING: 64-bit integer may lose precision beyond 2^53 */ h2);
}
