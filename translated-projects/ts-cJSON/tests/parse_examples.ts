...
function parse_file(filename: string): cJSON | null {
  let parsed = null; /* &ref */
  let content = read_file(cptr_clone(filename)); /* &ref */
  parsed = cJSON_Parse(cptr_clone(content));
  if (!cptr_eq(content, (null))) {
    free(content);
  }
  return parsed;
...
function do_test(test_name: string): void {
  let expected = null; /* &ref */
  let actual = null; /* &ref */
  let tree = null; /* &ref */
  let test_name_length = ((0) >>> 0);
  let test_path = null; /* &ref */
  let expected_path = null; /* &ref */
  test_name_length = strlen(cptr_clone(test_name));
  test_path = (malloc(8 + ((test_name_length) >>> 0)));
  if ((!cptr_eq(((test_path)), (null)))) {
  } else {
    UnityFail((((("Failed to allocate test_path buffer.")))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((63))))))))));
  }
  expected_path = (malloc(__u64(__as_bigint(8 + ((test_name_length) >>> 0)) + __as_bigint(10))));
  if ((!cptr_eq(((expected_path)), (null)))) {
  } else {
    UnityFail((((("Failed to allocate expected_path buffer.")))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((65))))))))));
  }
  (() => { const __s = printf_format("inputs/%s", cptr_clone(test_name)); strcpy(test_path, __s); return __s.length; })();
  (() => { const __s = printf_format("inputs/%s.expected", cptr_clone(test_name)); strcpy(expected_path, __s); return __s.length; })();
  expected = read_file(cptr_clone(expected_path));
  if ((!cptr_eq(((expected)), (null)))) {
  } else {
    UnityFail((((("Failed to read expected output.")))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((73))))))))));
  }
  tree = parse_file(cptr_clone(test_path));
  if ((((tree)) != (null))) {
  } else {
    UnityFail((((("Failed to read of parse test.")))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((77))))))))));
  }
  actual = cJSON_Print(tree);
  if ((!cptr_eq(((actual)), (null)))) {
  } else {
    UnityFail((((("Failed to print tree back to JSON.")))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((81))))))))));
  }
  UnityAssertEqualString(cptr_clone((((expected)))), cptr_clone((((actual)))), null, __u64(__as_bigint((84))));
  if (!cptr_eq(expected, (null))) {
    free(expected);
  }
  if (tree != (null)) {
...
function file_test1_should_be_parsed_and_printed(): void {
  do_test("test1");
}

function file_test2_should_be_parsed_and_printed(): void {
  do_test("test2");
}

function file_test3_should_be_parsed_and_printed(): void {
  do_test("test3");
}

function file_test4_should_be_parsed_and_printed(): void {
  do_test("test4");
}

function file_test5_should_be_parsed_and_printed(): void {
  do_test("test5");
}

function file_test6_should_not_be_parsed(): void {
  let test6 = null; /* &ref */
  let tree = null; /* &ref */
  test6 = read_file("inputs/test6");
  if ((!cptr_eq(((test6)), (null)))) {
  } else {
    UnityFail((((("Failed to read test6 data.")))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((140))))))))));
  }
  tree = cJSON_Parse(cptr_clone(test6));
  if ((((tree)) == (null))) {
  } else {
    UnityFail((((("Should fail to parse what is not JSON.")))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((143))))))))));
  }
  UnityAssertEqualNumber(Math.trunc(+(__rt_ptr_to_intptr(((test6))))), Math.trunc(+(__rt_ptr_to_intptr(((cJSON_GetErrorPtr()))))), (("Error pointer is incorrect.")), __u64(__as_bigint((145))), UNITY_DISPLAY_STYLE_HEX64);
  if (!cptr_eq(test6, (null))) {
    free(test6);
  }
  if (tree != (null)) {
...
function file_test7_should_be_parsed_and_printed(): void {
  do_test("test7");
}

function file_test8_should_be_parsed_and_printed(): void {
  do_test("test8");
}

function file_test9_should_be_parsed_and_printed(): void {
  do_test("test9");
}

function file_test10_should_be_parsed_and_printed(): void {
  do_test("test10");
}

function file_test11_should_be_parsed_and_printed(): void {
  do_test("test11");
}

function test12_should_not_be_parsed(): void {
  let test12 = cptr_from_string("{ \"name\": "); /* &ref */
  let tree = null; /* &ref */
  tree = cJSON_Parse(cptr_clone(test12));
  if ((((tree)) == (null))) {
  } else {
    UnityFail((((("Should fail to parse incomplete JSON.")))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((188))))))))));
  }
  (() => { const __rtl_0_4 = UNITY_DISPLAY_STYLE_HEX64; const __rtl_0_3 = __u64(__as_bigint((190))); const __rtl_0_2 = (("Error pointer is incorrect.")); const __rtl_0_1 = Math.trunc(+(__rt_ptr_to_intptr(((cJSON_GetErrorPtr()))))); const __rtl_0_0 = Math.trunc(+(__rt_ptr_to_intptr(((cptr_offset(test12, strlen(cptr_clone(test12)))))))); return UnityAssertEqualNumber(__rtl_0_0, __rtl_0_1, __rtl_0_2, __rtl_0_3, __rtl_0_4); })();
  if (tree != (null)) {
    cJSON_Delete(tree);
  }
}

function test13_should_be_parsed_without_null_termination(): void {
  let tree = null; /* &ref */
  let test_13 = (() => { const __b = cptr_create(179); const __s = "{\"Image\":{\"Width\":800,\"Height\":600,\"Title\":\"Viewfrom15thFloor\",\"Thumbnail\":{\"Url\":\"http:/*www.example.com/image/481989943\",\"Height\":125,\"Width\":\"100\"},\"IDs\":[116,943,234,38793]}}"; for (let __i = 0; __i < __s.length; __i++) __b.buf[__i] = __s.charCodeAt(__i); return __b; })();
  let test_13_wo_null = cptr_create(178);
  memcpy(test_13_wo_null, test_13, 179 - 1);
  tree = cJSON_ParseWithLength(cptr_clone(test_13_wo_null), 179 - 1);
  if ((((tree)) != (null))) {
  } else {
    UnityFail((((("Failed to parse valid json.")))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((219))))))))));
  }
  if (tree != (null)) {
    cJSON_Delete(tree);
  }
...
function test14_should_not_be_parsed(): void {
  let tree = null; /* &ref */
  let test_14 = (() => { const __b = cptr_create(179); const __s = "{\"Image\":{\"Width\":800,\"Height\":600,\"Title\":\"Viewfrom15thFloor\",\"Thumbnail\":{\"Url\":\"http:/*www.example.com/image/481989943\",\"Height\":125,\"Width\":\"100\"},\"IDs\":[116,943,234,38793]}}"; for (let __i = 0; __i < __s.length; __i++) __b.buf[__i] = __s.charCodeAt(__i); return __b; })();
  tree = cJSON_ParseWithLength(cptr_clone(test_14), 179 - 2);
  if ((((tree)) == (null))) {
  } else {
    UnityFail((((("Should not continue after buffer_length is reached.")))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((245))))))))));
  }
  if (tree != (null)) {
    cJSON_Delete(tree);
  }
...
function test15_should_not_heap_buffer_overflow(): void {
  let strings = ["{\"1\":1,", "{\"1\":1, "]; /* &ref */
  let i = 0;
  for (i = ((0) >>> 0); ((i) >>> 0) < __safe_div(8, 8); i += ((1) >>> 0)) {
    let json_string = cptr_clone(strings[((i) >>> 0)]); /* &ref */
    let len = strlen(cptr_clone(json_string));
    let json = null; /* &ref */
    let exact_size_heap = (malloc(((len) >>> 0))); /* &ref */
    if ((!cptr_eq(((exact_size_heap)), (null)))) {
    } else {
      UnityFail((((" Expected Non-NULL"))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((270))))))))));
    }
    memcpy(exact_size_heap, json_string, ((len) >>> 0));
    json = cJSON_ParseWithLength(cptr_clone(exact_size_heap), ((len) >>> 0));
    cJSON_Delete(json);
...
export function main(): number {
  UnityBegin("tests/real-world/cjson/tests/parse_examples.c");
  UnityDefaultTestRun((file_test1_should_be_parsed_and_printed), "file_test1_should_be_parsed_and_printed", (283));
  UnityDefaultTestRun((file_test2_should_be_parsed_and_printed), "file_test2_should_be_parsed_and_printed", (284));
  UnityDefaultTestRun((file_test3_should_be_parsed_and_printed), "file_test3_should_be_parsed_and_printed", (285));
  UnityDefaultTestRun((file_test4_should_be_parsed_and_printed), "file_test4_should_be_parsed_and_printed", (286));
  UnityDefaultTestRun((file_test5_should_be_parsed_and_printed), "file_test5_should_be_parsed_and_printed", (287));
  UnityDefaultTestRun((file_test6_should_not_be_parsed), "file_test6_should_not_be_parsed", (288));
  UnityDefaultTestRun((file_test7_should_be_parsed_and_printed), "file_test7_should_be_parsed_and_printed", (289));
  UnityDefaultTestRun((file_test8_should_be_parsed_and_printed), "file_test8_should_be_parsed_and_printed", (290));
  UnityDefaultTestRun((file_test9_should_be_parsed_and_printed), "file_test9_should_be_parsed_and_printed", (291));
  UnityDefaultTestRun((file_test10_should_be_parsed_and_printed), "file_test10_should_be_parsed_and_printed", (292));
  UnityDefaultTestRun((file_test11_should_be_parsed_and_printed), "file_test11_should_be_parsed_and_printed", (293));
  UnityDefaultTestRun((test12_should_not_be_parsed), "test12_should_not_be_parsed", (294));
  UnityDefaultTestRun((test13_should_be_parsed_without_null_termination), "test13_should_be_parsed_without_null_termination", (295));
  UnityDefaultTestRun((test14_should_not_be_parsed), "test14_should_not_be_parsed", (296));
  UnityDefaultTestRun((test15_should_not_heap_buffer_overflow), "test15_should_not_heap_buffer_overflow", (297));
  return UnityEnd();
}
