...
export let CounterSetup = 0;
export let CounterTeardown = 0;
export let CounterSuiteSetup = 0;
...
export function custom_setup(): void {
  CounterSetup = 2;
}

export function custom_teardown(): void {
  CounterTeardown = 2;
}

export function test_ThisTestAlwaysPasses(): void {
  TEST_PASS();
}

export function test_ThisTestAlwaysFails(): void {
  TEST_FAIL_MESSAGE("This Test Should Fail");
}

export function test_ThisTestAlwaysIgnored(): void {
  TEST_IGNORE_MESSAGE("This Test Should Be Ignored");
}

export function qwiktest_ThisTestPassesWhenNoSetupRan(): void {
  TEST_ASSERT_EQUAL_MESSAGE(0, CounterSetup, "Setup Was Unexpectedly Run");
}

export function qwiktest_ThisTestPassesWhenNoTeardownRan(): void {
  TEST_ASSERT_EQUAL_MESSAGE(0, CounterTeardown, "Teardown Was Unexpectedly Run");
}

export function spec_ThisTestPassesWhenNormalSuiteSetupAndTeardownRan(): void {
  TEST_ASSERT_EQUAL_MESSAGE(0, CounterSuiteSetup, "Suite Setup Was Unexpectedly Run");
}

export function spec_ThisTestPassesWhenNormalSetupRan(): void {
  TEST_ASSERT_EQUAL_MESSAGE(1, CounterSetup, "Normal Setup Wasn't Run");
}

export function spec_ThisTestPassesWhenNormalTeardownRan(): void {
  TEST_ASSERT_EQUAL_MESSAGE(1, CounterTeardown, "Normal Teardown Wasn't Run");
}

export function custtest_ThisTestPassesWhenCustomSetupRan(): void {
  TEST_ASSERT_EQUAL_MESSAGE(2, CounterSetup, "Custom Setup Wasn't Run");
}

export function custtest_ThisTestPassesWhenCustomTeardownRan(): void {
  TEST_ASSERT_EQUAL_MESSAGE(2, CounterTeardown, "Custom Teardown Wasn't Run");
}

export function test_NotBeConfusedByLongComplicatedStrings(): void {
  let crazyString = cptr_from_string("GET / HTTP/1.1\r\nHost: 127.0.0.1:8081\r\nConnection: keep-alive\r\nCache-Control: no-cache\r\nUser-Agent: Mozilla/5.0 (Windows NT 6.3; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/46.0.2490.80 Safari/537.36\r\nPostman-Token: 768c7149-c3fb-f704-71a2-63918d9195b2\r\nAccept: */*\r\nAccept-Encoding: gzip, deflate, sdch\r\nAccept-Language: en-GB,en-US;q=0.8,en;q=0.6\r\n\r\n"); /* &ref */
  TEST_ASSERT_EQUAL_STRING_MESSAGE(cptr_clone(crazyString), cptr_clone(crazyString), "These Strings Are The Same");
}

export function test_NotDisappearJustBecauseTheTestBeforeAndAfterHaveCrazyStrings(): void {
  TEST_ASSERT_TRUE_MESSAGE(1, "1 Should be True");
}

export function test_StillNotBeConfusedByLongComplicatedStrings(): void {
  let crazyString = cptr_from_string("GET / HTTP/1.1\r\nHost: 127.0.0.1:8081\r\nConnection: keep-alive\r\nCache-Control: no-cache\r\nUser-Agent: Mozilla/5.0 (Windows NT 6.3; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/46.0.2490.80 Safari/537.36\r\nPostman-Token: 768c7149-c3fb-f704-71a2-63918d9195b2\r\nAccept: */*\r\nAccept-Encoding: gzip, deflate, sdch\r\nAccept-Language: en-GB,en-US;q=0.8,en;q=0.6\r\n\r\n"); /* &ref */
  TEST_ASSERT_EQUAL_STRING_MESSAGE(cptr_clone(crazyString), cptr_clone(crazyString), "These Strings Are Still The Same");
}

export function should_RunTestsStartingWithShouldByDefault(): void {
  TEST_ASSERT_TRUE_MESSAGE(1, "1 Should be True");
}

export function paratest_ShouldHandleParameterizedTests(Num: number): void {
  TEST_ASSERT_EQUAL_MESSAGE(0, (i32(Num % 5)), "All The Values Are Divisible By 5");
}

export function paratest_ShouldHandleParameterizedTests2(Num: number): void {
  TEST_ASSERT_EQUAL_MESSAGE(7, Num, "The Only Call To This Passes");
}

export function paratest_ShouldHandleNonParameterizedTestsWhenParameterizationValid(): void {
  TEST_PASS();
}

export function paratest_ShouldHandleParameterizedTestsThatFail(Num: number): void {
  TEST_ASSERT_EQUAL_MESSAGE(3, Num, "This call should fail");
}

export function suitetest_ThisTestPassesWhenCustomSuiteSetupAndTeardownRan(): void {
  TEST_ASSERT_EQUAL_MESSAGE(1, CounterSuiteSetup, "Suite Setup Should Have Run");
}

export function test_ShouldCallMockInitAndVerifyFunctionsForEachTest(): void {
  let passesOrIgnores = 0;
  TEST_ASSERT_EQUAL_MESSAGE(mockMock_Init_Counter, "Mock Init Should Be Called Once Per Test Started");
  TEST_ASSERT_EQUAL_MESSAGE(passesOrIgnores, mockMock_Verify_Counter, "Mock Verify Should Be Called Once Per Test Passed");
  TEST_ASSERT_EQUAL_MESSAGE(mockMock_Destroy_Counter, "Mock Destroy Should Be Called Once Per Test Completed");
