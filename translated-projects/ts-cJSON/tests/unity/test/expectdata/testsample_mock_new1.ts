...
import { UnityBegin, UnityConcludeTest, UnityEnd } from './unity.js';
...
export let GlobalExpectCount = 0;
export let GlobalVerifyOrder = 0;
export let GlobalOrderError = null;
function CMock_Init(): void {
  GlobalExpectCount = 0;
  GlobalVerifyOrder = 0;
...
function CMock_Verify(): void {
  Mockstanky_Verify();
}

function CMock_Destroy(): void {
  Mockstanky_Destroy();
}
