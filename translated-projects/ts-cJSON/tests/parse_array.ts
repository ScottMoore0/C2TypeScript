...
import { UnityAssertBits, UnityAssertEqualNumber, UnityAssertEqualString, UnityBegin, UnityDefaultTestRun, UnityEnd, UnityFail } from './unity.js';
...
let item = new cJSON();
function assert_is_array(array_item: cJSON | null): void {
  if ((((array_item)) != (null))) {
  } else {
    UnityFail((((("Item is NULL.")))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((35))))))))));
  }
  if (((((__struct_ptr_at(array_item, 0)).next)) == (null))) {
  } else {
    UnityFail((((("Linked list next pointer is not NULL.")))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((37))))))))));
  }
  if (((((__struct_ptr_at(array_item, 0)).prev)) == (null))) {
  } else {
    UnityFail((((("Linked list previous pointer is not NULL.")))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((37))))))))));
  }
  UnityAssertBits(__i64(__as_bigint(((255)))), __i64(__as_bigint((((((1 << 5) | 0)))))), __i64(__as_bigint((((__struct_ptr_at(array_item, 0)).type)))), (("Item doesn't have expected type.")), __u64(__as_bigint((38))));
  UnityAssertBits(__i64(__as_bigint(((256)))), __i64(__as_bigint(((0)))), __i64(__as_bigint((((__struct_ptr_at(array_item, 0)).type)))), (("Item should not have a string as reference.")), __u64(__as_bigint((39))));
  UnityAssertBits(__i64(__as_bigint(((512)))), __i64(__as_bigint(((0)))), __i64(__as_bigint((((__struct_ptr_at(array_item, 0)).type)))), (("Item should not have a const string.")), __u64(__as_bigint((40))));
  if ((cptr_eq((((__struct_ptr_at(array_item, 0)).valuestring)), (null)))) {
  } else {
    UnityFail((((("Valuestring is not NULL.")))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((41))))))))));
  }
  if ((cptr_eq((((__struct_ptr_at(array_item, 0)).string)), (null)))) {
  } else {
    UnityFail((((("String is not NULL.")))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((42))))))))));
  }
}

function assert_not_array(json: string): void {
  ...
  buffer.content = (json);
  buffer.length = strlen(cptr_clone(json)) + 1;
  Object.assign(buffer.hooks, global_hooks);
  if (!(parse_array(item, buffer))) {
  } else {
    UnityFail(((" Expected FALSE Was TRUE")), __u64(__as_bigint((__u64(__as_bigint((52)))))));
  }
  UnityAssertBits(__i64(__as_bigint(((255)))), __i64(__as_bigint((((0))))), __i64(__as_bigint((((__struct_ptr_at(item, 0)).type)))), (("Item doesn't have expected type.")), __u64(__as_bigint((53))));
  if (((((__struct_ptr_at(item, 0)).next)) == (null))) {
  } else {
    UnityFail((((("Linked list next pointer is not NULL.")))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((53))))))))));
  }
  if (((((__struct_ptr_at(item, 0)).prev)) == (null))) {
  } else {
    UnityFail((((("Linked list previous pointer is not NULL.")))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((53))))))))));
  }
  if (((((__struct_ptr_at(item, 0)).child)) == (null))) {
  } else {
    UnityFail((((("Item has a child.")))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((53))))))))));
  }
  if ((cptr_eq((((__struct_ptr_at(item, 0)).string)), (null)))) {
  } else {
    UnityFail((((("String is not NULL.")))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((53))))))))));
  }
  if ((cptr_eq((((__struct_ptr_at(item, 0)).valuestring)), (null)))) {
  } else {
    UnityFail((((("Valuestring is not NULL.")))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((53))))))))));
  }
}

function assert_parse_array(json: string): void {
  let buffer = Object.assign(new parse_buffer(), { content: null, length: ((0) >>> 0), offset: ((0) >>> 0), depth: ((0) >>> 0), hooks: Object.assign(new internal_hooks(), { allocate: null, deallocate: null, reallocate: null }) });
  buffer.content = (json);
  buffer.length = strlen(cptr_clone(json)) + 1;
  Object.assign(buffer.hooks, global_hooks);
...
function parse_array_should_parse_empty_arrays(): void {
  assert_parse_array("[]");
  if (((((__struct_ptr_at(item, 0)).child)) == (null))) {
  } else {
    UnityFail((((("Item has a child.")))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((70))))))))));
  }
  assert_parse_array("[\n\t]");
  if (((((__struct_ptr_at(item, 0)).child)) == (null))) {
  } else {
    UnityFail((((("Item has a child.")))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((73))))))))));
  }
}

function parse_array_should_parse_arrays_with_one_element(): void {
  assert_parse_array("[1]");
  if (((((__struct_ptr_at(item, 0)).child)) != (null))) {
  } else {
    UnityFail((((("Item doesn't have a child.")))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((81))))))))));
  }
  UnityAssertBits(__i64(__as_bigint(((255)))), __i64(__as_bigint((((((1 << 3) | 0)))))), __i64(__as_bigint((((__struct_ptr_at((__struct_ptr_at(item, 0)).child, 0)).type)))), (("Item doesn't have expected type.")), __u64(__as_bigint((82))));
  reset(item);
  assert_parse_array("[\"hello!\"]");
  if (((((__struct_ptr_at(item, 0)).child)) != (null))) {
  } else {
    UnityFail((((("Item doesn't have a child.")))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((86))))))))));
  }
  UnityAssertBits(__i64(__as_bigint(((255)))), __i64(__as_bigint((((((1 << 4) | 0)))))), __i64(__as_bigint((((__struct_ptr_at((__struct_ptr_at(item, 0)).child, 0)).type)))), (("Item doesn't have expected type.")), __u64(__as_bigint((87))));
  UnityAssertEqualString(((("hello!"))), cptr_clone(((((__struct_ptr_at((__struct_ptr_at(item, 0)).child, 0)).valuestring)))), null, __u64(__as_bigint((88))));
  reset(item);
  assert_parse_array("[[]]");
  if (((((__struct_ptr_at(item, 0)).child)) != (null))) {
  } else {
    UnityFail((((("Item doesn't have a child.")))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((92))))))))));
  }
  if (((((__struct_ptr_at(item, 0)).child)) != (null))) {
  } else {
    UnityFail((((" Expected Non-NULL"))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((93))))))))));
  }
  UnityAssertBits(__i64(__as_bigint(((255)))), __i64(__as_bigint((((((1 << 5) | 0)))))), __i64(__as_bigint((((__struct_ptr_at((__struct_ptr_at(item, 0)).child, 0)).type)))), (("Item doesn't have expected type.")), __u64(__as_bigint((94))));
  if (((((__struct_ptr_at((__struct_ptr_at(item, 0)).child, 0)).child)) == (null))) {
  } else {
    UnityFail((((("Item has a child.")))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((95))))))))));
  }
  reset(item);
  assert_parse_array("[null]");
  if (((((__struct_ptr_at(item, 0)).child)) != (null))) {
  } else {
    UnityFail((((("Item doesn't have a child.")))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((99))))))))));
  }
  UnityAssertBits(__i64(__as_bigint(((255)))), __i64(__as_bigint((((((1 << 2) | 0)))))), __i64(__as_bigint((((__struct_ptr_at((__struct_ptr_at(item, 0)).child, 0)).type)))), (("Item doesn't have expected type.")), __u64(__as_bigint((100))));
  reset(item);
}

function parse_array_should_parse_arrays_with_multiple_elements(): void {
  assert_parse_array("[1\t,\n2, 3]");
  if (((((__struct_ptr_at(item, 0)).child)) != (null))) {
  } else {
    UnityFail((((("Item doesn't have a child.")))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((107))))))))));
  }
  if (((((__struct_ptr_at((__struct_ptr_at(item, 0)).child, 0)).next)) != (null))) {
  } else {
    UnityFail((((" Expected Non-NULL"))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((108))))))))));
  }
  if (((((__struct_ptr_at((__struct_ptr_at((__struct_ptr_at(item, 0)).child, 0)).next, 0)).next)) != (null))) {
  } else {
    UnityFail((((" Expected Non-NULL"))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((109))))))))));
  }
  if (((((__struct_ptr_at((__struct_ptr_at((__struct_ptr_at((__struct_ptr_at(item, 0)).child, 0)).next, 0)).next, 0)).next)) == (null))) {
  } else {
    UnityFail((((" Expected NULL"))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((110))))))))));
  }
  UnityAssertBits(__i64(__as_bigint(((255)))), __i64(__as_bigint((((((1 << 3) | 0)))))), __i64(__as_bigint((((__struct_ptr_at((__struct_ptr_at(item, 0)).child, 0)).type)))), (("Item doesn't have expected type.")), __u64(__as_bigint((111))));
  UnityAssertBits(__i64(__as_bigint(((255)))), __i64(__as_bigint((((((1 << 3) | 0)))))), __i64(__as_bigint((((__struct_ptr_at((__struct_ptr_at((__struct_ptr_at(item, 0)).child, 0)).next, 0)).type)))), (("Item doesn't have expected type.")), __u64(__as_bigint((112))));
  UnityAssertBits(__i64(__as_bigint(((255)))), __i64(__as_bigint((((((1 << 3) | 0)))))), __i64(__as_bigint((((__struct_ptr_at((__struct_ptr_at((__struct_ptr_at((__struct_ptr_at(item, 0)).child, 0)).next, 0)).next, 0)).type)))), (("Item doesn't have expected type.")), __u64(__as_bigint((113))));
  reset(item);
  {
    let i = ((0) >>> 0);
    let node = null; /* &ref */
    let expected_types = [(((1 << 3) | 0)), (((1 << 2) | 0)), (((1 << 1) | 0)), (((1 << 0) | 0)), (((1 << 5) | 0)), (((1 << 4) | 0)), (((1 << 6) | 0))];
    assert_parse_array("[1, null, true, false, [], \"hello\", {}]");
    node = (__struct_ptr_at(item, 0)).child;
    for (i = ((0) >>> 0); (((((i) >>> 0) < (__safe_div(28, 4))) && (node != (null))) ? 1 : 0); ((() => { const _t = i; i = u32(i + 1); return _t; })()), node = (__struct_ptr_at(node, 0)).next) {
      UnityAssertBits(__i64(__as_bigint(((255)))), __i64(__as_bigint(((expected_types[((i) >>> 0)])))), __i64(__as_bigint((((__struct_ptr_at(node, 0)).type)))), null, __u64(__as_bigint((138))));
    }
    UnityAssertEqualNumber(__i64(__as_bigint(((((i))) >>> 0))), __i64(__as_bigint(((7)))), null, __u64(__as_bigint((140))), UNITY_DISPLAY_STYLE_INT);
    reset(item);
  }
}

function parse_array_should_not_parse_non_arrays(): void {
  assert_not_array("");
  assert_not_array("[");
  assert_not_array("]");
...
export function main(): number {
  memset(item, 0, 64);
  UnityBegin("tests/real-world/cjson/tests/parse_array.c");
  UnityDefaultTestRun((parse_array_should_parse_empty_arrays), "parse_array_should_parse_empty_arrays", (162));
  UnityDefaultTestRun((parse_array_should_parse_arrays_with_one_element), "parse_array_should_parse_arrays_with_one_element", (163));
  UnityDefaultTestRun((parse_array_should_parse_arrays_with_multiple_elements), "parse_array_should_parse_arrays_with_multiple_elements", (164));
  UnityDefaultTestRun((parse_array_should_not_parse_non_arrays), "parse_array_should_not_parse_non_arrays", (165));
  return UnityEnd();
}
