...
import { cJSONUtils_AddPatchToArray, cJSONUtils_ApplyPatches, cJSONUtils_ApplyPatchesCaseSensitive, cJSONUtils_FindPointerFromObjectTo, cJSONUtils_GeneratePatches, cJSONUtils_GeneratePatchesCaseSensitive, cJSONUtils_GetPointer, cJSONUtils_GetPointerCaseSensitive, cJSONUtils_MergePatch, cJSONUtils_MergePatchCaseSensitive, cJSONUtils_SortObject, cJSONUtils_SortObjectCaseSensitive } from './cJSON_Utils.js';
...
function cjson_utils_functions_shouldnt_crash_with_null_pointers(): void {
  let item = cJSON_CreateString("item"); /* &ref */
  if ((((item)) != (null))) {
  } else {
    UnityFail((((" Expected Non-NULL"))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((35))))))))));
  }
  if ((((cJSONUtils_GetPointer(item, null))) == (null))) {
  } else {
    UnityFail((((" Expected NULL"))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((37))))))))));
  }
  if ((((cJSONUtils_GetPointer(null, "pointer"))) == (null))) {
  } else {
    UnityFail((((" Expected NULL"))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((38))))))))));
  }
  if ((((cJSONUtils_GetPointerCaseSensitive(null, "pointer"))) == (null))) {
  } else {
    UnityFail((((" Expected NULL"))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((39))))))))));
  }
  if ((((cJSONUtils_GetPointerCaseSensitive(item, null))) == (null))) {
  } else {
    UnityFail((((" Expected NULL"))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((40))))))))));
  }
  if ((((cJSONUtils_GeneratePatches(item, null))) == (null))) {
  } else {
    UnityFail((((" Expected NULL"))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((41))))))))));
  }
  if ((((cJSONUtils_GeneratePatches(null, item))) == (null))) {
  } else {
    UnityFail((((" Expected NULL"))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((42))))))))));
  }
  if ((((cJSONUtils_GeneratePatchesCaseSensitive(item, null))) == (null))) {
  } else {
    UnityFail((((" Expected NULL"))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((43))))))))));
  }
  if ((((cJSONUtils_GeneratePatchesCaseSensitive(null, item))) == (null))) {
  } else {
  ...
  if ((((cJSONUtils_MergePatch(item, null))) == (null))) {
  } else {
    UnityFail((((" Expected NULL"))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((53))))))))));
  }
  item = cJSON_CreateString("item");
  if ((((cJSONUtils_MergePatchCaseSensitive(item, null))) == (null))) {
  } else {
    UnityFail((((" Expected NULL"))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((55))))))))));
  }
  item = cJSON_CreateString("item");
  if ((cptr_eq(((cJSONUtils_FindPointerFromObjectTo(item, null))), (null)))) {
  } else {
    UnityFail((((" Expected NULL"))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((65))))))))));
  }
  if ((cptr_eq(((cJSONUtils_FindPointerFromObjectTo(null, item))), (null)))) {
  } else {
...
export function main(): number {
  UnityBegin("tests/real-world/cjson/tests/misc_utils_tests.c");
  UnityDefaultTestRun((cjson_utils_functions_shouldnt_crash_with_null_pointers), "cjson_utils_functions_shouldnt_crash_with_null_pointers", (77));
  return UnityEnd();
}
