...
import { UnityAssertBits, UnityBegin, UnityDefaultTestRun, UnityEnd, UnityFail } from './unity.js';
...
let item = new cJSON();
function assert_is_value(value_item: cJSON | null, type: number): void {
  if ((((value_item)) != (null))) {
  } else {
    UnityFail((((("Item is NULL.")))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((35))))))))));
  }
  if (((((__struct_ptr_at(value_item, 0)).next)) == (null))) {
  } else {
    UnityFail((((("Linked list next pointer is not NULL.")))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((37))))))))));
  }
  if (((((__struct_ptr_at(value_item, 0)).prev)) == (null))) {
  } else {
    UnityFail((((("Linked list previous pointer is not NULL.")))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((37))))))))));
  }
  UnityAssertBits(__i64(__as_bigint(((255)))), __i64(__as_bigint(((type)))), __i64(__as_bigint((((__struct_ptr_at(value_item, 0)).type)))), (("Item doesn't have expected type.")), __u64(__as_bigint((38))));
  UnityAssertBits(__i64(__as_bigint(((256)))), __i64(__as_bigint(((0)))), __i64(__as_bigint((((__struct_ptr_at(value_item, 0)).type)))), (("Item should not have a string as reference.")), __u64(__as_bigint((39))));
  UnityAssertBits(__i64(__as_bigint(((512)))), __i64(__as_bigint(((0)))), __i64(__as_bigint((((__struct_ptr_at(value_item, 0)).type)))), (("Item should not have a const string.")), __u64(__as_bigint((40))));
  if ((cptr_eq((((__struct_ptr_at(value_item, 0)).string)), (null)))) {
  } else {
    UnityFail((((("String is not NULL.")))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((41))))))))));
  }
}

function assert_parse_value(string: string, type: number): void {
  ...
  if ((parse_value(item, buffer))) {
    ...
    UnityFail(((" Expected TRUE Was FALSE")), __u64(__as_bigint((__u64(__as_bigint((51)))))));
  }
  assert_is_value(item, type);
}

function parse_value_should_parse_null(): void {
  assert_parse_value("null", (((1 << 2) | 0)));
  reset(item);
}

function parse_value_should_parse_true(): void {
  assert_parse_value("true", (((1 << 1) | 0)));
  reset(item);
}

function parse_value_should_parse_false(): void {
  assert_parse_value("false", (((1 << 0) | 0)));
  reset(item);
}

function parse_value_should_parse_number(): void {
  assert_parse_value("1.5", (((1 << 3) | 0)));
  reset(item);
}

function parse_value_should_parse_string(): void {
  assert_parse_value("\"\"", (((1 << 4) | 0)));
  reset(item);
  assert_parse_value("\"hello\"", (((1 << 4) | 0)));
  reset(item);
}

function parse_value_should_parse_array(): void {
  assert_parse_value("[]", (((1 << 5) | 0)));
  reset(item);
}

function parse_value_should_parse_object(): void {
  assert_parse_value("{}", (((1 << 6) | 0)));
  reset(item);
}

export function main(): number {
  memset(item, 0, 64);
  UnityBegin("tests/real-world/cjson/tests/parse_value.c");
  UnityDefaultTestRun((parse_value_should_parse_null), "parse_value_should_parse_null", (104));
  UnityDefaultTestRun((parse_value_should_parse_true), "parse_value_should_parse_true", (105));
  UnityDefaultTestRun((parse_value_should_parse_false), "parse_value_should_parse_false", (106));
  UnityDefaultTestRun((parse_value_should_parse_number), "parse_value_should_parse_number", (107));
  UnityDefaultTestRun((parse_value_should_parse_string), "parse_value_should_parse_string", (108));
  UnityDefaultTestRun((parse_value_should_parse_array), "parse_value_should_parse_array", (109));
  UnityDefaultTestRun((parse_value_should_parse_object), "parse_value_should_parse_object", (110));
  return UnityEnd();
}
