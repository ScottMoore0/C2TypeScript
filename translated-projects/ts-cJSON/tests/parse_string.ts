...
import { UnityAssertBits, UnityAssertEqualString, UnityBegin, UnityDefaultTestRun, UnityEnd, UnityFail } from './unity.js';
...
let item = new cJSON();
function assert_is_string(string_item: cJSON | null): void {
  if ((((string_item)) != (null))) {
  } else {
    UnityFail((((("Item is NULL.")))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((35))))))))));
  }
  if (((((__struct_ptr_at(string_item, 0)).next)) == (null))) {
  } else {
    UnityFail((((("Linked list next pointer is not NULL.")))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((37))))))))));
  }
  if (((((__struct_ptr_at(string_item, 0)).prev)) == (null))) {
  } else {
    UnityFail((((("Linked list previous pointer is not NULL.")))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((37))))))))));
  }
  if (((((__struct_ptr_at(string_item, 0)).child)) == (null))) {
  } else {
    UnityFail((((("Item has a child.")))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((38))))))))));
  }
  UnityAssertBits(__i64(__as_bigint(((255)))), __i64(__as_bigint((((((1 << 4) | 0)))))), __i64(__as_bigint((((__struct_ptr_at(string_item, 0)).type)))), (("Item doesn't have expected type.")), __u64(__as_bigint((39))));
  UnityAssertBits(__i64(__as_bigint(((256)))), __i64(__as_bigint(((0)))), __i64(__as_bigint((((__struct_ptr_at(string_item, 0)).type)))), (("Item should not have a string as reference.")), __u64(__as_bigint((40))));
  UnityAssertBits(__i64(__as_bigint(((512)))), __i64(__as_bigint(((0)))), __i64(__as_bigint((((__struct_ptr_at(string_item, 0)).type)))), (("Item should not have a const string.")), __u64(__as_bigint((41))));
  if ((!cptr_eq((((__struct_ptr_at(string_item, 0)).valuestring)), (null)))) {
  } else {
    UnityFail((((("Valuestring is NULL.")))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((42))))))))));
  }
  if ((cptr_eq((((__struct_ptr_at(string_item, 0)).string)), (null)))) {
  } else {
    UnityFail((((("String is not NULL.")))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((43))))))))));
  }
}

function assert_parse_string(string: string, expected: string): void {
  ...
  Object.assign(buffer.hooks, global_hooks);
  if ((parse_string(item, buffer))) {
  } else {
    UnityFail(((("Couldn't parse string."))), __u64(__as_bigint((__u64(__as_bigint((53)))))));
  }
  assert_is_string(item);
  UnityAssertEqualString(cptr_clone((((expected)))), cptr_clone(((((__struct_ptr_at(item, 0)).valuestring)))), (("The parsed result isn't as expected.")), __u64(__as_bigint((55))));
  global_hooks.deallocate((__struct_ptr_at(item, 0)).valuestring);
  (__struct_ptr_at(item, 0)).valuestring = null;
}

function assert_not_parse_string(string: string): void {
  let buffer = Object.assign(new parse_buffer(), { content: null, length: ((0) >>> 0), offset: ((0) >>> 0), depth: ((0) >>> 0), hooks: Object.assign(new internal_hooks(), { allocate: null, deallocate: null, reallocate: null }) });
  buffer.content = (string);
  buffer.length = strlen(cptr_clone(string)) + 1;
  Object.assign(buffer.hooks, global_hooks);
  if (!(parse_string(item, buffer))) {
    ...
    UnityFail(((("Malformed string should not be accepted."))), __u64(__as_bigint((__u64(__as_bigint((67)))))));
  }
  UnityAssertBits(__i64(__as_bigint(((255)))), __i64(__as_bigint((((0))))), __i64(__as_bigint((((__struct_ptr_at(item, 0)).type)))), (("Item doesn't have expected type.")), __u64(__as_bigint((68))));
  if (((((__struct_ptr_at(item, 0)).next)) == (null))) {
  } else {
    UnityFail((((("Linked list next pointer is not NULL.")))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((68))))))))));
  }
  if (((((__struct_ptr_at(item, 0)).prev)) == (null))) {
  } else {
    UnityFail((((("Linked list previous pointer is not NULL.")))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((68))))))))));
  }
  if (((((__struct_ptr_at(item, 0)).child)) == (null))) {
  } else {
    UnityFail((((("Item has a child.")))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((68))))))))));
  }
  if ((cptr_eq((((__struct_ptr_at(item, 0)).string)), (null)))) {
  } else {
    UnityFail((((("String is not NULL.")))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((68))))))))));
  }
  if ((cptr_eq((((__struct_ptr_at(item, 0)).valuestring)), (null)))) {
  } else {
    UnityFail((((("Valuestring is not NULL.")))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((68))))))))));
  }
}

function parse_string_should_parse_strings(): void {
  assert_parse_string("\"\"", "");
  assert_parse_string("\" !\\\"#$%&'()*+,-./\\/0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\\\]^_'abcdefghijklmnopqrstuvwxyz{|}~\"", " !\"#$%&'()*+,-.//0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_'abcdefghijklmnopqrstuvwxyz{|}~");
...
function parse_string_should_parse_utf16_surrogate_pairs(): void {
  assert_parse_string("\"\\uD83D\\udc31\"", "\xF0\x9F\x90\xB1");
  reset(item);
}

function parse_string_should_not_parse_non_strings(): void {
...
function parse_string_should_not_parse_invalid_backslash(): void {
  assert_not_parse_string("Abcdef\\x53");
  reset(item);
  assert_not_parse_string("Abcdef\\e23");
  reset(item);
}

function parse_string_should_not_overflow_with_closing_backslash(): void {
  assert_not_parse_string("\"000000000000000000\\");
  reset(item);
}

function parse_string_should_parse_bug_94(): void {
  let string = (() => { const __b = cptr_create(58); const __s = "\"~!@\\\\#$%^&*()\\\\\\\\-\\\\+{}[]:\\\\;\\\\\\\"\\\\<\\\\>?/.,DC=ad,DC=com\""; for (let __i = 0; __i < __s.length; __i++) __b.buf[__i] = __s.charCodeAt(__i); return __b; })();
  assert_parse_string(cptr_clone(string), "~!@\\#$%^&*()\\\\-\\+{}[]:\\;\\\"\\<\\>?/.,DC=ad,DC=com");
  reset(item);
}

export function main(): number {
  memset(item, 0, 64);
  UnityBegin("tests/real-world/cjson/tests/parse_string.c");
  UnityDefaultTestRun((parse_string_should_parse_strings), "parse_string_should_parse_strings", (128));
  UnityDefaultTestRun((parse_string_should_parse_utf16_surrogate_pairs), "parse_string_should_parse_utf16_surrogate_pairs", (129));
  UnityDefaultTestRun((parse_string_should_not_parse_non_strings), "parse_string_should_not_parse_non_strings", (130));
  UnityDefaultTestRun((parse_string_should_not_parse_invalid_backslash), "parse_string_should_not_parse_invalid_backslash", (131));
  UnityDefaultTestRun((parse_string_should_parse_bug_94), "parse_string_should_parse_bug_94", (132));
  UnityDefaultTestRun((parse_string_should_not_overflow_with_closing_backslash), "parse_string_should_not_overflow_with_closing_backslash", (133));
  return UnityEnd();
}
