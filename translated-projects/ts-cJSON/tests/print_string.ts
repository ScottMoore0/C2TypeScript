...
function assert_print_string(expected: string, input: string): void {
  ...
  Object.assign(buffer.hooks, global_hooks);
  if ((print_string_ptr(cptr_clone((input)), buffer))) {
  } else {
    UnityFail(((("Failed to print string."))), __u64(__as_bigint((__u64(__as_bigint((37)))))));
  }
  UnityAssertEqualString(cptr_clone((((expected)))), cptr_clone((((printed)))), (("The printed string isn't as expected.")), __u64(__as_bigint((38))));
}

function print_string_should_print_empty_strings(): void {
  assert_print_string("\"\"", "");
  assert_print_string("\"\"", null);
}

function print_string_should_print_ascii(): void {
  let ascii = cptr_create(127);
  let i = ((1) >>> 0);
  for (i = ((1) >>> 0); ((i) >>> 0) < ((127) >>> 0); (() => { const _t = i; i = u32(i + 1); return _t; })()) {
    ascii.buf[(ascii.off ?? 0) + ((i) >>> 0) - ((1) >>> 0)] = (((Number(BigInt.asIntN(32, __as_bigint(((i) >>> 0))))) << 24 >> 24)) << 24 >> 24;
  }
  ascii.buf[(ascii.off ?? 0) + i32(127 - 1)] = (((0) << 24 >> 24)) << 24 >> 24;
  assert_print_string("\"\\u0001\\u0002\\u0003\\u0004\\u0005\\u0006\\u0007\\b\\t\\n\\u000b\\f\\r\\u000e\\u000f\\u0010\\u0011\\u0012\\u0013\\u0014\\u0015\\u0016\\u0017\\u0018\\u0019\\u001a\\u001b\\u001c\\u001d\\u001e\\u001f !\\\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\\\]^_`abcdefghijklmnopqrstuvwxyz{|}~\"", cptr_clone(ascii));
}

function print_string_should_print_utf8(): void {
  assert_print_string("\"\xC3\xBC\xE7\x8C\xAB\xE6\x85\x95\"", "\xC3\xBC\xE7\x8C\xAB\xE6\x85\x95");
}

export function main(): number {
  UnityBegin("tests/real-world/cjson/tests/print_string.c");
  UnityDefaultTestRun((print_string_should_print_empty_strings), "print_string_should_print_empty_strings", (73));
  UnityDefaultTestRun((print_string_should_print_ascii), "print_string_should_print_ascii", (74));
  UnityDefaultTestRun((print_string_should_print_utf8), "print_string_should_print_utf8", (75));
  return UnityEnd();
}
