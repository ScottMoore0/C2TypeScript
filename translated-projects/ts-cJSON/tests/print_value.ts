...
function assert_print_value(input: string): void {
  ...
  memset(item, 0, 64);
  if ((parse_value(item, parsebuffer))) {
  } else {
    UnityFail(((("Failed to parse value."))), __u64(__as_bigint((__u64(__as_bigint((49)))))));
  }
  if ((print_value(item, buffer))) {
  } else {
    UnityFail(((("Failed to print value."))), __u64(__as_bigint((__u64(__as_bigint((51)))))));
  }
  UnityAssertEqualString(cptr_clone((((input)))), cptr_clone((((buffer.buffer)))), (("Printed value is not as expected.")), __u64(__as_bigint((52))));
  reset(item);
}

function print_value_should_print_null(): void {
  assert_print_value("null");
}

function print_value_should_print_true(): void {
  assert_print_value("true");
}

function print_value_should_print_false(): void {
  assert_print_value("false");
}

function print_value_should_print_number(): void {
  assert_print_value("1.5");
}

function print_value_should_print_string(): void {
  assert_print_value("\"\"");
  assert_print_value("\"hello\"");
}

function print_value_should_print_array(): void {
  assert_print_value("[]");
}

function print_value_should_print_object(): void {
  assert_print_value("{}");
}

export function main(): number {
  UnityBegin("tests/real-world/cjson/tests/print_value.c");
  UnityDefaultTestRun((print_value_should_print_null), "print_value_should_print_null", (98));
  ...
  UnityDefaultTestRun((print_value_should_print_number), "print_value_should_print_number", (101));
  UnityDefaultTestRun((print_value_should_print_string), "print_value_should_print_string", (102));
  UnityDefaultTestRun((print_value_should_print_array), "print_value_should_print_array", (103));
  UnityDefaultTestRun((print_value_should_print_object), "print_value_should_print_object", (104));
  return UnityEnd();
}
