...
import { UnityBegin, UnityDefaultTestRun, UnityEnd, UnityFail } from './unity.js';
...
function compare_from_string(a: string, b: string, case_sensitive: cJSON_bool): cJSON_bool {
  let a_json = null; /* &ref */
  let b_json = null; /* &ref */
  let result = (Math.trunc(+(0)));
  a_json = cJSON_Parse(cptr_clone(a));
  if ((((a_json)) != (null))) {
  } else {
    UnityFail((((("Failed to parse a.")))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((34))))))))));
  }
  b_json = cJSON_Parse(cptr_clone(b));
  if ((((b_json)) != (null))) {
  } else {
    UnityFail((((("Failed to parse b.")))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((36))))))))));
  }
...
function cjson_compare_should_compare_null_pointer_as_not_equal(): void {
  if (!(cJSON_Compare(null, null, (Math.trunc(+(1)))))) {
  } else {
    UnityFail(((" Expected FALSE Was TRUE")), __u64(__as_bigint((__u64(__as_bigint((48)))))));
  }
  if (!(cJSON_Compare(null, null, (Math.trunc(+(0)))))) {
  } else {
    UnityFail(((" Expected FALSE Was TRUE")), __u64(__as_bigint((__u64(__as_bigint((49)))))));
  }
}

function cjson_compare_should_compare_invalid_as_not_equal(): void {
  let invalid = new cJSON();
  memset(invalid, 0, 64);
  if (!(cJSON_Compare(invalid, invalid, (Math.trunc(+(0)))))) {
  } else {
    UnityFail(((" Expected FALSE Was TRUE")), __u64(__as_bigint((__u64(__as_bigint((57)))))));
  }
  if (!(cJSON_Compare(invalid, invalid, (Math.trunc(+(1)))))) {
  } else {
    UnityFail(((" Expected FALSE Was TRUE")), __u64(__as_bigint((__u64(__as_bigint((58)))))));
  }
}

function cjson_compare_should_compare_numbers(): void {
  if ((compare_from_string("1", "1", (Math.trunc(+(1)))))) {
  } else {
    UnityFail(((" Expected TRUE Was FALSE")), __u64(__as_bigint((__u64(__as_bigint((63)))))));
  }
  if ((compare_from_string("1", "1", (Math.trunc(+(0)))))) {
  } else {
    UnityFail(((" Expected TRUE Was FALSE")), __u64(__as_bigint((__u64(__as_bigint((64)))))));
  }
  if ((compare_from_string("0.0001", "0.0001", (Math.trunc(+(1)))))) {
  } else {
    UnityFail(((" Expected TRUE Was FALSE")), __u64(__as_bigint((__u64(__as_bigint((65)))))));
  }
  if ((compare_from_string("0.0001", "0.0001", (Math.trunc(+(0)))))) {
  } else {
    UnityFail(((" Expected TRUE Was FALSE")), __u64(__as_bigint((__u64(__as_bigint((66)))))));
  }
  if ((compare_from_string("1E100", "10E99", (Math.trunc(+(0)))))) {
  } else {
    UnityFail(((" Expected TRUE Was FALSE")), __u64(__as_bigint((__u64(__as_bigint((67)))))));
  }
  if (!(compare_from_string("0.5E-100", "0.5E-101", (Math.trunc(+(0)))))) {
  } else {
    UnityFail(((" Expected FALSE Was TRUE")), __u64(__as_bigint((__u64(__as_bigint((69)))))));
  }
  if (!(compare_from_string("1", "2", (Math.trunc(+(1)))))) {
  } else {
    UnityFail(((" Expected FALSE Was TRUE")), __u64(__as_bigint((__u64(__as_bigint((71)))))));
  }
  if (!(compare_from_string("1", "2", (Math.trunc(+(0)))))) {
  } else {
    UnityFail(((" Expected FALSE Was TRUE")), __u64(__as_bigint((__u64(__as_bigint((72)))))));
  }
}

function cjson_compare_should_compare_booleans(): void {
  if ((compare_from_string("true", "true", (Math.trunc(+(1)))))) {
  } else {
    UnityFail(((" Expected TRUE Was FALSE")), __u64(__as_bigint((__u64(__as_bigint((78)))))));
  }
  if ((compare_from_string("true", "true", (Math.trunc(+(0)))))) {
  } else {
    UnityFail(((" Expected TRUE Was FALSE")), __u64(__as_bigint((__u64(__as_bigint((79)))))));
  }
  if ((compare_from_string("false", "false", (Math.trunc(+(1)))))) {
  } else {
    UnityFail(((" Expected TRUE Was FALSE")), __u64(__as_bigint((__u64(__as_bigint((82)))))));
  }
  if ((compare_from_string("false", "false", (Math.trunc(+(0)))))) {
  } else {
    UnityFail(((" Expected TRUE Was FALSE")), __u64(__as_bigint((__u64(__as_bigint((83)))))));
  }
  if (!(compare_from_string("true", "false", (Math.trunc(+(1)))))) {
  } else {
    UnityFail(((" Expected FALSE Was TRUE")), __u64(__as_bigint((__u64(__as_bigint((86)))))));
  }
  if (!(compare_from_string("true", "false", (Math.trunc(+(0)))))) {
  } else {
    UnityFail(((" Expected FALSE Was TRUE")), __u64(__as_bigint((__u64(__as_bigint((87)))))));
  }
  if (!(compare_from_string("false", "true", (Math.trunc(+(1)))))) {
  } else {
    UnityFail(((" Expected FALSE Was TRUE")), __u64(__as_bigint((__u64(__as_bigint((88)))))));
  }
  if (!(compare_from_string("false", "true", (Math.trunc(+(0)))))) {
  } else {
    UnityFail(((" Expected FALSE Was TRUE")), __u64(__as_bigint((__u64(__as_bigint((89)))))));
  }
}

function cjson_compare_should_compare_null(): void {
  if ((compare_from_string("null", "null", (Math.trunc(+(1)))))) {
  } else {
    UnityFail(((" Expected TRUE Was FALSE")), __u64(__as_bigint((__u64(__as_bigint((94)))))));
  }
  if ((compare_from_string("null", "null", (Math.trunc(+(0)))))) {
  } else {
    UnityFail(((" Expected TRUE Was FALSE")), __u64(__as_bigint((__u64(__as_bigint((95)))))));
  }
  if (!(compare_from_string("null", "true", (Math.trunc(+(1)))))) {
  } else {
    UnityFail(((" Expected FALSE Was TRUE")), __u64(__as_bigint((__u64(__as_bigint((97)))))));
  }
  if (!(compare_from_string("null", "true", (Math.trunc(+(0)))))) {
  } else {
    UnityFail(((" Expected FALSE Was TRUE")), __u64(__as_bigint((__u64(__as_bigint((98)))))));
  }
}

function cjson_compare_should_not_accept_invalid_types(): void {
  let invalid = new cJSON();
  memset(invalid, 0, 64);
  (__struct_ptr_at(invalid, 0)).type = (((1 << 3) | 0)) | (((1 << 4) | 0));
  if (!(cJSON_Compare(invalid, invalid, (Math.trunc(+(1)))))) {
  } else {
    UnityFail(((" Expected FALSE Was TRUE")), __u64(__as_bigint((__u64(__as_bigint((108)))))));
  }
  if (!(cJSON_Compare(invalid, invalid, (Math.trunc(+(0)))))) {
  } else {
    UnityFail(((" Expected FALSE Was TRUE")), __u64(__as_bigint((__u64(__as_bigint((109)))))));
  }
}

function cjson_compare_should_compare_strings(): void {
  if ((compare_from_string("\"abcdefg\"", "\"abcdefg\"", (Math.trunc(+(1)))))) {
  } else {
    UnityFail(((" Expected TRUE Was FALSE")), __u64(__as_bigint((__u64(__as_bigint((114)))))));
  }
  if ((compare_from_string("\"abcdefg\"", "\"abcdefg\"", (Math.trunc(+(0)))))) {
  } else {
    UnityFail(((" Expected TRUE Was FALSE")), __u64(__as_bigint((__u64(__as_bigint((115)))))));
  }
  if (!(compare_from_string("\"ABCDEFG\"", "\"abcdefg\"", (Math.trunc(+(1)))))) {
  } else {
    UnityFail(((" Expected FALSE Was TRUE")), __u64(__as_bigint((__u64(__as_bigint((117)))))));
  }
  if (!(compare_from_string("\"ABCDEFG\"", "\"abcdefg\"", (Math.trunc(+(0)))))) {
  } else {
    UnityFail(((" Expected FALSE Was TRUE")), __u64(__as_bigint((__u64(__as_bigint((118)))))));
  }
}

function cjson_compare_should_compare_raw(): void {
  let raw1 = null; /* &ref */
  let raw2 = null; /* &ref */
  raw1 = cJSON_Parse("\"[true, false]\"");
  if ((((raw1)) != (null))) {
  } else {
    UnityFail((((" Expected Non-NULL"))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((127))))))))));
  }
  raw2 = cJSON_Parse("\"[true, false]\"");
  if ((((raw2)) != (null))) {
  } else {
    UnityFail((((" Expected Non-NULL"))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((129))))))))));
  }
  (__struct_ptr_at(raw1, 0)).type = (((1 << 7) | 0));
  (__struct_ptr_at(raw2, 0)).type = (((1 << 7) | 0));
  if ((cJSON_Compare(raw1, raw2, (Math.trunc(+(1)))))) {
  } else {
    UnityFail(((" Expected TRUE Was FALSE")), __u64(__as_bigint((__u64(__as_bigint((134)))))));
  }
  if ((cJSON_Compare(raw1, raw2, (Math.trunc(+(0)))))) {
  } else {
    UnityFail(((" Expected TRUE Was FALSE")), __u64(__as_bigint((__u64(__as_bigint((135)))))));
  }
  cJSON_Delete(raw1);
  cJSON_Delete(raw2);
}

function cjson_compare_should_compare_arrays(): void {
  if ((compare_from_string("[]", "[]", (Math.trunc(+(1)))))) {
  } else {
    UnityFail(((" Expected TRUE Was FALSE")), __u64(__as_bigint((__u64(__as_bigint((143)))))));
  }
  if ((compare_from_string("[]", "[]", (Math.trunc(+(0)))))) {
  } else {
    UnityFail(((" Expected TRUE Was FALSE")), __u64(__as_bigint((__u64(__as_bigint((144)))))));
  }
  if ((compare_from_string("[false,true,null,42,\"string\",[],{}]", "[false, true, null, 42, \"string\", [], {}]", (Math.trunc(+(1)))))) {
  } else {
    UnityFail(((" Expected TRUE Was FALSE")), __u64(__as_bigint((__u64(__as_bigint((146)))))));
  }
  if ((compare_from_string("[false,true,null,42,\"string\",[],{}]", "[false, true, null, 42, \"string\", [], {}]", (Math.trunc(+(0)))))) {
  } else {
    UnityFail(((" Expected TRUE Was FALSE")), __u64(__as_bigint((__u64(__as_bigint((147)))))));
  }
  if ((compare_from_string("[[[1], 2]]", "[[[1], 2]]", (Math.trunc(+(1)))))) {
  } else {
    UnityFail(((" Expected TRUE Was FALSE")), __u64(__as_bigint((__u64(__as_bigint((149)))))));
  }
  if ((compare_from_string("[[[1], 2]]", "[[[1], 2]]", (Math.trunc(+(0)))))) {
  } else {
    UnityFail(((" Expected TRUE Was FALSE")), __u64(__as_bigint((__u64(__as_bigint((150)))))));
  }
  if (!(compare_from_string("[true,null,42,\"string\",[],{}]", "[false, true, null, 42, \"string\", [], {}]", (Math.trunc(+(1)))))) {
  } else {
    UnityFail(((" Expected FALSE Was TRUE")), __u64(__as_bigint((__u64(__as_bigint((152)))))));
  }
  if (!(compare_from_string("[true,null,42,\"string\",[],{}]", "[false, true, null, 42, \"string\", [], {}]", (Math.trunc(+(0)))))) {
  } else {
    UnityFail(((" Expected FALSE Was TRUE")), __u64(__as_bigint((__u64(__as_bigint((153)))))));
  }
  if (!(compare_from_string("[1,2,3]", "[1,2]", (Math.trunc(+(1)))))) {
  } else {
    UnityFail(((" Expected FALSE Was TRUE")), __u64(__as_bigint((__u64(__as_bigint((156)))))));
  }
  if (!(compare_from_string("[1,2,3]", "[1,2]", (Math.trunc(+(0)))))) {
  } else {
    UnityFail(((" Expected FALSE Was TRUE")), __u64(__as_bigint((__u64(__as_bigint((157)))))));
  }
}

function cjson_compare_should_compare_objects(): void {
  if ((compare_from_string("{}", "{}", (Math.trunc(+(1)))))) {
  } else {
    UnityFail(((" Expected TRUE Was FALSE")), __u64(__as_bigint((__u64(__as_bigint((162)))))));
  }
  if ((compare_from_string("{}", "{}", (Math.trunc(+(0)))))) {
  } else {
    UnityFail(((" Expected TRUE Was FALSE")), __u64(__as_bigint((__u64(__as_bigint((163)))))));
  }
  if ((compare_from_string("{\"false\": false, \"true\": true, \"null\": null, \"number\": 42, \"string\": \"string\", \"array\": [], \"object\": {}}", "{\"true\": true, \"false\": false, \"null\": null, \"number\": 42, \"string\": \"string\", \"array\": [], \"object\": {}}", (Math.trunc(+(1)))))) {
  } else {
    UnityFail(((" Expected TRUE Was FALSE")), __u64(__as_bigint((__u64(__as_bigint((168)))))));
  }
  if (!(compare_from_string("{\"False\": false, \"true\": true, \"null\": null, \"number\": 42, \"string\": \"string\", \"array\": [], \"object\": {}}", "{\"true\": true, \"false\": false, \"null\": null, \"number\": 42, \"string\": \"string\", \"array\": [], \"object\": {}}", (Math.trunc(+(1)))))) {
  } else {
    UnityFail(((" Expected FALSE Was TRUE")), __u64(__as_bigint((__u64(__as_bigint((172)))))));
  }
  if ((compare_from_string("{\"False\": false, \"true\": true, \"null\": null, \"number\": 42, \"string\": \"string\", \"array\": [], \"object\": {}}", "{\"true\": true, \"false\": false, \"null\": null, \"number\": 42, \"string\": \"string\", \"array\": [], \"object\": {}}", (Math.trunc(+(0)))))) {
  } else {
    UnityFail(((" Expected TRUE Was FALSE")), __u64(__as_bigint((__u64(__as_bigint((176)))))));
  }
  if (!(compare_from_string("{\"Flse\": false, \"true\": true, \"null\": null, \"number\": 42, \"string\": \"string\", \"array\": [], \"object\": {}}", "{\"true\": true, \"false\": false, \"null\": null, \"number\": 42, \"string\": \"string\", \"array\": [], \"object\": {}}", (Math.trunc(+(0)))))) {
  } else {
    UnityFail(((" Expected FALSE Was TRUE")), __u64(__as_bigint((__u64(__as_bigint((180)))))));
  }
  if (!(compare_from_string("{\"one\": 1, \"two\": 2}", "{\"one\": 1, \"two\": 2, \"three\": 3}", (Math.trunc(+(1)))))) {
  } else {
    UnityFail(((" Expected FALSE Was TRUE")), __u64(__as_bigint((__u64(__as_bigint((185)))))));
  }
  if (!(compare_from_string("{\"one\": 1, \"two\": 2}", "{\"one\": 1, \"two\": 2, \"three\": 3}", (Math.trunc(+(0)))))) {
  } else {
...
export function main(): number {
  UnityBegin("tests/real-world/cjson/tests/compare_tests.c");
  UnityDefaultTestRun((cjson_compare_should_compare_null_pointer_as_not_equal), "cjson_compare_should_compare_null_pointer_as_not_equal", (196));
  UnityDefaultTestRun((cjson_compare_should_compare_invalid_as_not_equal), "cjson_compare_should_compare_invalid_as_not_equal", (197));
  UnityDefaultTestRun((cjson_compare_should_compare_numbers), "cjson_compare_should_compare_numbers", (198));
  UnityDefaultTestRun((cjson_compare_should_compare_booleans), "cjson_compare_should_compare_booleans", (199));
  UnityDefaultTestRun((cjson_compare_should_compare_null), "cjson_compare_should_compare_null", (200));
  UnityDefaultTestRun((cjson_compare_should_not_accept_invalid_types), "cjson_compare_should_not_accept_invalid_types", (201));
  UnityDefaultTestRun((cjson_compare_should_compare_strings), "cjson_compare_should_compare_strings", (202));
  UnityDefaultTestRun((cjson_compare_should_compare_raw), "cjson_compare_should_compare_raw", (203));
  UnityDefaultTestRun((cjson_compare_should_compare_arrays), "cjson_compare_should_compare_arrays", (204));
  UnityDefaultTestRun((cjson_compare_should_compare_objects), "cjson_compare_should_compare_objects", (205));
  return UnityEnd();
}
