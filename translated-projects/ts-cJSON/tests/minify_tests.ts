...
import { UnityAssertEqualString, UnityBegin, UnityDefaultTestRun, UnityEnd, UnityFail } from './unity.js';
...
function cjson_minify_should_not_overflow_buffer(): void {
  let unclosed_multiline_comment = (() => { const __b = cptr_create(7); const __s = "/* bla"; for (let __i = 0; __i < __s.length; __i++) __b.buf[__i] = __s.charCodeAt(__i); return __b; })();
  let pending_escape = (() => { const __b = cptr_create(3); const __s = "\"\\"; for (let __i = 0; __i < __s.length; __i++) __b.buf[__i] = __s.charCodeAt(__i); return __b; })();
  cJSON_Minify(cptr_clone(unclosed_multiline_comment));
  UnityAssertEqualString((((""))), cptr_clone((((unclosed_multiline_comment)))), null, __u64(__as_bigint((38))));
  cJSON_Minify(cptr_clone(pending_escape));
  UnityAssertEqualString(((("\"\\"))), cptr_clone((((pending_escape)))), null, __u64(__as_bigint((41))));
}

function cjson_minify_should_remove_single_line_comments(): void {
  let to_minify = (() => { const __b = cptr_create(61); const __s = "{// this is {} \"some kind\" of [] comment /*, don't you see\n}"; for (let __i = 0; __i < __s.length; __i++) __b.buf[__i] = __s.charCodeAt(__i); return __b; })();
  let minified = (malloc(61)); /* &ref */
  if ((!cptr_eq(((minified)), (null)))) {
  } else {
    UnityFail((((" Expected Non-NULL"))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((49))))))))));
  }
  strcpy(minified, cptr_clone(to_minify));
  cJSON_Minify(cptr_clone(minified));
  UnityAssertEqualString(((("{}"))), cptr_clone((((minified)))), null, __u64(__as_bigint((53))));
  free(minified);
}

function cjson_minify_should_remove_spaces(): void {
  let to_minify = (() => { const __b = cptr_create(21); const __s = "{ \"key\":\ttrue\r\n    }"; for (let __i = 0; __i < __s.length; __i++) __b.buf[__i] = __s.charCodeAt(__i); return __b; })();
  let minified = (malloc(21)); /* &ref */
  if ((!cptr_eq(((minified)), (null)))) {
  } else {
    UnityFail((((" Expected Non-NULL"))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((63))))))))));
  }
  strcpy(minified, cptr_clone(to_minify));
  cJSON_Minify(cptr_clone(minified));
  UnityAssertEqualString(((("{\"key\":true}"))), cptr_clone((((minified)))), null, __u64(__as_bigint((67))));
  free(minified);
}

function cjson_minify_should_remove_multiline_comments(): void {
  let to_minify = (() => { const __b = cptr_create(51); const __s = "{/* this is\n a /* multi\n //line \n {comment \"\\\" */}"; for (let __i = 0; __i < __s.length; __i++) __b.buf[__i] = __s.charCodeAt(__i); return __b; })();
  let minified = (malloc(51)); /* &ref */
  if ((!cptr_eq(((minified)), (null)))) {
  } else {
    UnityFail((((" Expected Non-NULL"))), __u64(__as_bigint((__u64(__as_bigint((__u64(__as_bigint((77))))))))));
  }
  strcpy(minified, cptr_clone(to_minify));
  cJSON_Minify(cptr_clone(minified));
  UnityAssertEqualString(((("{}"))), cptr_clone((((minified)))), null, __u64(__as_bigint((81))));
  free(minified);
}

function cjson_minify_should_not_modify_strings(): void {
  let to_minify = (() => { const __b = cptr_create(29); const __s = "\"this is a string \\\" \\t bla\""; for (let __i = 0; __i < __s.length; __i++) __b.buf[__i] = __s.charCodeAt(__i); return __b; })();
  let minified = (malloc(29)); /* &ref */
  if ((!cptr_eq(((minified)), (null)))) {
  } else {
  ...
  strcpy(minified, cptr_clone(to_minify));
  cJSON_Minify(cptr_clone(minified));
  UnityAssertEqualString(cptr_clone((((to_minify)))), cptr_clone((((minified)))), null, __u64(__as_bigint((95))));
  free(minified);
}

function cjson_minify_should_minify_json(): void {
  let to_minify = (() => { const __b = cptr_create(448); const __s = "{\n    \"glossary\": { // comment\n        \"title\": \"example glossary\",\n  /* multi\n line */\n\t\t\"GlossDiv\": {\n            \"title\": \"S\",\n\t\t\t\"GlossList\": {\n                \"GlossEntry\": {\n                    \"ID\": \"SGML\",\n\t\t\t\t\t\"SortAs\": \"SGML\",\n\t\t\t\t\t\"Acronym\": \"SGML\",\n\t\t\t\t\t\"Abbrev\": \"ISO 8879:1986\",\n\t\t\t\t\t\"GlossDef\": {\n\t\t\t\t\t\t\"GlossSeeAlso\": [\"GML\", \"XML\"]\n                    },\n\t\t\t\t\t\"GlossSee\": \"markup\"\n                }\n            }\n        }\n    }\n}"; for (let __i = 0; __i < __s.length; __i++) __b.buf[__i] = __s.charCodeAt(__i); return __b; })();
  let minified = cptr_from_string("{\"glossary\":{\"title\":\"example glossary\",\"GlossDiv\":{\"title\":\"S\",\"GlossList\":{\"GlossEntry\":{\"ID\":\"SGML\",\"SortAs\":\"SGML\",\"Acronym\":\"SGML\",\"Abbrev\":\"ISO 8879:1986\",\"GlossDef\":{\"GlossSeeAlso\":[\"GML\",\"XML\"]},\"GlossSee\":\"markup\"}}}}}"); /* &ref */
  let buffer = (malloc(448)); /* &ref */
  strcpy(buffer, cptr_clone(to_minify));
  cJSON_Minify(cptr_clone(buffer));
  UnityAssertEqualString(cptr_clone((((minified)))), cptr_clone((((buffer)))), null, __u64(__as_bigint((150))));
  free(buffer);
}

function cjson_minify_should_not_loop_infinitely(): void {
  let string = (() => { const __b = cptr_create(7); __b.buf[0] = (((56) << 24 >> 24)) & 0xFF; __b.buf[1] = (((32) << 24 >> 24)) & 0xFF; __b.buf[2] = (((47) << 24 >> 24)) & 0xFF; __b.buf[3] = (((32) << 24 >> 24)) & 0xFF; __b.buf[4] = (((53) << 24 >> 24)) & 0xFF; __b.buf[5] = (((10) << 24 >> 24)) & 0xFF; __b.buf[6] = (((0) << 24 >> 24)) & 0xFF; return __b; })();
  cJSON_Minify(cptr_clone(string));
}

export function main(): number {
  UnityBegin("tests/real-world/cjson/tests/minify_tests.c");
  UnityDefaultTestRun((cjson_minify_should_not_overflow_buffer), "cjson_minify_should_not_overflow_buffer", (165));
  UnityDefaultTestRun((cjson_minify_should_minify_json), "cjson_minify_should_minify_json", (166));
  UnityDefaultTestRun((cjson_minify_should_remove_single_line_comments), "cjson_minify_should_remove_single_line_comments", (167));
  UnityDefaultTestRun((cjson_minify_should_remove_multiline_comments), "cjson_minify_should_remove_multiline_comments", (168));
  UnityDefaultTestRun((cjson_minify_should_remove_spaces), "cjson_minify_should_remove_spaces", (169));
  UnityDefaultTestRun((cjson_minify_should_not_modify_strings), "cjson_minify_should_not_modify_strings", (170));
  UnityDefaultTestRun((cjson_minify_should_not_loop_infinitely), "cjson_minify_should_not_loop_infinitely", (171));
  return UnityEnd();
}
