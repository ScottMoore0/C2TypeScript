...
function parse_number(item: cJSON | null, input_buffer: parse_buffer | null): cJSON_bool {
  ...
  _sm: while (true) {
    ...
    case 1: /* loop_end */
      ...
      if ((cptr_eq(number_c_string, (null)) ? 1 : 0)) {
        return (Math.trunc(+(0)));
      }
      ...
      if (has_decimal_point) {
        for (i = ((0) >>> 0); (((i) >>> 0) < ((number_string_length) >>> 0) ? 1 : 0); (() => { const _t = i; i = u32(i + 1); return _t; })()) {
          if ((((number_c_string.buf[(number_c_string.off ?? 0) + ((i) >>> 0)]) & 0xFF) == 46 ? 1 : 0)) {
...
export function cJSON_SetValuestring(object: cJSON | null, valuestring: any): CPtr {
  let copy = null; /* &ref */
  let v1_len = 0;
  let v2_len = 0;
  if (((((((object == (null) ? 1 : 0)) || (!((__struct_ptr_at(object, 0)).type & (((1 << 4) | 0))) ? 1 : 0)) ? 1 : 0) || ((__struct_ptr_at(object, 0)).type & 256)) ? 1 : 0)) {
    return null;
  }
  if ((((cptr_eq((__struct_ptr_at(object, 0)).valuestring, (null)) ? 1 : 0) || (cptr_eq(valuestring, (null)) ? 1 : 0)) ? 1 : 0)) {
    return null;
  }
  v1_len = strlen(cptr_clone(valuestring));
  v2_len = strlen(cptr_clone((__struct_ptr_at(object, 0)).valuestring));
  if ((((v1_len) >>> 0) <= ((v2_len) >>> 0) ? 1 : 0)) {
    if ((!((((((__l: any, __r: any) => { const __lb = __l && __l.buf; const __rb = __r && __r.buf; if (__lb && __rb && __lb === __rb) return ((__l.off ?? 0) < (__r.off ?? 0)); if (__lb || __rb) return (__rt_ptr_to_intptr(__l) < __rt_ptr_to_intptr(__r)); return ((__l ?? 0) < (__r ?? 0)); })(cptr_offset(valuestring, ((v1_len) >>> 0)), (__struct_ptr_at(object, 0)).valuestring) ? 1 : 0) || (((__l: any, __r: any) => { const __lb = __l && __l.buf; const __rb = __r && __r.buf; if (__lb && __rb && __lb === __rb) return ((__l.off ?? 0) < (__r.off ?? 0)); if (__lb || __rb) return (__rt_ptr_to_intptr(__l) < __rt_ptr_to_intptr(__r)); return ((__l ?? 0) < (__r ?? 0)); })(cptr_offset((__struct_ptr_at(object, 0)).valuestring, ((v2_len) >>> 0)), valuestring) ? 1 : 0)) ? 1 : 0)) ? 1 : 0)) {
      return null;
    }
  ...
  if ((!cptr_eq((__struct_ptr_at(object, 0)).valuestring, (null)) ? 1 : 0)) {
...
function ensure(p: printbuffer | null, needed: number): any | null {
  ...
  let newsize = ((0) >>> 0);
  if (((((p == (null) ? 1 : 0)) || ((cptr_eq((__struct_ptr_at(p, 0)).buffer, (null)) ? 1 : 0))) ? 1 : 0)) {
    return null;
  }
  if ((((((((__struct_ptr_at(p, 0)).length) >>> 0) > ((0) >>> 0) ? 1 : 0)) && (((((__struct_ptr_at(p, 0)).offset) >>> 0) >= (((__struct_ptr_at(p, 0)).length) >>> 0) ? 1 : 0))) ? 1 : 0)) {
    return null;
  }
  if ((((needed) >>> 0) > ((2147483647) >>> 0) ? 1 : 0)) {
    return null;
  }
  needed += (((__struct_ptr_at(p, 0)).offset) >>> 0) + ((1) >>> 0);
  if ((((needed) >>> 0) <= (((__struct_ptr_at(p, 0)).length) >>> 0) ? 1 : 0)) {
    return cptr_clone(cptr_offset((__struct_ptr_at(p, 0)).buffer, (((__struct_ptr_at(p, 0)).offset) >>> 0)));
  }
  if ((__struct_ptr_at(p, 0)).noalloc) {
    return null;
  }
  if ((((needed) >>> 0) > (((__safe_div(2147483647, 2))) >>> 0) ? 1 : 0)) {
    if ((((needed) >>> 0) <= ((2147483647) >>> 0) ? 1 : 0)) {
...
function update_offset(buffer: printbuffer | null): void {
  ...
  if (((((buffer == (null) ? 1 : 0)) || ((cptr_eq((__struct_ptr_at(buffer, 0)).buffer, (null)) ? 1 : 0))) ? 1 : 0)) {
    return;
  }
...
function print_number(item: cJSON | null, output_buffer: printbuffer | null): cJSON_bool {
  ...
  if ((output_buffer == (null) ? 1 : 0)) {
    return (Math.trunc(+(0)));
  }
  if (((((((((((0 ? 102 : (1 ? 100 : 108))) == 102 ? 1 : 0) ? _fdclass(Math.fround((d))) : ((((0 ? 102 : (1 ? 100 : 108))) == 100 ? 1 : 0) ? _dclass(((d))) : _ldclass(((d))))))) == 2 ? 1 : 0)) || ((((((((0 ? 102 : (1 ? 100 : 108))) == 102 ? 1 : 0) ? _fdclass(Math.fround((d))) : ((((0 ? 102 : (1 ? 100 : 108))) == 100 ? 1 : 0) ? _dclass(((d))) : _ldclass(((d))))))) == 1 ? 1 : 0))) ? 1 : 0)) {
    length = (() => { const __s = printf_format("null"); strcpy((number_buffer), __s); return __s.length; })();
  } else {
    if ((d == ((__struct_ptr_at(item, 0)).valueint) ? 1 : 0)) {
      ...
      if (((((sscanf((number_buffer), "%lg", test_box) != 1 ? 1 : 0)) || (!compare_double((test_box.value), d) ? 1 : 0)) ? 1 : 0)) {
        length = (() => { const __s = printf_format("%1.17g", d); strcpy((number_buffer), __s); return __s.length; })();
      }
    }
  }
  if (((((length < 0 ? 1 : 0)) || ((length > (Math.trunc(+((26 - 1))) | 0) ? 1 : 0))) ? 1 : 0)) {
    return (Math.trunc(+(0)));
  }
  output_pointer = ensure(output_buffer, ((Math.trunc(+(length))) >>> 0) + 1);
  if ((cptr_eq(output_pointer, (null)) ? 1 : 0)) {
    return (Math.trunc(+(0)));
  }
  for (i = ((0) >>> 0); (((i) >>> 0) < (((Math.trunc(+(length))) >>> 0)) ? 1 : 0); (() => { const _t = i; i = u32(i + 1); return _t; })()) {
    if ((((number_buffer.buf[(number_buffer.off ?? 0) + ((i) >>> 0)]) & 0xFF) == ((decimal_point) & 0xFF) ? 1 : 0)) {
...
function parse_hex4(input: any | null): number {
  ...
  for (i = ((0) >>> 0); (((i) >>> 0) < ((4) >>> 0) ? 1 : 0); (() => { const _t = i; i = u32(i + 1); return _t; })()) {
    if (((((((input.buf[(input.off ?? 0) + ((i) >>> 0)]) & 0xFF) >= 48 ? 1 : 0)) && ((((input.buf[(input.off ?? 0) + ((i) >>> 0)]) & 0xFF) <= 57 ? 1 : 0))) ? 1 : 0)) {
      h = u32(h + u32(((Math.trunc(+(((input.buf[(input.off ?? 0) + ((i) >>> 0)]) & 0xFF)))) >>> 0) - ((48) >>> 0)));
    } else {
      if (((((((input.buf[(input.off ?? 0) + ((i) >>> 0)]) & 0xFF) >= 65 ? 1 : 0)) && ((((input.buf[(input.off ?? 0) + ((i) >>> 0)]) & 0xFF) <= 70 ? 1 : 0))) ? 1 : 0)) {
        h = u32(h + u32(u32(((Math.trunc(+(10))) >>> 0) + ((((input.buf[(input.off ?? 0) + ((i) >>> 0)]) & 0xFF)) >>> 0)) - ((65) >>> 0)));
      } else {
        if (((((((input.buf[(input.off ?? 0) + ((i) >>> 0)]) & 0xFF) >= 97 ? 1 : 0)) && ((((input.buf[(input.off ?? 0) + ((i) >>> 0)]) & 0xFF) <= 102 ? 1 : 0))) ? 1 : 0)) {
...
// BRIDGE: c-out-pointer — C17 §6.5.3.2 + §6.7.6.1: T*/T** out parameters lowered as COutParam<T> = { value: T }. Affected params: output_pointer.
...
function utf16_literal_to_utf8(input_pointer: any | null, input_end: any | null, output_pointer: COutParam<any | null>): number {
  ...
  _sm: while (true) {
    ...
    case 0:
      codepoint = ((0) >>> 0);
      first_code = ((0) >>> 0);
      first_sequence = cptr_clone(cptr_clone(input_pointer)); /* &ref */
      utf8_length = ((0) & 0xFF);
      utf8_position = ((0) & 0xFF);
      sequence_length = ((0) & 0xFF);
      first_byte_mark = ((0) & 0xFF);
      if (((((__lp: any, __rp: any) => { const __lb = __lp && __lp.buf; const __rb = __rp && __rp.buf; if (__lb && __rb && __lb !== __rb) return (__rt_ptr_to_intptr(__lp) - __rt_ptr_to_intptr(__rp)); return (((__x) => __x == null ? 0 : (typeof __x === 'string' ? 0 : (__x && __x.__field_ref === true ? ((__x.__field_offset ?? 0) + (__x.__byte_delta ?? 0)) : (typeof __x === 'object' && __x.off === undefined ? 0 : (__x.off ?? __x)))))(__lp) - ((__x) => __x == null ? 0 : (typeof __x === 'string' ? 0 : (__x && __x.__field_ref === true ? ((__x.__field_offset ?? 0) + (__x.__byte_delta ?? 0)) : (typeof __x === 'object' && __x.off === undefined ? 0 : (__x.off ?? __x)))))(__rp)); })(input_end, first_sequence)) < 6 ? 1 : 0)) {
        _state = 1; continue _sm; /* goto fail */
      }
      first_code = parse_hex4(cptr_offset(first_sequence, 2));
      if ((((((((first_code) >>> 0) >= ((56320) >>> 0) ? 1 : 0)) && ((((first_code) >>> 0) <= ((57343) >>> 0) ? 1 : 0))) ? 1 : 0))) {
        _state = 1; continue _sm; /* goto fail */
      }
      if (((((((first_code) >>> 0) >= ((55296) >>> 0) ? 1 : 0)) && ((((first_code) >>> 0) <= ((56319) >>> 0) ? 1 : 0))) ? 1 : 0)) {
        second_sequence = cptr_offset(first_sequence, 6); /* &ref */
        second_code = ((0) >>> 0);
        sequence_length = (((12) & 0xFF)) & 0xFF;
        if (((((__lp: any, __rp: any) => { const __lb = __lp && __lp.buf; const __rb = __rp && __rp.buf; if (__lb && __rb && __lb !== __rb) return (__rt_ptr_to_intptr(__lp) - __rt_ptr_to_intptr(__rp)); return (((__x) => __x == null ? 0 : (typeof __x === 'string' ? 0 : (__x && __x.__field_ref === true ? ((__x.__field_offset ?? 0) + (__x.__byte_delta ?? 0)) : (typeof __x === 'object' && __x.off === undefined ? 0 : (__x.off ?? __x)))))(__lp) - ((__x) => __x == null ? 0 : (typeof __x === 'string' ? 0 : (__x && __x.__field_ref === true ? ((__x.__field_offset ?? 0) + (__x.__byte_delta ?? 0)) : (typeof __x === 'object' && __x.off === undefined ? 0 : (__x.off ?? __x)))))(__rp)); })(input_end, second_sequence)) < 6 ? 1 : 0)) {
          _state = 1; continue _sm; /* goto fail */
        }
        if (((((((second_sequence.buf[(second_sequence.off ?? 0) + 0]) & 0xFF) != 92 ? 1 : 0)) || ((((second_sequence.buf[(second_sequence.off ?? 0) + 1]) & 0xFF) != 117 ? 1 : 0))) ? 1 : 0)) {
          _state = 1; continue _sm; /* goto fail */
        }
        second_code = parse_hex4(cptr_offset(second_sequence, 2));
        if (((((((second_code) >>> 0) < ((56320) >>> 0) ? 1 : 0)) || ((((second_code) >>> 0) > ((57343) >>> 0) ? 1 : 0))) ? 1 : 0)) {
          _state = 1; continue _sm; /* goto fail */
        }
      ...
      for (utf8_position = (((Math.trunc(+((i32(((utf8_length) & 0xFF) - 1))))) & 0xFF)) & 0xFF; (((utf8_position) & 0xFF) > 0 ? 1 : 0); (() => { const _t = utf8_position; utf8_position = u32(utf8_position - 1); return _t; })()) {
...
function parse_string(item: cJSON | null, input_buffer: parse_buffer | null): cJSON_bool {
  ...
  _sm: while (true) {
    ...
    case 0:
      ...
      output = null; /* &ref */
      if (((((cptr_offset((__struct_ptr_at((input_buffer), 0)).content, (((__struct_ptr_at((input_buffer), 0)).offset) >>> 0))).buf[((cptr_offset((__struct_ptr_at((input_buffer), 0)).content, (((__struct_ptr_at((input_buffer), 0)).offset) >>> 0))).off ?? 0) + 0]) & 0xFF) != 34 ? 1 : 0)) {
        _state = 1; continue _sm; /* goto fail */
      }
      allocation_length = ((0) >>> 0);
      skipped_bytes = ((0) >>> 0);
      while (((((((Math.trunc(+((((__lp: any, __rp: any) => { const __lb = __lp && __lp.buf; const __rb = __rp && __rp.buf; if (__lb && __rb && __lb !== __rb) return (__rt_ptr_to_intptr(__lp) - __rt_ptr_to_intptr(__rp)); return (((__x) => __x == null ? 0 : (typeof __x === 'string' ? 0 : (__x && __x.__field_ref === true ? ((__x.__field_offset ?? 0) + (__x.__byte_delta ?? 0)) : (typeof __x === 'object' && __x.off === undefined ? 0 : (__x.off ?? __x)))))(__lp) - ((__x) => __x == null ? 0 : (typeof __x === 'string' ? 0 : (__x && __x.__field_ref === true ? ((__x.__field_offset ?? 0) + (__x.__byte_delta ?? 0)) : (typeof __x === 'object' && __x.off === undefined ? 0 : (__x.off ?? __x)))))(__rp)); })(input_end, (__struct_ptr_at(input_buffer, 0)).content))))) >>> 0) < (((__struct_ptr_at(input_buffer, 0)).length) >>> 0) ? 1 : 0)) && ((((input_end.buf[input_end.off]) & 0xFF) != 34 ? 1 : 0))) ? 1 : 0)) {
        if ((((input_end.buf[(input_end.off ?? 0) + 0]) & 0xFF) == 92 ? 1 : 0)) {
      ...
      if ((cptr_eq(output, (null)) ? 1 : 0)) {
        _state = 1; continue _sm; /* goto fail */
      }
      output_pointer = cptr_clone(output);
      while ((((__l: any, __r: any) => { const __lb = __l && __l.buf; const __rb = __r && __r.buf; if (__lb && __rb && __lb === __rb) return ((__l.off ?? 0) < (__r.off ?? 0)); if (__lb || __rb) return (__rt_ptr_to_intptr(__l) < __rt_ptr_to_intptr(__r)); return ((__l ?? 0) < (__r ?? 0)); })(input_pointer, input_end) ? 1 : 0)) {
        if ((((input_pointer.buf[input_pointer.off]) & 0xFF) != 92 ? 1 : 0)) {
    ...
    case 1: /* fail */
      ...
      if ((!cptr_eq(input_pointer, (null)) ? 1 : 0)) {
...
function print_string_ptr(input: any | null, output_buffer: printbuffer | null): cJSON_bool {
  ...
  for (input_pointer = cptr_clone(input); ((input_pointer.buf[input_pointer.off]) & 0xFF); input_pointer.off++) {
    switch (((input_pointer.buf[input_pointer.off]) & 0xFF)) {
      ...
      default:
        {
          if ((((input_pointer.buf[input_pointer.off]) & 0xFF) < 32 ? 1 : 0)) {
  ...
  if ((((escape_characters) >>> 0) == ((0) >>> 0) ? 1 : 0)) {
  ...
  for (input_pointer = cptr_clone(input); (((input_pointer.buf[input_pointer.off]) & 0xFF) != 0 ? 1 : 0); (input_pointer.off++), output_pointer.off++) {
    if (((((((((input_pointer.buf[input_pointer.off]) & 0xFF) > 31 ? 1 : 0)) && ((((input_pointer.buf[input_pointer.off]) & 0xFF) != 34 ? 1 : 0))) ? 1 : 0) && ((((input_pointer.buf[input_pointer.off]) & 0xFF) != 92 ? 1 : 0))) ? 1 : 0)) {
      output_pointer.buf[output_pointer.off] = (((input_pointer.buf[input_pointer.off]) & 0xFF)) & 0xFF;
    } else {
...
function buffer_skip_whitespace(buffer: parse_buffer | null): parse_buffer | null {
  if (((((buffer == (null) ? 1 : 0)) || ((cptr_eq((__struct_ptr_at(buffer, 0)).content, (null)) ? 1 : 0))) ? 1 : 0)) {
    return null;
  }
  if (((!(((((buffer != (null) ? 1 : 0)) && ((((((__struct_ptr_at((buffer), 0)).offset) >>> 0) + ((0) >>> 0)) < (((__struct_ptr_at((buffer), 0)).length) >>> 0) ? 1 : 0))) ? 1 : 0)) ? 1 : 0))) {
    return buffer;
  }
  while ((((((((buffer != (null) ? 1 : 0)) && ((((((__struct_ptr_at((buffer), 0)).offset) >>> 0) + ((0) >>> 0)) < (((__struct_ptr_at((buffer), 0)).length) >>> 0) ? 1 : 0))) ? 1 : 0)) && (((((cptr_offset((__struct_ptr_at((buffer), 0)).content, (((__struct_ptr_at((buffer), 0)).offset) >>> 0))).buf[((cptr_offset((__struct_ptr_at((buffer), 0)).content, (((__struct_ptr_at((buffer), 0)).offset) >>> 0))).off ?? 0) + 0]) & 0xFF) <= 32 ? 1 : 0))) ? 1 : 0)) {
    (() => { const _t = (__struct_ptr_at(buffer, 0)).offset; (__struct_ptr_at(buffer, 0)).offset = u32((__struct_ptr_at(buffer, 0)).offset + 1); return _t; })();
  }
  if (((((__struct_ptr_at(buffer, 0)).offset) >>> 0) == (((__struct_ptr_at(buffer, 0)).length) >>> 0) ? 1 : 0)) {
    (() => { const _t = (__struct_ptr_at(buffer, 0)).offset; (__struct_ptr_at(buffer, 0)).offset = u32((__struct_ptr_at(buffer, 0)).offset - 1); return _t; })();
  }
  return buffer;
}
...
function skip_utf8_bom(buffer: parse_buffer | null): parse_buffer | null {
  if (((((((buffer == (null) ? 1 : 0)) || ((cptr_eq((__struct_ptr_at(buffer, 0)).content, (null)) ? 1 : 0))) ? 1 : 0) || (((((__struct_ptr_at(buffer, 0)).offset) >>> 0) != ((0) >>> 0) ? 1 : 0))) ? 1 : 0)) {
    return null;
  }
  if ((((((((buffer != (null) ? 1 : 0)) && ((((((__struct_ptr_at((buffer), 0)).offset) >>> 0) + ((4) >>> 0)) < (((__struct_ptr_at((buffer), 0)).length) >>> 0) ? 1 : 0))) ? 1 : 0)) && ((strncmp(((cptr_offset((__struct_ptr_at((buffer), 0)).content, (((__struct_ptr_at((buffer), 0)).offset) >>> 0)))), "\xEF\xBB\xBF", 3) == 0 ? 1 : 0))) ? 1 : 0)) {
    (__struct_ptr_at(buffer, 0)).offset += ((3) >>> 0);
  }
  return buffer;
}

// BRIDGE: c-out-pointer — C17 §6.5.3.2 + §6.7.6.1: T*/T** out parameters lowered as COutParam<T> = { value: T }. Affected params: return_parse_end.
// BRIDGE-HINT: to refactor into idiomatic TypeScript, return [<original-return>, ...out_types] and drop the COutParam parameters; callers replace box.value reads with destructuring.
export function cJSON_ParseWithOpts(value: any, return_parse_end: COutParam<CPtr>, require_null_terminated: cJSON_bool): cJSON | null {
  let buffer_length = 0;
  if ((cptr_eq((null), value) ? 1 : 0)) {
    return null;
  }
...
// BRIDGE: c-out-pointer — C17 §6.5.3.2 + §6.7.6.1: T*/T** out parameters lowered as COutParam<T> = { value: T }. Affected params: return_parse_end.
// BRIDGE-HINT: to refactor into idiomatic TypeScript, return [<original-return>, ...out_types] and drop the COutParam parameters; callers replace box.value reads with destructuring.
export function cJSON_ParseWithLengthOpts(value: string, buffer_length: number, return_parse_end: COutParam<CPtr>, require_null_terminated: cJSON_bool): cJSON | null {
  ...
  _sm: while (true) {
    ...
    case 0:
      ...
      if ((((cptr_eq(value, (null)) ? 1 : 0) || (((0) >>> 0) == ((buffer_length) >>> 0) ? 1 : 0)) ? 1 : 0)) {
        _state = 1; continue _sm; /* goto fail */
      }
      ...
      if ((!parse_value(item, buffer_skip_whitespace(skip_utf8_bom(buffer))) ? 1 : 0)) {
        _state = 1; continue _sm; /* goto fail */
      }
      if (require_null_terminated) {
        buffer_skip_whitespace(buffer);
        if (((((((buffer.offset) >>> 0) >= ((buffer.length) >>> 0) ? 1 : 0)) || ((((cptr_offset((buffer).content, (((buffer).offset) >>> 0))).buf[((cptr_offset((buffer).content, (((buffer).offset) >>> 0))).off ?? 0) + 0]) & 0xFF) != 0 ? 1 : 0)) ? 1 : 0)) {
          _state = 1; continue _sm; /* goto fail */
        }
      }
      if (return_parse_end) {
...
export function cJSON_Parse(value: any): cJSON | null {
  return cJSON_ParseWithOpts(cptr_clone(value), { value: null }, 0);
}

export function cJSON_ParseWithLength(value: any, buffer_length: number): cJSON | null {
...
function print(item: cJSON | null, format: cJSON_bool, hooks: internal_hooks | null): any | null {
  ...
  _sm: while (true) {
    ...
    case 0:
      ...
      if ((cptr_eq((__struct_ptr_at(buffer, 0)).buffer, (null)) ? 1 : 0)) {
        _state = 1; continue _sm; /* goto fail */
      }
      if ((!print_value(item, buffer) ? 1 : 0)) {
        _state = 1; continue _sm; /* goto fail */
      }
      update_offset(buffer);
      if (((__struct_ptr_at(hooks, 0)).reallocate != (null) ? 1 : 0)) {
        printed = ((__struct_ptr_at(hooks, 0)).reallocate((__struct_ptr_at(buffer, 0)).buffer, (((__struct_ptr_at(buffer, 0)).offset) >>> 0) + ((1) >>> 0)));
        if ((cptr_eq(printed, (null)) ? 1 : 0)) {
          _state = 1; continue _sm; /* goto fail */
        }
        ...
        memcpy(printed, (__struct_ptr_at(buffer, 0)).buffer, ((((((((__struct_ptr_at(buffer, 0)).length)) >>> 0) < ((((__struct_ptr_at(buffer, 0)).offset) >>> 0) + ((1) >>> 0)) ? 1 : 0)) ? ((((__struct_ptr_at(buffer, 0)).length)) >>> 0) : ((((__struct_ptr_at(buffer, 0)).offset) >>> 0) + ((1) >>> 0)))));
...
export function cJSON_Print(item: cJSON | null): CPtr {
  return cptr_clone((print(item, (Math.trunc(+(1))), global_hooks)));
}

export function cJSON_PrintUnformatted(item: cJSON | null): CPtr {
  return cptr_clone((print(item, (Math.trunc(+(0))), global_hooks)));
}

export function cJSON_PrintBuffered(item: cJSON | null, prebuffer: number, fmt: cJSON_bool): CPtr {
...
export function cJSON_PrintPreallocated(item: cJSON | null, buffer: string, length: number, format: cJSON_bool): cJSON_bool {
  let p = Object.assign(new printbuffer(), { buffer: null, length: ((0) >>> 0), offset: ((0) >>> 0), depth: ((0) >>> 0), noalloc: 0, format: 0, hooks: Object.assign(new internal_hooks(), { allocate: null, deallocate: null, reallocate: null }) });
  if (((((length < 0 ? 1 : 0)) || ((cptr_eq(buffer, (null)) ? 1 : 0))) ? 1 : 0)) {
    return (Math.trunc(+(0)));
  }
  p.buffer = (buffer);
...
function parse_value(item: cJSON | null, input_buffer: parse_buffer | null): cJSON_bool {
  ...
  if ((((((((input_buffer != (null) ? 1 : 0)) && ((((((__struct_ptr_at((input_buffer), 0)).offset) >>> 0) + ((4) >>> 0)) <= (((__struct_ptr_at((input_buffer), 0)).length) >>> 0) ? 1 : 0))) ? 1 : 0)) && ((strncmp(((cptr_offset((__struct_ptr_at((input_buffer), 0)).content, (((__struct_ptr_at((input_buffer), 0)).offset) >>> 0)))), "null", 4) == 0 ? 1 : 0))) ? 1 : 0)) {
    (__struct_ptr_at(item, 0)).type = (((1 << 2) | 0));
    (__struct_ptr_at(input_buffer, 0)).offset += ((4) >>> 0);
    return (Math.trunc(+(1)));
  }
  if ((((((((input_buffer != (null) ? 1 : 0)) && ((((((__struct_ptr_at((input_buffer), 0)).offset) >>> 0) + ((5) >>> 0)) <= (((__struct_ptr_at((input_buffer), 0)).length) >>> 0) ? 1 : 0))) ? 1 : 0)) && ((strncmp(((cptr_offset((__struct_ptr_at((input_buffer), 0)).content, (((__struct_ptr_at((input_buffer), 0)).offset) >>> 0)))), "false", 5) == 0 ? 1 : 0))) ? 1 : 0)) {
    (__struct_ptr_at(item, 0)).type = (((1 << 0) | 0));
    (__struct_ptr_at(input_buffer, 0)).offset += ((5) >>> 0);
    return (Math.trunc(+(1)));
  }
  if ((((((((input_buffer != (null) ? 1 : 0)) && ((((((__struct_ptr_at((input_buffer), 0)).offset) >>> 0) + ((4) >>> 0)) <= (((__struct_ptr_at((input_buffer), 0)).length) >>> 0) ? 1 : 0))) ? 1 : 0)) && ((strncmp(((cptr_offset((__struct_ptr_at((input_buffer), 0)).content, (((__struct_ptr_at((input_buffer), 0)).offset) >>> 0)))), "true", 4) == 0 ? 1 : 0))) ? 1 : 0)) {
    (__struct_ptr_at(item, 0)).type = (((1 << 1) | 0));
    (__struct_ptr_at(item, 0)).valueint = 1;
    (__struct_ptr_at(input_buffer, 0)).offset += ((4) >>> 0);
    return (Math.trunc(+(1)));
  }
  if ((((((((input_buffer != (null) ? 1 : 0)) && ((((((__struct_ptr_at((input_buffer), 0)).offset) >>> 0) + ((0) >>> 0)) < (((__struct_ptr_at((input_buffer), 0)).length) >>> 0) ? 1 : 0))) ? 1 : 0)) && (((((cptr_offset((__struct_ptr_at((input_buffer), 0)).content, (((__struct_ptr_at((input_buffer), 0)).offset) >>> 0))).buf[((cptr_offset((__struct_ptr_at((input_buffer), 0)).content, (((__struct_ptr_at((input_buffer), 0)).offset) >>> 0))).off ?? 0) + 0]) & 0xFF) == 34 ? 1 : 0))) ? 1 : 0)) {
    return parse_string(item, input_buffer);
  }
  if ((((((((input_buffer != (null) ? 1 : 0)) && ((((((__struct_ptr_at((input_buffer), 0)).offset) >>> 0) + ((0) >>> 0)) < (((__struct_ptr_at((input_buffer), 0)).length) >>> 0) ? 1 : 0))) ? 1 : 0)) && ((((((((cptr_offset((__struct_ptr_at((input_buffer), 0)).content, (((__struct_ptr_at((input_buffer), 0)).offset) >>> 0))).buf[((cptr_offset((__struct_ptr_at((input_buffer), 0)).content, (((__struct_ptr_at((input_buffer), 0)).offset) >>> 0))).off ?? 0) + 0]) & 0xFF) == 45 ? 1 : 0)) || ((((((((cptr_offset((__struct_ptr_at((input_buffer), 0)).content, (((__struct_ptr_at((input_buffer), 0)).offset) >>> 0))).buf[((cptr_offset((__struct_ptr_at((input_buffer), 0)).content, (((__struct_ptr_at((input_buffer), 0)).offset) >>> 0))).off ?? 0) + 0]) & 0xFF) >= 48 ? 1 : 0)) && (((((cptr_offset((__struct_ptr_at((input_buffer), 0)).content, (((__struct_ptr_at((input_buffer), 0)).offset) >>> 0))).buf[((cptr_offset((__struct_ptr_at((input_buffer), 0)).content, (((__struct_ptr_at((input_buffer), 0)).offset) >>> 0))).off ?? 0) + 0]) & 0xFF) <= 57 ? 1 : 0))) ? 1 : 0))) ? 1 : 0))) ? 1 : 0)) {
    return parse_number(item, input_buffer);
  }
  if ((((((((input_buffer != (null) ? 1 : 0)) && ((((((__struct_ptr_at((input_buffer), 0)).offset) >>> 0) + ((0) >>> 0)) < (((__struct_ptr_at((input_buffer), 0)).length) >>> 0) ? 1 : 0))) ? 1 : 0)) && (((((cptr_offset((__struct_ptr_at((input_buffer), 0)).content, (((__struct_ptr_at((input_buffer), 0)).offset) >>> 0))).buf[((cptr_offset((__struct_ptr_at((input_buffer), 0)).content, (((__struct_ptr_at((input_buffer), 0)).offset) >>> 0))).off ?? 0) + 0]) & 0xFF) == 91 ? 1 : 0))) ? 1 : 0)) {
    return parse_array(item, input_buffer);
  }
  if ((((((((input_buffer != (null) ? 1 : 0)) && ((((((__struct_ptr_at((input_buffer), 0)).offset) >>> 0) + ((0) >>> 0)) < (((__struct_ptr_at((input_buffer), 0)).length) >>> 0) ? 1 : 0))) ? 1 : 0)) && (((((cptr_offset((__struct_ptr_at((input_buffer), 0)).content, (((__struct_ptr_at((input_buffer), 0)).offset) >>> 0))).buf[((cptr_offset((__struct_ptr_at((input_buffer), 0)).content, (((__struct_ptr_at((input_buffer), 0)).offset) >>> 0))).off ?? 0) + 0]) & 0xFF) == 123 ? 1 : 0))) ? 1 : 0)) {
...
function print_value(item: cJSON | null, output_buffer: printbuffer | null): cJSON_bool {
  let output = null; /* &ref */
  if (((((item == (null) ? 1 : 0)) || ((output_buffer == (null) ? 1 : 0))) ? 1 : 0)) {
    return (Math.trunc(+(0)));
  }
  switch (((__struct_ptr_at(item, 0)).type) & 255) {
    ...
    case (((1 << 7) | 0)):
      {
        let raw_length = ((0) >>> 0);
        if ((cptr_eq((__struct_ptr_at(item, 0)).valuestring, (null)) ? 1 : 0)) {
          return (Math.trunc(+(0)));
        }
...
function parse_array(item: cJSON | null, input_buffer: parse_buffer | null): cJSON_bool {
  ...
  _sm: while (true) {
    ...
    case 0:
      ...
      if (((((__struct_ptr_at(input_buffer, 0)).depth) >>> 0) >= ((1000) >>> 0) ? 1 : 0)) {
        return (Math.trunc(+(0)));
      }
      ...
      if (((((cptr_offset((__struct_ptr_at((input_buffer), 0)).content, (((__struct_ptr_at((input_buffer), 0)).offset) >>> 0))).buf[((cptr_offset((__struct_ptr_at((input_buffer), 0)).content, (((__struct_ptr_at((input_buffer), 0)).offset) >>> 0))).off ?? 0) + 0]) & 0xFF) != 91 ? 1 : 0)) {
        _state = 2; continue _sm; /* goto fail */
      }
      (() => { const _t = (__struct_ptr_at(input_buffer, 0)).offset; (__struct_ptr_at(input_buffer, 0)).offset = u32((__struct_ptr_at(input_buffer, 0)).offset + 1); return _t; })();
      buffer_skip_whitespace(input_buffer);
      if ((((((((input_buffer != (null) ? 1 : 0)) && ((((((__struct_ptr_at((input_buffer), 0)).offset) >>> 0) + ((0) >>> 0)) < (((__struct_ptr_at((input_buffer), 0)).length) >>> 0) ? 1 : 0))) ? 1 : 0)) && (((((cptr_offset((__struct_ptr_at((input_buffer), 0)).content, (((__struct_ptr_at((input_buffer), 0)).offset) >>> 0))).buf[((cptr_offset((__struct_ptr_at((input_buffer), 0)).content, (((__struct_ptr_at((input_buffer), 0)).offset) >>> 0))).off ?? 0) + 0]) & 0xFF) == 93 ? 1 : 0))) ? 1 : 0)) {
        _state = 1; continue _sm; /* goto success */
      }
      if (((!(((((input_buffer != (null) ? 1 : 0)) && ((((((__struct_ptr_at((input_buffer), 0)).offset) >>> 0) + ((0) >>> 0)) < (((__struct_ptr_at((input_buffer), 0)).length) >>> 0) ? 1 : 0))) ? 1 : 0)) ? 1 : 0))) {
        (() => { const _t = (__struct_ptr_at(input_buffer, 0)).offset; (__struct_ptr_at(input_buffer, 0)).offset = u32((__struct_ptr_at(input_buffer, 0)).offset - 1); return _t; })();
        _state = 2; continue _sm; /* goto fail */
      }
      (() => { const _t = (__struct_ptr_at(input_buffer, 0)).offset; (__struct_ptr_at(input_buffer, 0)).offset = u32((__struct_ptr_at(input_buffer, 0)).offset - 1); return _t; })();
      do {
        ...
        (() => { const _t = (__struct_ptr_at(input_buffer, 0)).offset; (__struct_ptr_at(input_buffer, 0)).offset = u32((__struct_ptr_at(input_buffer, 0)).offset + 1); return _t; })();
        buffer_skip_whitespace(input_buffer);
        if ((!parse_value(current_item, input_buffer) ? 1 : 0)) {
          _state = 2; continue _sm; /* goto fail */
        }
        buffer_skip_whitespace(input_buffer);
      } while ((((((((input_buffer != (null) ? 1 : 0)) && ((((((__struct_ptr_at((input_buffer), 0)).offset) >>> 0) + ((0) >>> 0)) < (((__struct_ptr_at((input_buffer), 0)).length) >>> 0) ? 1 : 0))) ? 1 : 0)) && (((((cptr_offset((__struct_ptr_at((input_buffer), 0)).content, (((__struct_ptr_at((input_buffer), 0)).offset) >>> 0))).buf[((cptr_offset((__struct_ptr_at((input_buffer), 0)).content, (((__struct_ptr_at((input_buffer), 0)).offset) >>> 0))).off ?? 0) + 0]) & 0xFF) == 44 ? 1 : 0))) ? 1 : 0));
      if (((((!(((((input_buffer != (null) ? 1 : 0)) && ((((((__struct_ptr_at((input_buffer), 0)).offset) >>> 0) + ((0) >>> 0)) < (((__struct_ptr_at((input_buffer), 0)).length) >>> 0) ? 1 : 0))) ? 1 : 0)) ? 1 : 0)) || ((((cptr_offset((__struct_ptr_at((input_buffer), 0)).content, (((__struct_ptr_at((input_buffer), 0)).offset) >>> 0))).buf[((cptr_offset((__struct_ptr_at((input_buffer), 0)).content, (((__struct_ptr_at((input_buffer), 0)).offset) >>> 0))).off ?? 0) + 0]) & 0xFF) != 93 ? 1 : 0)) ? 1 : 0)) {
        _state = 2; continue _sm; /* goto fail */
      }
    case 1: /* success */
      (() => { const _t = (__struct_ptr_at(input_buffer, 0)).depth; (__struct_ptr_at(input_buffer, 0)).depth = u32((__struct_ptr_at(input_buffer, 0)).depth - 1); return _t; })();
...
function print_array(item: cJSON | null, output_buffer: printbuffer | null): cJSON_bool {
  ...
  if (((((__struct_ptr_at(output_buffer, 0)).depth) >>> 0) >= ((1000) >>> 0) ? 1 : 0)) {
    return (Math.trunc(+(0)));
  }
  ...
  while ((current_element != (null) ? 1 : 0)) {
    if ((!print_value(current_element, output_buffer) ? 1 : 0)) {
      return (Math.trunc(+(0)));
    }
...
function parse_object(item: cJSON | null, input_buffer: parse_buffer | null): cJSON_bool {
  ...
  _sm: while (true) {
    ...
    case 0:
      ...
      (() => { const _t = (__struct_ptr_at(input_buffer, 0)).depth; (__struct_ptr_at(input_buffer, 0)).depth = u32((__struct_ptr_at(input_buffer, 0)).depth + 1); return _t; })();
      if (((((!(((((input_buffer != (null) ? 1 : 0)) && ((((((__struct_ptr_at((input_buffer), 0)).offset) >>> 0) + ((0) >>> 0)) < (((__struct_ptr_at((input_buffer), 0)).length) >>> 0) ? 1 : 0))) ? 1 : 0)) ? 1 : 0)) || (((((cptr_offset((__struct_ptr_at((input_buffer), 0)).content, (((__struct_ptr_at((input_buffer), 0)).offset) >>> 0))).buf[((cptr_offset((__struct_ptr_at((input_buffer), 0)).content, (((__struct_ptr_at((input_buffer), 0)).offset) >>> 0))).off ?? 0) + 0]) & 0xFF) != 123 ? 1 : 0))) ? 1 : 0)) {
        _state = 2; continue _sm; /* goto fail */
      }
      (() => { const _t = (__struct_ptr_at(input_buffer, 0)).offset; (__struct_ptr_at(input_buffer, 0)).offset = u32((__struct_ptr_at(input_buffer, 0)).offset + 1); return _t; })();
      buffer_skip_whitespace(input_buffer);
      if ((((((((input_buffer != (null) ? 1 : 0)) && ((((((__struct_ptr_at((input_buffer), 0)).offset) >>> 0) + ((0) >>> 0)) < (((__struct_ptr_at((input_buffer), 0)).length) >>> 0) ? 1 : 0))) ? 1 : 0)) && (((((cptr_offset((__struct_ptr_at((input_buffer), 0)).content, (((__struct_ptr_at((input_buffer), 0)).offset) >>> 0))).buf[((cptr_offset((__struct_ptr_at((input_buffer), 0)).content, (((__struct_ptr_at((input_buffer), 0)).offset) >>> 0))).off ?? 0) + 0]) & 0xFF) == 125 ? 1 : 0))) ? 1 : 0)) {
        _state = 1; continue _sm; /* goto success */
      }
      if (((!(((((input_buffer != (null) ? 1 : 0)) && ((((((__struct_ptr_at((input_buffer), 0)).offset) >>> 0) + ((0) >>> 0)) < (((__struct_ptr_at((input_buffer), 0)).length) >>> 0) ? 1 : 0))) ? 1 : 0)) ? 1 : 0))) {
        (() => { const _t = (__struct_ptr_at(input_buffer, 0)).offset; (__struct_ptr_at(input_buffer, 0)).offset = u32((__struct_ptr_at(input_buffer, 0)).offset - 1); return _t; })();
      ...
      do {
        ...
        if (((!(((((input_buffer != (null) ? 1 : 0)) && ((((((__struct_ptr_at((input_buffer), 0)).offset) >>> 0) + ((1) >>> 0)) < (((__struct_ptr_at((input_buffer), 0)).length) >>> 0) ? 1 : 0))) ? 1 : 0)) ? 1 : 0))) {
          _state = 2; continue _sm; /* goto fail */
        }
        (() => { const _t = (__struct_ptr_at(input_buffer, 0)).offset; (__struct_ptr_at(input_buffer, 0)).offset = u32((__struct_ptr_at(input_buffer, 0)).offset + 1); return _t; })();
        buffer_skip_whitespace(input_buffer);
        if ((!parse_string(current_item, input_buffer) ? 1 : 0)) {
          _state = 2; continue _sm; /* goto fail */
        }
        buffer_skip_whitespace(input_buffer);
        ...
        if (((((!(((((input_buffer != (null) ? 1 : 0)) && ((((((__struct_ptr_at((input_buffer), 0)).offset) >>> 0) + ((0) >>> 0)) < (((__struct_ptr_at((input_buffer), 0)).length) >>> 0) ? 1 : 0))) ? 1 : 0)) ? 1 : 0)) || (((((cptr_offset((__struct_ptr_at((input_buffer), 0)).content, (((__struct_ptr_at((input_buffer), 0)).offset) >>> 0))).buf[((cptr_offset((__struct_ptr_at((input_buffer), 0)).content, (((__struct_ptr_at((input_buffer), 0)).offset) >>> 0))).off ?? 0) + 0]) & 0xFF) != 58 ? 1 : 0))) ? 1 : 0)) {
          _state = 2; continue _sm; /* goto fail */
        }
        (() => { const _t = (__struct_ptr_at(input_buffer, 0)).offset; (__struct_ptr_at(input_buffer, 0)).offset = u32((__struct_ptr_at(input_buffer, 0)).offset + 1); return _t; })();
        buffer_skip_whitespace(input_buffer);
      ...
      if (((((!(((((input_buffer != (null) ? 1 : 0)) && ((((((__struct_ptr_at((input_buffer), 0)).offset) >>> 0) + ((0) >>> 0)) < (((__struct_ptr_at((input_buffer), 0)).length) >>> 0) ? 1 : 0))) ? 1 : 0)) ? 1 : 0)) || (((((cptr_offset((__struct_ptr_at((input_buffer), 0)).content, (((__struct_ptr_at((input_buffer), 0)).offset) >>> 0))).buf[((cptr_offset((__struct_ptr_at((input_buffer), 0)).content, (((__struct_ptr_at((input_buffer), 0)).offset) >>> 0))).off ?? 0) + 0]) & 0xFF) != 125 ? 1 : 0))) ? 1 : 0)) {
        _state = 2; continue _sm; /* goto fail */
      }
    case 1: /* success */
      (() => { const _t = (__struct_ptr_at(input_buffer, 0)).depth; (__struct_ptr_at(input_buffer, 0)).depth = u32((__struct_ptr_at(input_buffer, 0)).depth - 1); return _t; })();
...
function print_object(item: cJSON | null, output_buffer: printbuffer | null): cJSON_bool {
  ...
  while (current_item) {
    ...
    if ((!print_string_ptr(cptr_clone(((__struct_ptr_at(current_item, 0)).string)), output_buffer) ? 1 : 0)) {
      return (Math.trunc(+(0)));
    }
    update_offset(output_buffer);
    length = ((Math.trunc(+((((__struct_ptr_at(output_buffer, 0)).format ? 2 : 1))))) >>> 0);
    ...
    (__struct_ptr_at(output_buffer, 0)).offset += ((length) >>> 0);
    if ((!print_value(current_item, output_buffer) ? 1 : 0)) {
      return (Math.trunc(+(0)));
    }
    update_offset(output_buffer);
  ...
  if ((__struct_ptr_at(output_buffer, 0)).format) {
    let i = 0;
    for (i = ((0) >>> 0); (((i) >>> 0) < ((((__struct_ptr_at(output_buffer, 0)).depth) >>> 0) - ((1) >>> 0)) ? 1 : 0); (() => { const _t = i; i = u32(i + 1); return _t; })()) {
      (output_pointer.buf[output_pointer.off++]) = (((9) & 0xFF)) & 0xFF;
    }
  }
...
function get_array_item(array: cJSON | null, index: number): cJSON | null {
  ...
  while (((((current_child != (null) ? 1 : 0)) && ((((index) >>> 0) > ((0) >>> 0) ? 1 : 0))) ? 1 : 0)) {
...
function get_object_item(object: cJSON | null, name: string, case_sensitive: cJSON_bool): cJSON | null {
  ...
  if (((((object == (null) ? 1 : 0)) || ((cptr_eq(name, (null)) ? 1 : 0))) ? 1 : 0)) {
    return null;
  }
  current_element = (__struct_ptr_at(object, 0)).child;
  if (case_sensitive) {
    while (((((((current_element != (null) ? 1 : 0)) && ((!cptr_eq((__struct_ptr_at(current_element, 0)).string, (null)) ? 1 : 0))) ? 1 : 0) && ((strcmp(cptr_clone(name), cptr_clone((__struct_ptr_at(current_element, 0)).string)) != 0 ? 1 : 0))) ? 1 : 0)) {
      current_element = (__struct_ptr_at(current_element, 0)).next;
    }
  } else {
    while (((((current_element != (null) ? 1 : 0)) && ((case_insensitive_strcmp(cptr_clone((name)), cptr_clone((((__struct_ptr_at(current_element, 0)).string)))) != 0 ? 1 : 0))) ? 1 : 0)) {
      current_element = (__struct_ptr_at(current_element, 0)).next;
    }
  }
  if (((((current_element == (null) ? 1 : 0)) || ((cptr_eq((__struct_ptr_at(current_element, 0)).string, (null)) ? 1 : 0))) ? 1 : 0)) {
    return null;
  }
  return current_element;
}

export function cJSON_GetObjectItem(object: cJSON | null, string: any): cJSON | null {
  return get_object_item(object, cptr_clone(string), (Math.trunc(+(0))));
}

export function cJSON_GetObjectItemCaseSensitive(object: cJSON | null, string: any): cJSON | null {
  return get_object_item(object, cptr_clone(string), (Math.trunc(+(1))));
}

export function cJSON_HasObjectItem(object: cJSON | null, string: any): cJSON_bool {
...
function add_item_to_array(array: cJSON | null, item: cJSON | null): cJSON_bool {
  let child = null; /* &ref */
  if (((((((item == (null) ? 1 : 0)) || ((array == (null) ? 1 : 0))) ? 1 : 0) || ((array == item ? 1 : 0))) ? 1 : 0)) {
    return (Math.trunc(+(0)));
  }
  child = (__struct_ptr_at(array, 0)).child;
  if ((child == (null) ? 1 : 0)) {
...
function add_item_to_object(object: cJSON | null, string: string, item: cJSON | null, hooks: internal_hooks | null, constant_key: cJSON_bool): cJSON_bool {
  ...
  let new_type = (0);
  if (((((((((object == (null) ? 1 : 0)) || ((cptr_eq(string, (null)) ? 1 : 0))) ? 1 : 0) || ((item == (null) ? 1 : 0))) ? 1 : 0) || ((object == item ? 1 : 0))) ? 1 : 0)) {
    return (Math.trunc(+(0)));
  }
  if (constant_key) {
...
export function cJSON_AddItemToObject(object: cJSON | null, string: any, item: cJSON | null): cJSON_bool {
  return add_item_to_object(object, cptr_clone(string), item, global_hooks, (Math.trunc(+(0))));
}

export function cJSON_AddItemToObjectCS(object: cJSON | null, string: any, item: cJSON | null): cJSON_bool {
...
export function cJSON_AddItemReferenceToObject(object: cJSON | null, string: any, item: cJSON | null): cJSON_bool {
  if (((((object == (null) ? 1 : 0)) || ((cptr_eq(string, (null)) ? 1 : 0))) ? 1 : 0)) {
    return (Math.trunc(+(0)));
  }
  return add_item_to_object(object, cptr_clone(string), create_reference(item, global_hooks), global_hooks, (Math.trunc(+(0))));
}

export function cJSON_AddNullToObject(object: cJSON | null, name: any): cJSON | null {
...
export function cJSON_AddTrueToObject(object: cJSON | null, name: any): cJSON | null {
...
export function cJSON_AddFalseToObject(object: cJSON | null, name: any): cJSON | null {
...
export function cJSON_AddBoolToObject(object: cJSON | null, name: any, _boolean: cJSON_bool): cJSON | null {
...
export function cJSON_AddNumberToObject(object: cJSON | null, name: any, number: number): cJSON | null {
...
export function cJSON_AddStringToObject(object: cJSON | null, name: any, string: any): cJSON | null {
...
export function cJSON_AddRawToObject(object: cJSON | null, name: any, raw: any): cJSON | null {
...
export function cJSON_AddObjectToObject(object: cJSON | null, name: any): cJSON | null {
...
export function cJSON_AddArrayToObject(object: cJSON | null, name: any): cJSON | null {
...
export function cJSON_DetachItemViaPointer(parent: cJSON | null, item: cJSON | null): cJSON | null {
  if (((((((parent == (null) ? 1 : 0)) || ((item == (null) ? 1 : 0))) ? 1 : 0) || ((((item != (__struct_ptr_at(parent, 0)).child ? 1 : 0) && ((__struct_ptr_at(item, 0)).prev == (null) ? 1 : 0)) ? 1 : 0))) ? 1 : 0)) {
    return null;
  }
  if ((item != (__struct_ptr_at(parent, 0)).child ? 1 : 0)) {
    (__struct_ptr_at((__struct_ptr_at(item, 0)).prev, 0)).next = (__struct_ptr_at(item, 0)).next;
  }
  if (((__struct_ptr_at(item, 0)).next != (null) ? 1 : 0)) {
...
export function cJSON_DetachItemFromObject(object: cJSON | null, string: any): cJSON | null {
  let to_detach = cJSON_GetObjectItem(object, cptr_clone(string)); /* &ref */
  return cJSON_DetachItemViaPointer(object, to_detach);
}

export function cJSON_DetachItemFromObjectCaseSensitive(object: cJSON | null, string: any): cJSON | null {
  let to_detach = cJSON_GetObjectItemCaseSensitive(object, cptr_clone(string)); /* &ref */
  return cJSON_DetachItemViaPointer(object, to_detach);
}

export function cJSON_DeleteItemFromObject(object: cJSON | null, string: any): void {
  cJSON_Delete(cJSON_DetachItemFromObject(object, cptr_clone(string)));
}

export function cJSON_DeleteItemFromObjectCaseSensitive(object: cJSON | null, string: any): void {
...
export function cJSON_InsertItemInArray(array: cJSON | null, which: number, newitem: cJSON | null): cJSON_bool {
  ...
  if ((((which < 0 ? 1 : 0) || (newitem == (null) ? 1 : 0)) ? 1 : 0)) {
    return (Math.trunc(+(0)));
  }
  after_inserted = get_array_item(array, ((Math.trunc(+(which))) >>> 0));
  if ((after_inserted == (null) ? 1 : 0)) {
    return add_item_to_array(array, newitem);
  }
  if ((((after_inserted != (__struct_ptr_at(array, 0)).child ? 1 : 0) && ((__struct_ptr_at(after_inserted, 0)).prev == (null) ? 1 : 0)) ? 1 : 0)) {
    return (Math.trunc(+(0)));
  }
  ...
  if ((after_inserted == (__struct_ptr_at(array, 0)).child ? 1 : 0)) {
...
export function cJSON_ReplaceItemViaPointer(parent: cJSON | null, item: cJSON | null, replacement: cJSON | null): cJSON_bool {
  if (((((((((parent == (null) ? 1 : 0)) || (((__struct_ptr_at(parent, 0)).child == (null) ? 1 : 0))) ? 1 : 0) || ((replacement == (null) ? 1 : 0))) ? 1 : 0) || ((item == (null) ? 1 : 0))) ? 1 : 0)) {
    return (Math.trunc(+(0)));
  }
  if ((replacement == item ? 1 : 0)) {
    return (Math.trunc(+(1)));
  }
  ...
  if (((__struct_ptr_at(replacement, 0)).next != (null) ? 1 : 0)) {
    (__struct_ptr_at((__struct_ptr_at(replacement, 0)).next, 0)).prev = replacement;
  }
  if (((__struct_ptr_at(parent, 0)).child == item ? 1 : 0)) {
    if (((__struct_ptr_at((__struct_ptr_at(parent, 0)).child, 0)).prev == (__struct_ptr_at(parent, 0)).child ? 1 : 0)) {
      (__struct_ptr_at(replacement, 0)).prev = replacement;
    }
    (__struct_ptr_at(parent, 0)).child = replacement;
  } else {
    if (((__struct_ptr_at(replacement, 0)).prev != (null) ? 1 : 0)) {
...
function replace_item_in_object(object: cJSON | null, string: string, replacement: cJSON | null, case_sensitive: cJSON_bool): cJSON_bool {
  if (((((replacement == (null) ? 1 : 0)) || ((cptr_eq(string, (null)) ? 1 : 0))) ? 1 : 0)) {
    return (Math.trunc(+(0)));
  }
  if ((((!((__struct_ptr_at(replacement, 0)).type & 512) ? 1 : 0) && ((!cptr_eq((__struct_ptr_at(replacement, 0)).string, (null)) ? 1 : 0))) ? 1 : 0)) {
  ...
  if ((cptr_eq((__struct_ptr_at(replacement, 0)).string, (null)) ? 1 : 0)) {
    return (Math.trunc(+(0)));
  }
...
export function cJSON_ReplaceItemInObject(object: cJSON | null, string: any, newitem: cJSON | null): cJSON_bool {
  return replace_item_in_object(object, cptr_clone(string), newitem, (Math.trunc(+(0))));
}

export function cJSON_ReplaceItemInObjectCaseSensitive(object: cJSON | null, string: any, newitem: cJSON | null): cJSON_bool {
...
export function cJSON_CreateNumber(num: number): cJSON | null {
  ...
  if (item) {
    ...
    if ((num >= 2147483647 ? 1 : 0)) {
      (__struct_ptr_at(item, 0)).valueint = 2147483647;
    } else {
      if ((num <= ((i32(-2147483647 - 1))) ? 1 : 0)) {
        (__struct_ptr_at(item, 0)).valueint = (i32(-2147483647 - 1));
      } else {
...
export function cJSON_CreateString(string: string): cJSON | null {
  ...
  if (item) {
    ...
    if ((!(__struct_ptr_at(item, 0)).valuestring ? 1 : 0)) {
      cJSON_Delete(item);
      return null;
    }
  }
...
export function cJSON_CreateIntArray(numbers: number | null, count: number): cJSON | null {
  ...
  let p = null; /* &ref */
  let a = null; /* &ref */
  if (((((count < 0 ? 1 : 0)) || ((cptr_eq(numbers, (null)) ? 1 : 0))) ? 1 : 0)) {
    return null;
  }
  a = cJSON_CreateArray();
  for (i = ((0) >>> 0); ((a && ((((i) >>> 0) < ((Math.trunc(+(count))) >>> 0) ? 1 : 0))) ? 1 : 0); (() => { const _t = i; i = u32(i + 1); return _t; })()) {
...
// BRIDGE: c-out-pointer — C17 §6.5.3.2 + §6.7.6.1: T*/T** out parameters lowered as COutParam<T> = { value: T }. Affected params: strings.
// BRIDGE-HINT: to refactor into idiomatic TypeScript, return [<original-return>, ...out_types] and drop the COutParam parameters; callers replace box.value reads with destructuring.
export function cJSON_CreateStringArray(strings: COutParam<CPtr>, count: number): cJSON | null {
  let i = ((0) >>> 0);
  let n = null; /* &ref */
  let p = null; /* &ref */
  let a = null; /* &ref */
  if (((((count < 0 ? 1 : 0)) || ((cptr_eq(strings, (null)) ? 1 : 0))) ? 1 : 0)) {
    return null;
  }
  a = cJSON_CreateArray();
  for (i = ((0) >>> 0); ((a && ((((i) >>> 0) < ((Math.trunc(+(count))) >>> 0) ? 1 : 0))) ? 1 : 0); (() => { const _t = i; i = u32(i + 1); return _t; })()) {
  ...
  _sm: while (true) {
    ...
    case 0:
      ...
      if ((__struct_ptr_at(item, 0)).valuestring) {
        ...
        if ((!(__struct_ptr_at(newitem, 0)).valuestring ? 1 : 0)) {
          _state = 1; continue _sm; /* goto fail */
        }
      }
      if ((__struct_ptr_at(item, 0)).string) {
        ...
        if ((!(__struct_ptr_at(newitem, 0)).string ? 1 : 0)) {
          _state = 1; continue _sm; /* goto fail */
        }
      }
      if ((!recurse ? 1 : 0)) {
...
// BRIDGE: c-out-pointer — C17 §6.5.3.2 + §6.7.6.1: T*/T** out parameters lowered as COutParam<T> = { value: T }. Affected params: input.
// BRIDGE-HINT: to refactor into idiomatic TypeScript, return [<original-return>, ...out_types] and drop the COutParam parameters; callers replace box.value reads with destructuring.
function skip_oneline_comment(input: COutParam<CPtr>): void {
  input.value = cptr_offset(input.value, (3 - 1));
  for (; ((((input.value).buf[((input.value).off ?? 0) + 0]) << 24 >> 24) != 0 ? 1 : 0); ++(input.value).off) {
    if (((((input.value).buf[((input.value).off ?? 0) + 0]) << 24 >> 24) == 10 ? 1 : 0)) {
...
// BRIDGE: c-out-pointer — C17 §6.5.3.2 + §6.7.6.1: T*/T** out parameters lowered as COutParam<T> = { value: T }. Affected params: input.
// BRIDGE-HINT: to refactor into idiomatic TypeScript, return [<original-return>, ...out_types] and drop the COutParam parameters; callers replace box.value reads with destructuring.
function skip_multiline_comment(input: COutParam<CPtr>): void {
  input.value = cptr_offset(input.value, (3 - 1));
  for (; ((((input.value).buf[((input.value).off ?? 0) + 0]) << 24 >> 24) != 0 ? 1 : 0); ++(input.value).off) {
    if ((((((((input.value).buf[((input.value).off ?? 0) + 0]) << 24 >> 24) == 42 ? 1 : 0)) && (((((input.value).buf[((input.value).off ?? 0) + 1]) << 24 >> 24) == 47 ? 1 : 0))) ? 1 : 0)) {
      input.value = cptr_offset(input.value, (3 - 1));
      return;
    }
  }
...
// BRIDGE: c-out-pointer — C17 §6.5.3.2 + §6.7.6.1: T*/T** out parameters lowered as COutParam<T> = { value: T }. Affected params: input, output.
// BRIDGE-HINT: to refactor into idiomatic TypeScript, return [<original-return>, ...out_types] and drop the COutParam parameters; callers replace box.value reads with destructuring.
function minify_string(input: COutParam<CPtr>, output: COutParam<CPtr>): void {
  ...
  for (; ((((input.value).buf[((input.value).off ?? 0) + 0]) << 24 >> 24) != 0 ? 1 : 0); (++(input.value).off), ++(output.value).off) {
    (output.value).buf[((output.value).off ?? 0) + 0] = ((((input.value).buf[((input.value).off ?? 0) + 0]) << 24 >> 24)) << 24 >> 24;
    if (((((input.value).buf[((input.value).off ?? 0) + 0]) << 24 >> 24) == 34 ? 1 : 0)) {
      (output.value).buf[((output.value).off ?? 0) + 0] = (((34) << 24 >> 24)) << 24 >> 24;
      input.value = cptr_offset(input.value, (2 - 1));
      output.value = cptr_offset(output.value, (2 - 1));
      return;
    } else {
      if ((((((((input.value).buf[((input.value).off ?? 0) + 0]) << 24 >> 24) == 92 ? 1 : 0)) && (((((input.value).buf[((input.value).off ?? 0) + 1]) << 24 >> 24) == 34 ? 1 : 0))) ? 1 : 0)) {
...
export function cJSON_Minify(json: any): void {
  ...
  let into = cptr_clone(cptr_clone(json)); /* &ref */
  if ((cptr_eq(json, (null)) ? 1 : 0)) {
    return;
  }
  while ((((json.buf[(json.off ?? 0) + 0]) << 24 >> 24) != 0 ? 1 : 0)) {
    switch (((json.buf[(json.off ?? 0) + 0]) << 24 >> 24)) {
      ...
      case 47:
        {
          if ((((json.buf[(json.off ?? 0) + 1]) << 24 >> 24) == 47 ? 1 : 0)) {
            let _ref0 = { value: json };
            skip_oneline_comment(_ref0);
            json = _ref0.value;
          } else {
            if ((((json.buf[(json.off ?? 0) + 1]) << 24 >> 24) == 42 ? 1 : 0)) {
...
export function cJSON_IsInvalid(item: cJSON | null): cJSON_bool {
  ...
  return ((((__struct_ptr_at(item, 0)).type & 255) == (0) ? 1 : 0) ? 1 : 0);
}
...
export function cJSON_IsFalse(item: cJSON | null): cJSON_bool {
  ...
  return ((((__struct_ptr_at(item, 0)).type & 255) == (((1 << 0) | 0)) ? 1 : 0) ? 1 : 0);
}
...
export function cJSON_IsTrue(item: cJSON | null): cJSON_bool {
  ...
  return ((((__struct_ptr_at(item, 0)).type & 255) == (((1 << 1) | 0)) ? 1 : 0) ? 1 : 0);
}
...
export function cJSON_IsBool(item: cJSON | null): cJSON_bool {
  ...
  return ((((__struct_ptr_at(item, 0)).type & ((((1 << 1) | 0)) | (((1 << 0) | 0)))) != 0 ? 1 : 0) ? 1 : 0);
}
...
export function cJSON_IsNull(item: cJSON | null): cJSON_bool {
  ...
  return ((((__struct_ptr_at(item, 0)).type & 255) == (((1 << 2) | 0)) ? 1 : 0) ? 1 : 0);
}
...
export function cJSON_IsNumber(item: cJSON | null): cJSON_bool {
  ...
  return ((((__struct_ptr_at(item, 0)).type & 255) == (((1 << 3) | 0)) ? 1 : 0) ? 1 : 0);
}
...
export function cJSON_IsString(item: cJSON | null): cJSON_bool {
  ...
  return ((((__struct_ptr_at(item, 0)).type & 255) == (((1 << 4) | 0)) ? 1 : 0) ? 1 : 0);
}
...
export function cJSON_IsArray(item: cJSON | null): cJSON_bool {
  ...
  return ((((__struct_ptr_at(item, 0)).type & 255) == (((1 << 5) | 0)) ? 1 : 0) ? 1 : 0);
}
...
export function cJSON_IsObject(item: cJSON | null): cJSON_bool {
  ...
  return ((((__struct_ptr_at(item, 0)).type & 255) == (((1 << 6) | 0)) ? 1 : 0) ? 1 : 0);
}
...
export function cJSON_IsRaw(item: cJSON | null): cJSON_bool {
  ...
  return ((((__struct_ptr_at(item, 0)).type & 255) == (((1 << 7) | 0)) ? 1 : 0) ? 1 : 0);
}
...
export function cJSON_Compare(a: cJSON | null, b: cJSON | null, case_sensitive: cJSON_bool): cJSON_bool {
  ...
  switch ((__struct_ptr_at(a, 0)).type & 255) {
    ...
    case (((1 << 4) | 0)):
      case (((1 << 7) | 0)):
        {
          if (((((cptr_eq((__struct_ptr_at(a, 0)).valuestring, (null)) ? 1 : 0)) || ((cptr_eq((__struct_ptr_at(b, 0)).valuestring, (null)) ? 1 : 0))) ? 1 : 0)) {
            return (Math.trunc(+(0)));
          }
        }
    ...
    case (((1 << 5) | 0)):
      {
        ...
        for (; ((((a_element != (null) ? 1 : 0)) && ((b_element != (null) ? 1 : 0))) ? 1 : 0); ) {
          if ((!cJSON_Compare(a_element, b_element, case_sensitive) ? 1 : 0)) {
            return (Math.trunc(+(0)));
          }
          a_element = (__struct_ptr_at(a_element, 0)).next;
          b_element = (__struct_ptr_at(b_element, 0)).next;
        }
        if ((a_element != b_element ? 1 : 0)) {
          return (Math.trunc(+(0)));
        }
        return (Math.trunc(+(1)));
      }
    case (((1 << 6) | 0)):
      {
        ...
        for (a_element = (((a != (null) ? 1 : 0)) ? (__struct_ptr_at((a), 0)).child : null); (a_element != (null) ? 1 : 0); a_element = (__struct_ptr_at(a_element, 0)).next) {
          b_element = get_object_item(b, cptr_clone((__struct_ptr_at(a_element, 0)).string), case_sensitive);
          if ((b_element == (null) ? 1 : 0)) {
            return (Math.trunc(+(0)));
          }
          if ((!cJSON_Compare(a_element, b_element, case_sensitive) ? 1 : 0)) {
            return (Math.trunc(+(0)));
        ...
        for (b_element = (((b != (null) ? 1 : 0)) ? (__struct_ptr_at((b), 0)).child : null); (b_element != (null) ? 1 : 0); b_element = (__struct_ptr_at(b_element, 0)).next) {
          a_element = get_object_item(a, cptr_clone((__struct_ptr_at(b_element, 0)).string), case_sensitive);
          if ((a_element == (null) ? 1 : 0)) {
            return (Math.trunc(+(0)));
          }
          if ((!cJSON_Compare(b_element, a_element, case_sensitive) ? 1 : 0)) {
            return (Math.trunc(+(0)));
          }
        }
        return (Math.trunc(+(1)));
