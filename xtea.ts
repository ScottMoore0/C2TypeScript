let inbuf: any = null; // BRIDGE: dropped-file-scope-static — see Rule 41j (lvalue without decl)
let outbuf: any = null; // BRIDGE: dropped-file-scope-static — see Rule 41j (lvalue without decl)
...
const xtea_t = xtea_s;
type xtea_t = xtea_s;
(xtea_s as any).__fieldTypes = ["bytes"];
(xtea_s as any).__fieldNames = ["key"];
(xtea_s as any).__fieldOffsets = [0];

export function xtea_setkey(xtea: xtea_t | null, key: any | null): void {
  ...
  for (i = 0; (i < 4 ? 1 : 0); ++i) {
    n = Math.imul(i, 4);
    (__struct_ptr_at(xtea, 0)).key[i] = (((((((key.buf[(key.off ?? 0) + i32(n + 0)]) & 0xFF) << 24) | 0)) | (((((key.buf[(key.off ?? 0) + i32(n + 1)]) & 0xFF) << 16) | 0)) | (((((key.buf[(key.off ?? 0) + i32(n + 2)]) & 0xFF) << 8) | 0)) | ((key.buf[(key.off ?? 0) + i32(n + 3)]) & 0xFF)) >>> 0);
  }
}

export function xtea_encodeecb(xtea: xtea_t | null, outbuf: any | null, inbuf: any | null): void {
  if (typeof outbuf === 'string') outbuf = cptr_from_string(outbuf);
  if (typeof inbuf === 'string') inbuf = cptr_from_string(inbuf);
  ...
  let o3 = 0;
  let o4 = 0;
  k = cptr_from_uint32_array((__struct_ptr_at(xtea, 0)).key);
  v0 = (((((((inbuf.buf[(inbuf.off ?? 0) + 0]) & 0xFF) << 24) | 0)) | (((((inbuf.buf[(inbuf.off ?? 0) + 1]) & 0xFF) << 16) | 0)) | (((((inbuf.buf[(inbuf.off ?? 0) + 2]) & 0xFF) << 8) | 0)) | ((inbuf.buf[(inbuf.off ?? 0) + 3]) & 0xFF)) >>> 0);
  v1 = (((((((inbuf.buf[(inbuf.off ?? 0) + 4]) & 0xFF) << 24) | 0)) | (((((inbuf.buf[(inbuf.off ?? 0) + 5]) & 0xFF) << 16) | 0)) | (((((inbuf.buf[(inbuf.off ?? 0) + 6]) & 0xFF) << 8) | 0)) | ((inbuf.buf[(inbuf.off ?? 0) + 7]) & 0xFF)) >>> 0);
  for (i = ((0) >>> 0); (((i) >>> 0) < ((32) >>> 0) ? 1 : 0); (i = u32(i + 1))) {
    v0 = u32(v0 + ((u32(((((((v1) >>> 0) << 4) >>> 0) ^ ((((v1) >>> 0) >>> 5) >>> 0)) >>> 0) + ((v1) >>> 0))) ^ (u32(((sum) >>> 0) + ((cptr_read_uint32(k, (((sum) >>> 0) & ((3) >>> 0)) >>> 0)) >>> 0)))) >>> 0);
    sum = u32(sum + ((delta) >>> 0));
    v1 = u32(v1 + ((u32(((((((v0) >>> 0) << 4) >>> 0) ^ ((((v0) >>> 0) >>> 5) >>> 0)) >>> 0) + ((v0) >>> 0))) ^ (u32(((sum) >>> 0) + ((cptr_read_uint32(k, (((((sum) >>> 0) >>> 11) >>> 0) & ((3) >>> 0)) >>> 0)) >>> 0)))) >>> 0);
  }
  o1 = (((Math.trunc(+(((((v0) >>> 0) >>> 16) >>> 0)))) & 0xFFFF)) & 0xFFFF;
  o2 = (((Math.trunc(+(((((v0) >>> 0) & ((65535) >>> 0)) >>> 0)))) & 0xFFFF)) & 0xFFFF;
  o3 = (((Math.trunc(+(((((v1) >>> 0) >>> 16) >>> 0)))) & 0xFFFF)) & 0xFFFF;
  o4 = (((Math.trunc(+(((((v1) >>> 0) & ((65535) >>> 0)) >>> 0)))) & 0xFFFF)) & 0xFFFF;
  outbuf.buf[(outbuf.off ?? 0) + 0] = (((Math.trunc(+((((((o1) & 0xFFFF) >> 8) | 0))))) & 0xFF)) & 0xFF;
  outbuf.buf[(outbuf.off ?? 0) + 1] = (((Math.trunc(+((((o1) & 0xFFFF) & 255)))) & 0xFF)) & 0xFF;
  outbuf.buf[(outbuf.off ?? 0) + 2] = (((Math.trunc(+((((((o2) & 0xFFFF) >> 8) | 0))))) & 0xFF)) & 0xFF;
  outbuf.buf[(outbuf.off ?? 0) + 3] = (((Math.trunc(+((((o2) & 0xFFFF) & 255)))) & 0xFF)) & 0xFF;
  outbuf.buf[(outbuf.off ?? 0) + 4] = (((Math.trunc(+((((((o3) & 0xFFFF) >> 8) | 0))))) & 0xFF)) & 0xFF;
  outbuf.buf[(outbuf.off ?? 0) + 5] = (((Math.trunc(+((((o3) & 0xFFFF) & 255)))) & 0xFF)) & 0xFF;
  outbuf.buf[(outbuf.off ?? 0) + 6] = (((Math.trunc(+((((((o4) & 0xFFFF) >> 8) | 0))))) & 0xFF)) & 0xFF;
  outbuf.buf[(outbuf.off ?? 0) + 7] = (((Math.trunc(+((((o4) & 0xFFFF) & 255)))) & 0xFF)) & 0xFF;
}

export function xtea_decodeecb(xtea: xtea_t | null, outbuf: any | null, inbuf: any | null): void {
  if (typeof outbuf === 'string') outbuf = cptr_from_string(outbuf);
  if (typeof inbuf === 'string') inbuf = cptr_from_string(inbuf);

  let delta = 2654435769;
  let sum = (Math.imul(((delta) >>> 0), ((32) >>> 0)) >>> 0);
  let k = null;
  let v0 = 0;
  let v1 = 0;
  let i = 0;
  ...
  v0 = (((((((inbuf.buf[(inbuf.off ?? 0) + 0]) & 0xFF) << 24) | 0)) | (((((inbuf.buf[(inbuf.off ?? 0) + 1]) & 0xFF) << 16) | 0)) | (((((inbuf.buf[(inbuf.off ?? 0) + 2]) & 0xFF) << 8) | 0)) | ((inbuf.buf[(inbuf.off ?? 0) + 3]) & 0xFF)) >>> 0);
  v1 = (((((((inbuf.buf[(inbuf.off ?? 0) + 4]) & 0xFF) << 24) | 0)) | (((((inbuf.buf[(inbuf.off ?? 0) + 5]) & 0xFF) << 16) | 0)) | (((((inbuf.buf[(inbuf.off ?? 0) + 6]) & 0xFF) << 8) | 0)) | ((inbuf.buf[(inbuf.off ?? 0) + 7]) & 0xFF)) >>> 0);
  for (i = ((0) >>> 0); (((i) >>> 0) < ((32) >>> 0) ? 1 : 0); (() => { const _t = i; i = u32(i + 1); return _t; })()) {
    v1 = u32(v1 - ((u32(((((((v0) >>> 0) << 4) >>> 0) ^ ((((v0) >>> 0) >>> 5) >>> 0)) >>> 0) + ((v0) >>> 0))) ^ (u32(((sum) >>> 0) + ((cptr_read_uint32(k, (((((sum) >>> 0) >>> 11) >>> 0) & ((3) >>> 0)) >>> 0)) >>> 0)))) >>> 0);
    sum = u32(sum - ((delta) >>> 0));
    v0 = u32(v0 - ((u32(((((((v1) >>> 0) << 4) >>> 0) ^ ((((v1) >>> 0) >>> 5) >>> 0)) >>> 0) + ((v1) >>> 0))) ^ (u32(((sum) >>> 0) + ((cptr_read_uint32(k, (((sum) >>> 0) & ((3) >>> 0)) >>> 0)) >>> 0)))) >>> 0);
  }
...
export function xtea_encodecbc(xtea: xtea_t | null, outbuf: any | null, inbuf: any | null, len: number, iv: any | null): number {
  if (typeof outbuf === 'string') outbuf = cptr_from_string(outbuf);
  if (typeof inbuf === 'string') inbuf = cptr_from_string(inbuf);
  ...
  while ((len > 0 ? 1 : 0)) {
    for (i = 0; (i < 8 ? 1 : 0); i++) {
      outbuf.buf[(outbuf.off ?? 0) + i] = (((Math.trunc(+((((inbuf.buf[(inbuf.off ?? 0) + i]) & 0xFF) ^ ((iv.buf[(iv.off ?? 0) + i]) & 0xFF))))) & 0xFF)) & 0xFF;
    }
    xtea_encodeecb(xtea, cptr_clone(outbuf), cptr_clone(outbuf));
    memcpy(iv, outbuf, 8);
    inbuf = cptr_offset(inbuf, 8);
    outbuf = cptr_offset(outbuf, 8);
    len = i32(len - 8);
  }
  return 0;
}

export function xtea_decodecbc(xtea: xtea_t | null, outbuf: any | null, inbuf: any | null, len: number, iv: any | null): number {
  if (typeof outbuf === 'string') outbuf = cptr_from_string(outbuf);
  if (typeof iv === 'string') iv = cptr_from_string(iv);

  let i = 0;
  let temp = cptr_create(8);
  if (len & 7) {
    return -1;
  }
  while ((len > 0 ? 1 : 0)) {
    memcpy(temp, inbuf, 8);
    xtea_decodeecb(xtea, cptr_clone(outbuf), cptr_clone(inbuf));
    for (i = 0; (i < 8 ? 1 : 0); i++) {
      outbuf.buf[(outbuf.off ?? 0) + i] = (((Math.trunc(+((((outbuf.buf[(outbuf.off ?? 0) + i]) & 0xFF) ^ ((iv.buf[(iv.off ?? 0) + i]) & 0xFF))))) & 0xFF)) & 0xFF;
    }
    memcpy(iv, temp, 8);
    inbuf = cptr_offset(inbuf, 8);
    outbuf = cptr_offset(outbuf, 8);
...
export function xtea_enclen(len: number): number {
  let blocks = __safe_div(len, 8);
  return i32((Math.imul(blocks, 8)) + 8);
}

export function xtea_declen(len: number): number {
  return len;
}

export function xtea_encode(xtea: xtea_t | null, outbuf: any | null, inbuf: any | null, inlen: number, iv: any | null): number {
  let blocks = __safe_div(inlen, 8);
  let block_bytes = Math.imul(blocks, 8);
  let buffer = (() => { const __b = cptr_create(8); __b.buf[0] = (((0) & 0xFF)) & 0xFF; return __b; })();
  let padlen = 0;
  if ((block_bytes > 0 ? 1 : 0)) {
    if ((0 != xtea_encodecbc(xtea, cptr_clone((outbuf)), cptr_clone((inbuf)), block_bytes, cptr_clone(iv)) ? 1 : 0)) {
      return -1;
    }
  }
  padlen = i32(8 - (i32(inlen - block_bytes)));
  memcpy(buffer, cptr_offset((inbuf), block_bytes), i32(8 - padlen));
  memset(cptr_offset(buffer, (i32(8 - padlen))), padlen, padlen);
  if ((0 != xtea_encodecbc(xtea, cptr_offset((outbuf), block_bytes), cptr_clone(buffer), 8, cptr_clone(iv)) ? 1 : 0)) {
    return -1;
  }
  return i32(block_bytes + 8);
}

export function xtea_decode(xtea: xtea_t | null, outbuf: any | null, inbuf: any | null, inlen: number, iv: any | null): number {
  let blocks = __safe_div(inlen, 8);
  let block_bytes = Math.imul((i32(blocks - 1)), 8);
  let buffer = (() => { const __b = cptr_create(8); __b.buf[0] = (((0) & 0xFF)) & 0xFF; return __b; })();
  let padlen = 0;
  if ((block_bytes > 0 ? 1 : 0)) {
    if ((0 != xtea_decodecbc(xtea, cptr_clone((outbuf)), cptr_clone((inbuf)), block_bytes, cptr_clone(iv)) ? 1 : 0)) {
      return -1;
    }
  }
  if ((0 != xtea_decodecbc(xtea, cptr_clone(buffer), cptr_offset((inbuf), block_bytes), 8, cptr_clone(iv)) ? 1 : 0)) {
    return -1;
  }
  padlen = ((buffer.buf[(buffer.off ?? 0) + i32(8 - 1)]) & 0xFF);
  if ((padlen <= 8 ? 1 : 0)) {
    memcpy(cptr_offset((outbuf), block_bytes), buffer, i32(8 - padlen));
  }
  return i32(block_bytes + (i32(8 - padlen)));
}
