...
let e58map = (() => { const __b = cptr_create(59); const __s = "123456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz"; for (let __i = 0; __i < __s.length; __i++) __b.buf[__i] = __s.charCodeAt(__i); return __b; })();
// BRIDGE: c-out-pointer — C17 §6.5.3.2 + §6.7.6.1: T*/T** out parameters lowered as COutParam<T> = { value: T }. Affected params: b58, b58len.
...
export function e58(bin: any | null, binlen: number, b58: COutParam<CPtr>, b58len: COutParam<number>): void {
  if (typeof bin === 'string') bin = cptr_from_string(bin);
  ...
  let j = 0;
  let p = null;
  for (i = ((0) >>> 0); (((i) >>> 0) < ((binlen) >>> 0) ? 1 : 0); (() => { const _t = i; i = u32(i + 1); return _t; })()) {
    if ((((bin.buf[(bin.off ?? 0) + ((i) >>> 0)]) & 0xFF) != 0 ? 1 : 0)) {
      break;
    }
  }
  z = ((i) >>> 0);
  p = cptr_clone(b58.value);
  s = ((b58len.value) >>> 0);
  h = ((s) >>> 0) - ((1) >>> 0);
  l = ((h) >>> 0);
  for (; (((i) >>> 0) < ((binlen) >>> 0) ? 1 : 0); (() => { const _t = i; i = u32(i + 1); return _t; })()) {
    let c = ((((bin.buf[(bin.off ?? 0) + ((i) >>> 0)]) & 0xFF)) >>> 0);
    for (j = ((h) >>> 0); ; (() => { const _t = j; j = u32(j - 1); return _t; })()) {
      if ((((j) >>> 0) == ((l) >>> 0) ? 1 : 0)) {
        if (((c) >>> 0)) {
          (() => { const _t = l; l = u32(l - 1); return _t; })();
        } else {
          break;
        }
      } else {
        c = u32(c + (Math.imul(((Math.trunc(+(((p.buf[(p.off ?? 0) + ((j) >>> 0)]) << 24 >> 24)))) >>> 0), ((256) >>> 0)) >>> 0));
      }
      p.buf[(p.off ?? 0) + ((j) >>> 0)] = (((u32(((c) >>> 0) % ((58) >>> 0))) << 24 >> 24)) << 24 >> 24;
      c = __safe_div(c, ((58) >>> 0));
    }
  }
  for (i = ((0) >>> 0); (((i) >>> 0) < ((z) >>> 0) ? 1 : 0); (() => { const _t = i; i = u32(i + 1); return _t; })()) {
    p.buf[(p.off ?? 0) + (((l) >>> 0) + ((1) >>> 0) - ((z) >>> 0)) + ((i) >>> 0)] = (((49) << 24 >> 24)) << 24 >> 24;
  }
  for (i = ((l) >>> 0) + ((1) >>> 0); (((i) >>> 0) <= ((h) >>> 0) ? 1 : 0); (() => { const _t = i; i = u32(i + 1); return _t; })()) {
    p.buf[(p.off ?? 0) + ((i) >>> 0)] = (((e58map.buf[(e58map.off ?? 0) + ((((p)).buf[(((p)).off ?? 0) + ((i) >>> 0)]) & 0xFF)]) << 24 >> 24)) << 24 >> 24;
  }
  b58.value = cptr_offset(p, (((l) >>> 0) + ((1) >>> 0) - ((z) >>> 0)));
  b58len.value = ((s) >>> 0) - (((l) >>> 0) + ((1) >>> 0) - ((z) >>> 0));
}

let d58map = (() => { const __b = cptr_create(128); __b.buf[0] = (((255) & 0xFF)) & 0xFF; __b.buf[1] = (((255) & 0xFF)) & 0xFF; __b.buf[2] = (((255) & 0xFF)) & 0xFF; __b.buf[3] = (((255) & 0xFF)) & 0xFF; __b.buf[4] = (((255) & 0xFF)) & 0xFF; __b.buf[5] = (((255) & 0xFF)) & 0xFF; __b.buf[6] = (((255) & 0xFF)) & 0xFF; __b.buf[7] = (((255) & 0xFF)) & 0xFF; __b.buf[8] = (((255) & 0xFF)) & 0xFF; __b.buf[9] = (((255) & 0xFF)) & 0xFF; __b.buf[10] = (((255) & 0xFF)) & 0xFF; __b.buf[11] = (((255) & 0xFF)) & 0xFF; __b.buf[12] = (((255) & 0xFF)) & 0xFF; __b.buf[13] = (((255) & 0xFF)) & 0xFF; __b.buf[14] = (((255) & 0xFF)) & 0xFF; __b.buf[15] = (((255) & 0xFF)) & 0xFF; __b.buf[16] = (((255) & 0xFF)) & 0xFF; __b.buf[17] = (((255) & 0xFF)) & 0xFF; __b.buf[18] = (((255) & 0xFF)) & 0xFF; __b.buf[19] = (((255) & 0xFF)) & 0xFF; __b.buf[20] = (((255) & 0xFF)) & 0xFF; __b.buf[21] = (((255) & 0xFF)) & 0xFF; __b.buf[22] = (((255) & 0xFF)) & 0xFF; __b.buf[23] = (((255) & 0xFF)) & 0xFF; __b.buf[24] = (((255) & 0xFF)) & 0xFF; __b.buf[25] = (((255) & 0xFF)) & 0xFF; __b.buf[26] = (((255) & 0xFF)) & 0xFF; __b.buf[27] = (((255) & 0xFF)) & 0xFF; __b.buf[28] = (((255) & 0xFF)) & 0xFF; __b.buf[29] = (((255) & 0xFF)) & 0xFF; __b.buf[30] = (((255) & 0xFF)) & 0xFF; __b.buf[31] = (((255) & 0xFF)) & 0xFF; __b.buf[32] = (((255) & 0xFF)) & 0xFF; __b.buf[33] = (((255) & 0xFF)) & 0xFF; __b.buf[34] = (((255) & 0xFF)) & 0xFF; __b.buf[35] = (((255) & 0xFF)) & 0xFF; __b.buf[36] = (((255) & 0xFF)) & 0xFF; __b.buf[37] = (((255) & 0xFF)) & 0xFF; __b.buf[38] = (((255) & 0xFF)) & 0xFF; __b.buf[39] = (((255) & 0xFF)) & 0xFF; __b.buf[40] = (((255) & 0xFF)) & 0xFF; __b.buf[41] = (((255) & 0xFF)) & 0xFF; __b.buf[42] = (((255) & 0xFF)) & 0xFF; __b.buf[43] = (((255) & 0xFF)) & 0xFF; __b.buf[44] = (((255) & 0xFF)) & 0xFF; __b.buf[45] = (((255) & 0xFF)) & 0xFF; __b.buf[46] = (((255) & 0xFF)) & 0xFF; __b.buf[47] = (((255) & 0xFF)) & 0xFF; __b.buf[48] = (((255) & 0xFF)) & 0xFF; __b.buf[49] = (((0) & 0xFF)) & 0xFF; __b.buf[50] = (((1) & 0xFF)) & 0xFF; __b.buf[51] = (((2) & 0xFF)) & 0xFF; __b.buf[52] = (((3) & 0xFF)) & 0xFF; __b.buf[53] = (((4) & 0xFF)) & 0xFF; __b.buf[54] = (((5) & 0xFF)) & 0xFF; __b.buf[55] = (((6) & 0xFF)) & 0xFF; __b.buf[56] = (((7) & 0xFF)) & 0xFF; __b.buf[57] = (((8) & 0xFF)) & 0xFF; __b.buf[58] = (((255) & 0xFF)) & 0xFF; __b.buf[59] = (((255) & 0xFF)) & 0xFF; __b.buf[60] = (((255) & 0xFF)) & 0xFF; __b.buf[61] = (((255) & 0xFF)) & 0xFF; __b.buf[62] = (((255) & 0xFF)) & 0xFF; __b.buf[63] = (((255) & 0xFF)) & 0xFF; __b.buf[64] = (((255) & 0xFF)) & 0xFF; __b.buf[65] = (((9) & 0xFF)) & 0xFF; __b.buf[66] = (((10) & 0xFF)) & 0xFF; __b.buf[67] = (((11) & 0xFF)) & 0xFF; __b.buf[68] = (((12) & 0xFF)) & 0xFF; __b.buf[69] = (((13) & 0xFF)) & 0xFF; __b.buf[70] = (((14) & 0xFF)) & 0xFF; __b.buf[71] = (((15) & 0xFF)) & 0xFF; __b.buf[72] = (((16) & 0xFF)) & 0xFF; __b.buf[73] = (((255) & 0xFF)) & 0xFF; __b.buf[74] = (((17) & 0xFF)) & 0xFF; __b.buf[75] = (((18) & 0xFF)) & 0xFF; __b.buf[76] = (((19) & 0xFF)) & 0xFF; __b.buf[77] = (((20) & 0xFF)) & 0xFF; __b.buf[78] = (((21) & 0xFF)) & 0xFF; __b.buf[79] = (((255) & 0xFF)) & 0xFF; __b.buf[80] = (((22) & 0xFF)) & 0xFF; __b.buf[81] = (((23) & 0xFF)) & 0xFF; __b.buf[82] = (((24) & 0xFF)) & 0xFF; __b.buf[83] = (((25) & 0xFF)) & 0xFF; __b.buf[84] = (((26) & 0xFF)) & 0xFF; __b.buf[85] = (((27) & 0xFF)) & 0xFF; __b.buf[86] = (((28) & 0xFF)) & 0xFF; __b.buf[87] = (((29) & 0xFF)) & 0xFF; __b.buf[88] = (((30) & 0xFF)) & 0xFF; __b.buf[89] = (((31) & 0xFF)) & 0xFF; __b.buf[90] = (((32) & 0xFF)) & 0xFF; __b.buf[91] = (((255) & 0xFF)) & 0xFF; __b.buf[92] = (((255) & 0xFF)) & 0xFF; __b.buf[93] = (((255) & 0xFF)) & 0xFF; __b.buf[94] = (((255) & 0xFF)) & 0xFF; __b.buf[95] = (((255) & 0xFF)) & 0xFF; __b.buf[96] = (((255) & 0xFF)) & 0xFF; __b.buf[97] = (((33) & 0xFF)) & 0xFF; __b.buf[98] = (((34) & 0xFF)) & 0xFF; __b.buf[99] = (((35) & 0xFF)) & 0xFF; __b.buf[100] = (((36) & 0xFF)) & 0xFF; __b.buf[101] = (((37) & 0xFF)) & 0xFF; __b.buf[102] = (((38) & 0xFF)) & 0xFF; __b.buf[103] = (((39) & 0xFF)) & 0xFF; __b.buf[104] = (((40) & 0xFF)) & 0xFF; __b.buf[105] = (((41) & 0xFF)) & 0xFF; __b.buf[106] = (((42) & 0xFF)) & 0xFF; __b.buf[107] = (((43) & 0xFF)) & 0xFF; __b.buf[108] = (((255) & 0xFF)) & 0xFF; __b.buf[109] = (((44) & 0xFF)) & 0xFF; __b.buf[110] = (((45) & 0xFF)) & 0xFF; __b.buf[111] = (((46) & 0xFF)) & 0xFF; __b.buf[112] = (((47) & 0xFF)) & 0xFF; __b.buf[113] = (((48) & 0xFF)) & 0xFF; __b.buf[114] = (((49) & 0xFF)) & 0xFF; __b.buf[115] = (((50) & 0xFF)) & 0xFF; __b.buf[116] = (((51) & 0xFF)) & 0xFF; __b.buf[117] = (((52) & 0xFF)) & 0xFF; __b.buf[118] = (((53) & 0xFF)) & 0xFF; __b.buf[119] = (((54) & 0xFF)) & 0xFF; __b.buf[120] = (((55) & 0xFF)) & 0xFF; __b.buf[121] = (((56) & 0xFF)) & 0xFF; __b.buf[122] = (((57) & 0xFF)) & 0xFF; __b.buf[123] = (((255) & 0xFF)) & 0xFF; __b.buf[124] = (((255) & 0xFF)) & 0xFF; __b.buf[125] = (((255) & 0xFF)) & 0xFF; __b.buf[126] = (((255) & 0xFF)) & 0xFF; __b.buf[127] = (((255) & 0xFF)) & 0xFF; return __b; })();
// BRIDGE: c-out-pointer — C17 §6.5.3.2 + §6.7.6.1: T*/T** out parameters lowered as COutParam<T> = { value: T }. Affected params: bin, binlen.
// BRIDGE-HINT: to refactor into idiomatic TypeScript, return [<original-return>, ...out_types] and drop the COutParam parameters; callers replace box.value reads with destructuring.
export function d58(b58: any, b58len: number, bin: COutParam<any | null>, binlen: COutParam<number>): void {
  if (typeof b58 === 'string') b58 = cptr_from_string(b58);
  ...
  let j = 0;
  let p = null;
  for (i = ((0) >>> 0); (((i) >>> 0) < ((b58len) >>> 0) ? 1 : 0); (() => { const _t = i; i = u32(i + 1); return _t; })()) {
    if ((((b58.buf[(b58.off ?? 0) + ((i) >>> 0)]) << 24 >> 24) != 49 ? 1 : 0)) {
      break;
    }
  }
  z = ((i) >>> 0);
  p = cptr_clone(bin.value);
  s = ((binlen.value) >>> 0);
  h = ((s) >>> 0) - ((1) >>> 0);
  l = ((h) >>> 0);
  for (; (((i) >>> 0) < ((b58len) >>> 0) ? 1 : 0); (() => { const _t = i; i = u32(i + 1); return _t; })()) {
    let c = ((((d58map.buf[(d58map.off ?? 0) + ((((b58)).buf[(((b58)).off ?? 0) + ((i) >>> 0)]) & 0xFF)]) & 0xFF)) >>> 0);
    for (j = ((h) >>> 0); ; (() => { const _t = j; j = u32(j - 1); return _t; })()) {
      if ((((j) >>> 0) == ((l) >>> 0) ? 1 : 0)) {
        if (((c) >>> 0)) {
          (() => { const _t = l; l = u32(l - 1); return _t; })();
        ...
        c = u32(c + (Math.imul(((Math.trunc(+(((p.buf[(p.off ?? 0) + ((j) >>> 0)]) & 0xFF)))) >>> 0), ((58) >>> 0)) >>> 0));
      }
      p.buf[(p.off ?? 0) + ((j) >>> 0)] = (((u32(((c) >>> 0) % ((256) >>> 0))) & 0xFF)) & 0xFF;
      c = __safe_div(c, ((256) >>> 0));
    }
  }
  for (i = ((0) >>> 0); (((i) >>> 0) < ((z) >>> 0) ? 1 : 0); (() => { const _t = i; i = u32(i + 1); return _t; })()) {
    p.buf[(p.off ?? 0) + (((l) >>> 0) + ((1) >>> 0) - ((z) >>> 0)) + ((i) >>> 0)] = (((0) & 0xFF)) & 0xFF;
  }
  bin.value = cptr_offset(p, (((l) >>> 0) + ((1) >>> 0) - ((z) >>> 0)));
  binlen.value = ((s) >>> 0) - (((l) >>> 0) + ((1) >>> 0) - ((z) >>> 0));
}

export function c58(b58: any, b58len: number): number {
  if (typeof b58 === 'string') b58 = cptr_from_string(b58);

  let i = 0;
  for (i = ((0) >>> 0); (((i) >>> 0) < ((b58len) >>> 0) ? 1 : 0); (() => { const _t = i; i = u32(i + 1); return _t; })()) {
    if ((((((b58.buf[(b58.off ?? 0) + ((i) >>> 0)]) << 24 >> 24) < 49 ? 1 : 0) || (((d58map.buf[(d58map.off ?? 0) + ((((b58)).buf[(((b58)).off ?? 0) + ((i) >>> 0)]) & 0xFF)]) & 0xFF) == ((d58map.buf[(d58map.off ?? 0) + 0]) & 0xFF) ? 1 : 0)) ? 1 : 0)) {
      return ((0) << 24 >> 24);
    }
  }
  return ((1) << 24 >> 24);
