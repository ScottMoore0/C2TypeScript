...
export type DiagnosticCode =
  | "compile-db/unresolved-include"
  | "compile-db/target-triple-mismatch"
  | "compile-db/generated-header-confidence-low"
  | "compile-db/compiler-version-unknown"
  | "compile-db/missing-compiler"
  | "compile-db/malformed-compile-command"
  | "compile-db/adapter-not-found"
  | "compile-db/cmake-exit-nonzero"
  | "compile-db/preprocessor-failed"
  | "compile-db/include-cycle-detected"
  | "compile-db/partial-ingest"
  | "compile-db/schema-extension-rejected";
