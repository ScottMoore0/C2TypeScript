...
export class NodeSyncBridge {
  ...
  constructor() {
    ...
    const req: (m: string) => any =
      typeof (g as any).require === "function"
        ...
        : (function () {
            ...
            const fromUrl =
              typeof (g as any).__posixRuntime_bridge_import_meta_url__ === "string"
                ? (g as any).__posixRuntime_bridge_import_meta_url__
                : "file://" + process.cwd() + "/";
    ...
    const candidates = [
      // tsx running posix-runtime/src/network/node-bridge.ts
      path.join(process.cwd(), "posix-runtime", "src", "network", "bridge-worker.cjs"),
      path.join(process.cwd(), "..", "posix-runtime", "src", "network", "bridge-worker.cjs"),
      path.join(process.cwd(), "src", "network", "bridge-worker.cjs"),
      // dist layout
      path.join(process.cwd(), "posix-runtime", "dist", "network", "bridge-worker.cjs"),
    ];
    ...
    try {
      const metaUrl = (g as any).__posixRuntime_bridge_import_meta_url__;
    ...
    // places at posix-runtime/src/network/. Add that to the candidate list.
