...
// Why this module
// ---------------
// `posix-runtime/src/network/network.ts` ships a `NetworkStack` with three operating
...
// browser bridge would land in `posix-runtime/src/network/web-bridge.ts` parallel
// to `node-bridge.ts`.
