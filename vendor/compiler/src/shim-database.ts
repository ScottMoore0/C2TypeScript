...
export const shimDatabase: Record<string, ShimEntry[]> = {
  ...
  "POSIX": [
    ...
    { cFunction: "close", tsCode: "const M=(globalThis as any).__mirage_sockets; if(M&&M.posix_is_socket_fd&&M.posix_is_socket_fd(fd))return M.posix_close_socket(fd); try { require('fs').closeSync(fd); } catch {} return 0;", returnType: "number", params: "fd: any", category: "file" },
    ...
    { cFunction: "socket", tsCode: "const g=(globalThis as any); if(g.__mirage_sockets===undefined){try{g.__mirage_sockets=require('@c2typescript/mirage');}catch{try{g.__mirage_sockets=require('mirage');}catch{g.__mirage_sockets=null;}}} const M=g.__mirage_sockets; if(M&&M.posix_socket)return M.posix_socket(domain,type,protocol); return -1;", returnType: "number", params: "domain: number, type: number, protocol: number", category: "network" },
    { cFunction: "bind", tsCode: "const M=(globalThis as any).__mirage_sockets; if(M&&M.posix_bind)return M.posix_bind(sockfd,addr,addrlen); return -1;", returnType: "number", params: "sockfd: number, addr: any, addrlen: number", category: "network" },
    { cFunction: "listen", tsCode: "const M=(globalThis as any).__mirage_sockets; if(M&&M.posix_listen)return M.posix_listen(sockfd,backlog); return -1;", returnType: "number", params: "sockfd: number, backlog: number", category: "network" },
    { cFunction: "accept", tsCode: "const M=(globalThis as any).__mirage_sockets; if(M&&M.posix_accept)return M.posix_accept(sockfd,addr,addrlen); return -1;", returnType: "number", params: "sockfd: number, addr: any, addrlen: any", category: "network" },
    { cFunction: "connect", tsCode: "const M=(globalThis as any).__mirage_sockets; if(M&&M.posix_connect)return M.posix_connect(sockfd,addr,addrlen); return -1;", returnType: "number", params: "sockfd: number, addr: any, addrlen: number", category: "network" },
    { cFunction: "send", tsCode: "const M=(globalThis as any).__mirage_sockets; if(M&&M.posix_send)return M.posix_send(sockfd,buf,len,flags); return -1;", returnType: "number", params: "sockfd: number, buf: any, len: number, flags: number", category: "network" },
    { cFunction: "recv", tsCode: "const M=(globalThis as any).__mirage_sockets; if(M&&M.posix_recv)return M.posix_recv(sockfd,buf,len,flags); return -1;", returnType: "number", params: "sockfd: number, buf: any, len: number, flags: number", category: "network" },
    { cFunction: "sendto", tsCode: "const M=(globalThis as any).__mirage_sockets; if(M&&M.posix_sendto)return M.posix_sendto(sockfd,buf,len,flags,addr,addrlen); return -1;", returnType: "number", params: "sockfd: number, buf: any, len: number, flags: number, addr: any, addrlen: number", category: "network" },
    { cFunction: "recvfrom", tsCode: "const M=(globalThis as any).__mirage_sockets; if(M&&M.posix_recvfrom)return M.posix_recvfrom(sockfd,buf,len,flags,addr,addrlen); return -1;", returnType: "number", params: "sockfd: number, buf: any, len: number, flags: number, addr: any, addrlen: any", category: "network" },
    { cFunction: "shutdown", tsCode: "const M=(globalThis as any).__mirage_sockets; if(M&&M.posix_shutdown)return M.posix_shutdown(sockfd,how); return -1;", returnType: "number", params: "sockfd: number, how: number", category: "network" },
    { cFunction: "setsockopt", tsCode: "const M=(globalThis as any).__mirage_sockets; if(M&&M.posix_setsockopt)return M.posix_setsockopt(sockfd,level,optname,optval,optlen); return 0;", returnType: "number", params: "sockfd: number, level: number, optname: number, optval: any, optlen: number", category: "network" },
    { cFunction: "getsockopt", tsCode: "const M=(globalThis as any).__mirage_sockets; if(M&&M.posix_getsockopt)return M.posix_getsockopt(sockfd,level,optname,optval,optlen); return -1;", returnType: "number", params: "sockfd: number, level: number, optname: number, optval: any, optlen: any", category: "network" },
    { cFunction: "getsockname", tsCode: "const M=(globalThis as any).__mirage_sockets; if(M&&M.posix_getsockname)return M.posix_getsockname(sockfd,addr,addrlen); return -1;", returnType: "number", params: "sockfd: number, addr: any, addrlen: any", category: "network" },
    { cFunction: "getpeername", tsCode: "const M=(globalThis as any).__mirage_sockets; if(M&&M.posix_getpeername)return M.posix_getpeername(sockfd,addr,addrlen); return -1;", returnType: "number", params: "sockfd: number, addr: any, addrlen: any", category: "network" },
    { cFunction: "getaddrinfo", tsCode: "const g=(globalThis as any); if(g.__mirage_sockets===undefined){try{g.__mirage_sockets=require('@c2typescript/mirage');}catch{try{g.__mirage_sockets=require('mirage');}catch{g.__mirage_sockets=null;}}} const M=g.__mirage_sockets; if(M&&M.posix_getaddrinfo)return M.posix_getaddrinfo(node,service,hints,res); return -1;", returnType: "number", params: "node: string|null, service: string|null, hints: any, res: any", category: "network" },
    { cFunction: "freeaddrinfo", tsCode: "const M=(globalThis as any).__mirage_sockets; if(M&&M.posix_freeaddrinfo)M.posix_freeaddrinfo(res);", returnType: "void", params: "res: any", category: "network" },
    { cFunction: "getnameinfo", tsCode: "const M=(globalThis as any).__mirage_sockets; if(M&&M.posix_getnameinfo)return M.posix_getnameinfo(sa,salen,host,hostlen,serv,servlen,flags); return -1;", returnType: "number", params: "sa: any, salen: number, host: any, hostlen: number, serv: any, servlen: number, flags: number", category: "network" },
    { cFunction: "gai_strerror", tsCode: "const M=(globalThis as any).__mirage_sockets; if(M&&M.posix_gai_strerror)return M.posix_gai_strerror(code); return 'unknown';", returnType: "string", params: "code: number", category: "network" },
