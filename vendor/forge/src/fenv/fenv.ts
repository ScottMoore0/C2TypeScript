 ...
 *  so forge must agree to keep state synchronised with the emitter's
...
// (which read from globalThis.__fenvExc) and the forge `c_fetestexcept`
...
// shims still write to globalThis directly, and the forge functions
