...
export class SHA1_CTX {
  [k: string]: any;
  data: any = cptr_create(64);
  datalen: WORD;
  bitlen: number;
  state: any = new Array(5).fill(0);
  k: any = new Array(4).fill(0);
  constructor() {
    this.data = cptr_create(64);
    this.datalen = 0;
    this.bitlen = 0;
    this.state = new Array(5).fill(0);
    this.k = new Array(4).fill(0);
  }
}
(SHA1_CTX as any).__fieldTypes = ["bytes","int32","int64","bytes","bytes"];
(SHA1_CTX as any).__fieldNames = ["data","datalen","bitlen","state","k"];
(SHA1_CTX as any).__fieldOffsets = [0,512,520,528,568];

export function sha1_transform(ctx: SHA1_CTX | null, data: any | null): void {
  ...
  let j = 0;
  let t = 0;
  let m = new Array(80).fill(0);
  for (i = ((0) >>> 0), j = ((0) >>> 0); (((i) >>> 0) < ((16) >>> 0) ? 1 : 0); ++i, j = u32(j + ((4) >>> 0))) {
    m[((i) >>> 0)] = ((i32(i32(i32((((((data.buf[(data.off ?? 0) + ((j) >>> 0)]) & 0xFF) << 24) | 0)) + (((((data.buf[(data.off ?? 0) + u32(((j) >>> 0) + ((1) >>> 0))]) & 0xFF) << 16) | 0))) + (((((data.buf[(data.off ?? 0) + u32(((j) >>> 0) + ((2) >>> 0))]) & 0xFF) << 8) | 0))) + (((data.buf[(data.off ?? 0) + u32(((j) >>> 0) + ((3) >>> 0))])) & 0xFF))) >>> 0);
  }
  for (; (((i) >>> 0) < ((80) >>> 0) ? 1 : 0); ++i) {
    m[((i) >>> 0)] = ((((((m[u32(((i) >>> 0) - ((3) >>> 0))]) >>> 0) ^ ((m[u32(((i) >>> 0) - ((8) >>> 0))]) >>> 0)) >>> 0 ^ ((m[u32(((i) >>> 0) - ((14) >>> 0))]) >>> 0)) >>> 0 ^ ((m[u32(((i) >>> 0) - ((16) >>> 0))]) >>> 0)) >>> 0);
    m[((i) >>> 0)] = (((((m[((i) >>> 0)]) >>> 0) << 1) >>> 0) | ((((m[((i) >>> 0)]) >>> 0) >>> 31) >>> 0)) >>> 0;
  }
  ...
  for (i = ((0) >>> 0); (((i) >>> 0) < ((20) >>> 0) ? 1 : 0); ++i) {
    t = u32(u32(u32(u32(((((((a) >>> 0) << 5) >>> 0) | ((((a) >>> 0) >>> (i32(32 - 5))) >>> 0)) >>> 0) + ((((((b) >>> 0) & ((c) >>> 0)) >>> 0) ^ ((~((b) >>> 0) & ((d) >>> 0)) >>> 0)) >>> 0)) + ((e) >>> 0)) + (((__struct_ptr_at(ctx, 0)).k[0]) >>> 0)) + ((m[((i) >>> 0)]) >>> 0));
    e = ((d) >>> 0);
    d = ((c) >>> 0);
    c = ((((((b) >>> 0) << 30) >>> 0) | ((((b) >>> 0) >>> (i32(32 - 30))) >>> 0)) >>> 0);
    b = ((a) >>> 0);
    a = ((t) >>> 0);
  }
  for (; (((i) >>> 0) < ((40) >>> 0) ? 1 : 0); ++i) {
    t = u32(u32(u32(u32(((((((a) >>> 0) << 5) >>> 0) | ((((a) >>> 0) >>> (i32(32 - 5))) >>> 0)) >>> 0) + (((((b) >>> 0) ^ ((c) >>> 0)) >>> 0 ^ ((d) >>> 0)) >>> 0)) + ((e) >>> 0)) + (((__struct_ptr_at(ctx, 0)).k[1]) >>> 0)) + ((m[((i) >>> 0)]) >>> 0));
    e = ((d) >>> 0);
    d = ((c) >>> 0);
    c = ((((((b) >>> 0) << 30) >>> 0) | ((((b) >>> 0) >>> (i32(32 - 30))) >>> 0)) >>> 0);
    b = ((a) >>> 0);
  ...
  for (; (((i) >>> 0) < ((60) >>> 0) ? 1 : 0); ++i) {
    t = u32(u32(u32(u32(((((((a) >>> 0) << 5) >>> 0) | ((((a) >>> 0) >>> (i32(32 - 5))) >>> 0)) >>> 0) + (((((((b) >>> 0) & ((c) >>> 0)) >>> 0) ^ ((((b) >>> 0) & ((d) >>> 0)) >>> 0)) >>> 0 ^ ((((c) >>> 0) & ((d) >>> 0)) >>> 0)) >>> 0)) + ((e) >>> 0)) + (((__struct_ptr_at(ctx, 0)).k[2]) >>> 0)) + ((m[((i) >>> 0)]) >>> 0));
    e = ((d) >>> 0);
    d = ((c) >>> 0);
    c = ((((((b) >>> 0) << 30) >>> 0) | ((((b) >>> 0) >>> (i32(32 - 30))) >>> 0)) >>> 0);
    b = ((a) >>> 0);
  ...
  for (; (((i) >>> 0) < ((80) >>> 0) ? 1 : 0); ++i) {
    t = u32(u32(u32(u32(((((((a) >>> 0) << 5) >>> 0) | ((((a) >>> 0) >>> (i32(32 - 5))) >>> 0)) >>> 0) + (((((b) >>> 0) ^ ((c) >>> 0)) >>> 0 ^ ((d) >>> 0)) >>> 0)) + ((e) >>> 0)) + (((__struct_ptr_at(ctx, 0)).k[3]) >>> 0)) + ((m[((i) >>> 0)]) >>> 0));
    e = ((d) >>> 0);
    d = ((c) >>> 0);
    c = ((((((b) >>> 0) << 30) >>> 0) | ((((b) >>> 0) >>> (i32(32 - 30))) >>> 0)) >>> 0);
    b = ((a) >>> 0);
...
export function sha1_init(ctx: SHA1_CTX | null): void {
  (__struct_ptr_at(ctx, 0)).datalen = ((0) >>> 0);
  (__struct_ptr_at(ctx, 0)).bitlen = /* WARNING: 64-bit integer may lose precision beyond 2^53 */ 0;
  (__struct_ptr_at(ctx, 0)).state[0] = ((1732584193) >>> 0);
  (__struct_ptr_at(ctx, 0)).state[1] = 4023233417;
  (__struct_ptr_at(ctx, 0)).state[2] = 2562383102;
  (__struct_ptr_at(ctx, 0)).state[3] = ((271733878) >>> 0);
  (__struct_ptr_at(ctx, 0)).state[4] = 3285377520;
  (__struct_ptr_at(ctx, 0)).k[0] = ((1518500249) >>> 0);
  (__struct_ptr_at(ctx, 0)).k[1] = ((1859775393) >>> 0);
  (__struct_ptr_at(ctx, 0)).k[2] = 2400959708;
  (__struct_ptr_at(ctx, 0)).k[3] = 3395469782;
}

export function sha1_update(ctx: SHA1_CTX | null, data: any | null, len: number): void {
  if (typeof data === 'string') data = cptr_from_string(data);
  ...
  for (i = ((0) >>> 0); (((i) >>> 0) < ((len) >>> 0) ? 1 : 0); (i = u32(i + 1))) {
    ...
    if (((((__struct_ptr_at(ctx, 0)).datalen) >>> 0) == ((64) >>> 0) ? 1 : 0)) {
      sha1_transform(ctx, (__struct_ptr_at(ctx, 0)).data);
...
export function sha1_final(ctx: SHA1_CTX | null, hash: any | null): void {
  let i = 0;
