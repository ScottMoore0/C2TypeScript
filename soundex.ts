...
function calloc(n: any, size: any): any { const ni = typeof n === 'bigint' ? Number(n) : Number(n ?? 0); const si = typeof size === 'bigint' ? Number(size) : Number(size ?? 0); return cptr_create(ni * si); }
...
type COutParam<T> = { value: T | any };

function strlen(s: any): number {
  if (typeof s === 'string') s = cptr_from_string(s);
 if (s == null) return 0; if (typeof s === 'string') return s.length; if (s.buf) return cptr_strlen(s); if (Array.isArray(s)) { let i = 0; while (s[i] !== 0 && s[i] !== undefined && i < s.length) i++; return i; } return s?.length ?? 0; }
export function shift_whitespaces(str: any): number {
  let raw = cptr_clone(cptr_clone(str)); /* &ref */
  let shifted = cptr_clone(cptr_clone(str)); /* &ref */
  let whitespaces = 0;
  while ((((raw.buf[raw.off]) << 24 >> 24) != 0 ? 1 : 0)) {
    if ((((raw.buf[raw.off]) << 24 >> 24) != 32 ? 1 : 0)) {
      (shifted.buf[shifted.off++]) = (((raw.buf[raw.off]) << 24 >> 24)) << 24 >> 24;
    } else {
      ++whitespaces;
    }
    ++raw.off;
  }
  while ((((shifted.buf[shifted.off]) << 24 >> 24) != 0 ? 1 : 0)) {
    (shifted.buf[shifted.off++]) = (((32) << 24 >> 24)) << 24 >> 24;
  }
  return whitespaces;
}

// BRIDGE: c-out-pointer — C17 §6.5.3.2 + §6.7.6.1: T*/T** out parameters lowered as COutParam<T> = { value: T }. Affected params: str.
...
export function trim(str: any, n: number): number {
  let s = null;
  let i = 0;
  let l = 0;
  l = strlen(cptr_clone(str.value));
  s = cptr_clone(calloc(i32(i32(l - n) + 1), 1));
  for (i = 0; (i < i32(l - n) ? 1 : 0); ++i) {
    s.buf[(s.off ?? 0) + i] = ((((str.value).buf[((str.value).off ?? 0) + i]) << 24 >> 24)) << 24 >> 24;
  }
  s.buf[(s.off ?? 0) + i32(l - n)] = (((0) << 24 >> 24)) << 24 >> 24;
  free(str.value);
  str.value = s;
  return strlen(cptr_clone(str.value));
}

export function zoundx_encode(query: any): any {
  if (typeof query === 'string') query = cptr_from_string(query);
  ...
  let l = 0;
  let val = 0;
  l = strlen(cptr_clone(query));
  lower = cptr_clone(calloc(l, 1));
  for (i = 0; (i < l ? 1 : 0); ++i) {
    lower.buf[(lower.off ?? 0) + i] = (((tolower(((query.buf[(query.off ?? 0) + i]) << 24 >> 24))) << 24 >> 24)) << 24 >> 24;
  }
  for (i = 0; (i < l ? 1 : 0); ++i) {
    if (((((((i32(i + 1)) < l ? 1 : 0) && (i > 1 ? 1 : 0)) ? 1 : 0) && ((((((((((((((((((((((((lower.buf[(lower.off ?? 0) + i]) << 24 >> 24) == 98 ? 1 : 0) || (((lower.buf[(lower.off ?? 0) + i]) << 24 >> 24) == 102 ? 1 : 0)) ? 1 : 0) || (((lower.buf[(lower.off ?? 0) + i]) << 24 >> 24) == 112 ? 1 : 0)) ? 1 : 0) || (((lower.buf[(lower.off ?? 0) + i]) << 24 >> 24) == 118 ? 1 : 0)) ? 1 : 0)) && ((((((((((lower.buf[(lower.off ?? 0) + i32(i + 1)]) << 24 >> 24) == 98 ? 1 : 0) || (((lower.buf[(lower.off ?? 0) + i32(i + 1)]) << 24 >> 24) == 102 ? 1 : 0)) ? 1 : 0) || (((lower.buf[(lower.off ?? 0) + i32(i + 1)]) << 24 >> 24) == 112 ? 1 : 0)) ? 1 : 0) || (((lower.buf[(lower.off ?? 0) + i32(i + 1)]) << 24 >> 24) == 118 ? 1 : 0)) ? 1 : 0))) ? 1 : 0)) || (((((((((((((((((((((lower.buf[(lower.off ?? 0) + i]) << 24 >> 24) == 99 ? 1 : 0) || (((lower.buf[(lower.off ?? 0) + i]) << 24 >> 24) == 103 ? 1 : 0)) ? 1 : 0) || (((lower.buf[(lower.off ?? 0) + i]) << 24 >> 24) == 106 ? 1 : 0)) ? 1 : 0) || (((lower.buf[(lower.off ?? 0) + i]) << 24 >> 24) == 107 ? 1 : 0)) ? 1 : 0) || (((lower.buf[(lower.off ?? 0) + i]) << 24 >> 24) == 113 ? 1 : 0)) ? 1 : 0) || (((lower.buf[(lower.off ?? 0) + i]) << 24 >> 24) == 115 ? 1 : 0)) ? 1 : 0) || (((lower.buf[(lower.off ?? 0) + i]) << 24 >> 24) == 120 ? 1 : 0)) ? 1 : 0) || (((lower.buf[(lower.off ?? 0) + i]) << 24 >> 24) == 122 ? 1 : 0)) ? 1 : 0)) && ((((((((((((((((((lower.buf[(lower.off ?? 0) + i32(i + 1)]) << 24 >> 24) == 99 ? 1 : 0) || (((lower.buf[(lower.off ?? 0) + i32(i + 1)]) << 24 >> 24) == 103 ? 1 : 0)) ? 1 : 0) || (((lower.buf[(lower.off ?? 0) + i32(i + 1)]) << 24 >> 24) == 106 ? 1 : 0)) ? 1 : 0) || (((lower.buf[(lower.off ?? 0) + i32(i + 1)]) << 24 >> 24) == 107 ? 1 : 0)) ? 1 : 0) || (((lower.buf[(lower.off ?? 0) + i32(i + 1)]) << 24 >> 24) == 113 ? 1 : 0)) ? 1 : 0) || (((lower.buf[(lower.off ?? 0) + i32(i + 1)]) << 24 >> 24) == 115 ? 1 : 0)) ? 1 : 0) || (((lower.buf[(lower.off ?? 0) + i32(i + 1)]) << 24 >> 24) == 120 ? 1 : 0)) ? 1 : 0) || (((lower.buf[(lower.off ?? 0) + i32(i + 1)]) << 24 >> 24) == 122 ? 1 : 0)) ? 1 : 0))) ? 1 : 0))) ? 1 : 0) || (((((((((lower.buf[(lower.off ?? 0) + i]) << 24 >> 24) == 100 ? 1 : 0) || (((lower.buf[(lower.off ?? 0) + i]) << 24 >> 24) == 116 ? 1 : 0)) ? 1 : 0)) && ((((((lower.buf[(lower.off ?? 0) + i32(i + 1)]) << 24 >> 24) == 100 ? 1 : 0) || (((lower.buf[(lower.off ?? 0) + i32(i + 1)]) << 24 >> 24) == 116 ? 1 : 0)) ? 1 : 0))) ? 1 : 0))) ? 1 : 0) || (((((((lower.buf[(lower.off ?? 0) + i]) << 24 >> 24) == 108 ? 1 : 0)) && ((((lower.buf[(lower.off ?? 0) + i32(i + 1)]) << 24 >> 24) == 108 ? 1 : 0))) ? 1 : 0))) ? 1 : 0) || (((((((((lower.buf[(lower.off ?? 0) + i]) << 24 >> 24) == 109 ? 1 : 0) || (((lower.buf[(lower.off ?? 0) + i]) << 24 >> 24) == 110 ? 1 : 0)) ? 1 : 0)) && ((((((lower.buf[(lower.off ?? 0) + i32(i + 1)]) << 24 >> 24) == 109 ? 1 : 0) || (((lower.buf[(lower.off ?? 0) + i32(i + 1)]) << 24 >> 24) == 110 ? 1 : 0)) ? 1 : 0))) ? 1 : 0))) ? 1 : 0) || (((((((lower.buf[(lower.off ?? 0) + i]) << 24 >> 24) == 114 ? 1 : 0)) && ((((lower.buf[(lower.off ?? 0) + i32(i + 1)]) << 24 >> 24) == 114 ? 1 : 0))) ? 1 : 0))) ? 1 : 0))) ? 1 : 0)) {
      lower.buf[(lower.off ?? 0) + i32(i + 1)] = (((32) << 24 >> 24)) << 24 >> 24;
    }
  }
  l = (() => { const _box0 = { value: lower }; const _r = trim(_box0, shift_whitespaces(cptr_clone(lower))); lower = _box0.value; return _r; })();
  for (i = 0; (i < l ? 1 : 0); ++i) {
    if (((((((((i32(i + 1)) < l ? 1 : 0) && (i > 1 ? 1 : 0)) ? 1 : 0) && ((((((lower.buf[(lower.off ?? 0) + i]) << 24 >> 24) == 104 ? 1 : 0) || (((lower.buf[(lower.off ?? 0) + i]) << 24 >> 24) == 119 ? 1 : 0)) ? 1 : 0))) ? 1 : 0) && ((((((((((((((((((((((((lower.buf[(lower.off ?? 0) + i32(i - 1)]) << 24 >> 24) == 98 ? 1 : 0) || (((lower.buf[(lower.off ?? 0) + i32(i - 1)]) << 24 >> 24) == 102 ? 1 : 0)) ? 1 : 0) || (((lower.buf[(lower.off ?? 0) + i32(i - 1)]) << 24 >> 24) == 112 ? 1 : 0)) ? 1 : 0) || (((lower.buf[(lower.off ?? 0) + i32(i - 1)]) << 24 >> 24) == 118 ? 1 : 0)) ? 1 : 0)) && ((((((((((lower.buf[(lower.off ?? 0) + i32(i + 1)]) << 24 >> 24) == 98 ? 1 : 0) || (((lower.buf[(lower.off ?? 0) + i32(i + 1)]) << 24 >> 24) == 102 ? 1 : 0)) ? 1 : 0) || (((lower.buf[(lower.off ?? 0) + i32(i + 1)]) << 24 >> 24) == 112 ? 1 : 0)) ? 1 : 0) || (((lower.buf[(lower.off ?? 0) + i32(i + 1)]) << 24 >> 24) == 118 ? 1 : 0)) ? 1 : 0))) ? 1 : 0)) || (((((((((((((((((((((lower.buf[(lower.off ?? 0) + i32(i - 1)]) << 24 >> 24) == 99 ? 1 : 0) || (((lower.buf[(lower.off ?? 0) + i32(i - 1)]) << 24 >> 24) == 103 ? 1 : 0)) ? 1 : 0) || (((lower.buf[(lower.off ?? 0) + i32(i - 1)]) << 24 >> 24) == 106 ? 1 : 0)) ? 1 : 0) || (((lower.buf[(lower.off ?? 0) + i32(i - 1)]) << 24 >> 24) == 107 ? 1 : 0)) ? 1 : 0) || (((lower.buf[(lower.off ?? 0) + i32(i - 1)]) << 24 >> 24) == 113 ? 1 : 0)) ? 1 : 0) || (((lower.buf[(lower.off ?? 0) + i32(i - 1)]) << 24 >> 24) == 115 ? 1 : 0)) ? 1 : 0) || (((lower.buf[(lower.off ?? 0) + i32(i - 1)]) << 24 >> 24) == 120 ? 1 : 0)) ? 1 : 0) || (((lower.buf[(lower.off ?? 0) + i32(i - 1)]) << 24 >> 24) == 122 ? 1 : 0)) ? 1 : 0)) && ((((((((((((((((((lower.buf[(lower.off ?? 0) + i32(i + 1)]) << 24 >> 24) == 99 ? 1 : 0) || (((lower.buf[(lower.off ?? 0) + i32(i + 1)]) << 24 >> 24) == 103 ? 1 : 0)) ? 1 : 0) || (((lower.buf[(lower.off ?? 0) + i32(i + 1)]) << 24 >> 24) == 106 ? 1 : 0)) ? 1 : 0) || (((lower.buf[(lower.off ?? 0) + i32(i + 1)]) << 24 >> 24) == 107 ? 1 : 0)) ? 1 : 0) || (((lower.buf[(lower.off ?? 0) + i32(i + 1)]) << 24 >> 24) == 113 ? 1 : 0)) ? 1 : 0) || (((lower.buf[(lower.off ?? 0) + i32(i + 1)]) << 24 >> 24) == 115 ? 1 : 0)) ? 1 : 0) || (((lower.buf[(lower.off ?? 0) + i32(i + 1)]) << 24 >> 24) == 120 ? 1 : 0)) ? 1 : 0) || (((lower.buf[(lower.off ?? 0) + i32(i + 1)]) << 24 >> 24) == 122 ? 1 : 0)) ? 1 : 0))) ? 1 : 0))) ? 1 : 0) || (((((((((lower.buf[(lower.off ?? 0) + i32(i - 1)]) << 24 >> 24) == 100 ? 1 : 0) || (((lower.buf[(lower.off ?? 0) + i32(i - 1)]) << 24 >> 24) == 116 ? 1 : 0)) ? 1 : 0)) && ((((((lower.buf[(lower.off ?? 0) + i32(i + 1)]) << 24 >> 24) == 100 ? 1 : 0) || (((lower.buf[(lower.off ?? 0) + i32(i + 1)]) << 24 >> 24) == 116 ? 1 : 0)) ? 1 : 0))) ? 1 : 0))) ? 1 : 0) || (((((((lower.buf[(lower.off ?? 0) + i32(i - 1)]) << 24 >> 24) == 108 ? 1 : 0)) && ((((lower.buf[(lower.off ?? 0) + i32(i + 1)]) << 24 >> 24) == 108 ? 1 : 0))) ? 1 : 0))) ? 1 : 0) || (((((((((lower.buf[(lower.off ?? 0) + i32(i - 1)]) << 24 >> 24) == 109 ? 1 : 0) || (((lower.buf[(lower.off ?? 0) + i32(i - 1)]) << 24 >> 24) == 110 ? 1 : 0)) ? 1 : 0)) && ((((((lower.buf[(lower.off ?? 0) + i32(i + 1)]) << 24 >> 24) == 109 ? 1 : 0) || (((lower.buf[(lower.off ?? 0) + i32(i + 1)]) << 24 >> 24) == 110 ? 1 : 0)) ? 1 : 0))) ? 1 : 0))) ? 1 : 0) || (((((((lower.buf[(lower.off ?? 0) + i32(i - 1)]) << 24 >> 24) == 114 ? 1 : 0)) && ((((lower.buf[(lower.off ?? 0) + i32(i + 1)]) << 24 >> 24) == 114 ? 1 : 0))) ? 1 : 0))) ? 1 : 0))) ? 1 : 0)) {
      lower.buf[(lower.off ?? 0) + i] = (lower.buf[(lower.off ?? 0) + i32(i + 1)] = (((32) << 24 >> 24)) << 24 >> 24) << 24 >> 24;
    }
  }
  l = (() => { const _box0 = { value: lower }; const _r = trim(_box0, shift_whitespaces(cptr_clone(lower))); lower = _box0.value; return _r; })();
  for (i = 1; (i < l ? 1 : 0); ++i) {
    if (((((((((((((((((((lower.buf[(lower.off ?? 0) + i]) << 24 >> 24) == 97 ? 1 : 0) || (((lower.buf[(lower.off ?? 0) + i]) << 24 >> 24) == 101 ? 1 : 0)) ? 1 : 0) || (((lower.buf[(lower.off ?? 0) + i]) << 24 >> 24) == 105 ? 1 : 0)) ? 1 : 0) || (((lower.buf[(lower.off ?? 0) + i]) << 24 >> 24) == 111 ? 1 : 0)) ? 1 : 0) || (((lower.buf[(lower.off ?? 0) + i]) << 24 >> 24) == 117 ? 1 : 0)) ? 1 : 0) || (((lower.buf[(lower.off ?? 0) + i]) << 24 >> 24) == 121 ? 1 : 0)) ? 1 : 0) || (((lower.buf[(lower.off ?? 0) + i]) << 24 >> 24) == 104 ? 1 : 0)) ? 1 : 0) || (((lower.buf[(lower.off ?? 0) + i]) << 24 >> 24) == 119 ? 1 : 0)) ? 1 : 0))) {
      lower.buf[(lower.off ?? 0) + i] = (((32) << 24 >> 24)) << 24 >> 24;
    }
  }
  l = (() => { const _box0 = { value: lower }; const _r = trim(_box0, shift_whitespaces(cptr_clone(lower))); lower = _box0.value; return _r; })();
  for (i = 1; (i < l ? 1 : 0); ++i) {
    if ((((((((((((((((((((((((lower.buf[(lower.off ?? 0) + i]) << 24 >> 24) == 98 ? 1 : 0) || (((lower.buf[(lower.off ?? 0) + i]) << 24 >> 24) == 102 ? 1 : 0)) ? 1 : 0) || (((lower.buf[(lower.off ?? 0) + i]) << 24 >> 24) == 112 ? 1 : 0)) ? 1 : 0) || (((lower.buf[(lower.off ?? 0) + i]) << 24 >> 24) == 118 ? 1 : 0)) ? 1 : 0)) && (val = 1)) ? 1 : 0)) || (((((((((((((((((((((lower.buf[(lower.off ?? 0) + i]) << 24 >> 24) == 99 ? 1 : 0) || (((lower.buf[(lower.off ?? 0) + i]) << 24 >> 24) == 103 ? 1 : 0)) ? 1 : 0) || (((lower.buf[(lower.off ?? 0) + i]) << 24 >> 24) == 106 ? 1 : 0)) ? 1 : 0) || (((lower.buf[(lower.off ?? 0) + i]) << 24 >> 24) == 107 ? 1 : 0)) ? 1 : 0) || (((lower.buf[(lower.off ?? 0) + i]) << 24 >> 24) == 113 ? 1 : 0)) ? 1 : 0) || (((lower.buf[(lower.off ?? 0) + i]) << 24 >> 24) == 115 ? 1 : 0)) ? 1 : 0) || (((lower.buf[(lower.off ?? 0) + i]) << 24 >> 24) == 120 ? 1 : 0)) ? 1 : 0) || (((lower.buf[(lower.off ?? 0) + i]) << 24 >> 24) == 122 ? 1 : 0)) ? 1 : 0)) && (val = 2)) ? 1 : 0))) ? 1 : 0) || (((((((((lower.buf[(lower.off ?? 0) + i]) << 24 >> 24) == 100 ? 1 : 0) || (((lower.buf[(lower.off ?? 0) + i]) << 24 >> 24) == 116 ? 1 : 0)) ? 1 : 0)) && (val = 3)) ? 1 : 0))) ? 1 : 0) || (((((((lower.buf[(lower.off ?? 0) + i]) << 24 >> 24) == 108 ? 1 : 0)) && (val = 4)) ? 1 : 0))) ? 1 : 0) || (((((((((lower.buf[(lower.off ?? 0) + i]) << 24 >> 24) == 109 ? 1 : 0) || (((lower.buf[(lower.off ?? 0) + i]) << 24 >> 24) == 110 ? 1 : 0)) ? 1 : 0)) && (val = 5)) ? 1 : 0))) ? 1 : 0) || (((((((lower.buf[(lower.off ?? 0) + i]) << 24 >> 24) == 114 ? 1 : 0)) && (val = 6)) ? 1 : 0))) ? 1 : 0)) {
      lower.buf[(lower.off ?? 0) + i] = (((i32(48 + ((Math.trunc(+(val))) << 24 >> 24))) << 24 >> 24)) << 24 >> 24;
    }
  }
  if ((l > 4 ? 1 : 0)) {
    buffer = cptr_clone(calloc(4, 1));
    for (i = 0; (i < 4 ? 1 : 0); ++i) {
      buffer.buf[(buffer.off ?? 0) + i] = (((lower.buf[(lower.off ?? 0) + i]) << 24 >> 24)) << 24 >> 24;
    }
    free(lower);
    lower = cptr_clone(buffer);
  } else {
    if ((((l < 4 ? 1 : 0) && (l > 0 ? 1 : 0)) ? 1 : 0)) {
      buffer = cptr_clone(calloc(4, 1));
      for (i = 0; (i < l ? 1 : 0); ++i) {
        buffer.buf[(buffer.off ?? 0) + i] = (((lower.buf[(lower.off ?? 0) + i]) << 24 >> 24)) << 24 >> 24;
      }
      ...
      lower = cptr_clone(buffer);
      for (i = l; (i < 4 ? 1 : 0); ++i) {
        lower.buf[(lower.off ?? 0) + i] = (((48) << 24 >> 24)) << 24 >> 24;
      }
    }
  }
  lower.buf[(lower.off ?? 0) + 0] = (((toupper(((lower.buf[(lower.off ?? 0) + 0]) << 24 >> 24))) << 24 >> 24)) << 24 >> 24;
  return cptr_clone(lower);
}

export function shift_whitespaces_1(str: any): number {
  let raw = cptr_clone(cptr_clone(str)); /* &ref */
  let shifted = cptr_clone(cptr_clone(str)); /* &ref */
  let whitespaces = 0;
  while ((((raw.buf[raw.off]) << 24 >> 24) != 0 ? 1 : 0)) {
...
// BRIDGE: c-out-pointer — C17 §6.5.3.2 + §6.7.6.1: T*/T** out parameters lowered as COutParam<T> = { value: T }. Affected params: str.
// BRIDGE-HINT: to refactor into idiomatic TypeScript, return [<original-return>, ...out_types] and drop the COutParam parameters; callers replace box.value reads with destructuring.
export function trim_1(str: any, n: number): number {
  let s = null;
  let i = 0;
  let l = 0;
  l = strlen(cptr_clone(str.value));
