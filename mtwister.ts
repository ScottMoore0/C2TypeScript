...
let _static_mag_0: number[] = [((0) >>> 0), 2567483615];

// BRIDGE: struct-as-class — C17 §6.7.2.1 / C++20 [class]
export class tagMTRand {
  mt: any = new Array(624).fill(0);
  index: number;
  constructor() {
...
const MTRand = tagMTRand;
type MTRand = tagMTRand;
(tagMTRand as any).__fieldTypes = ["bytes","int32"];
(tagMTRand as any).__fieldNames = ["mt","index"];
(tagMTRand as any).__fieldOffsets = [0,2496];

function m_seedRand(rand: MTRand | null, seed: number): void {
  (__struct_ptr_at(rand, 0)).mt[0] = (((seed) >>> 0) & 4294967295) >>> 0;
  for ((__struct_ptr_at(rand, 0)).index = 1; (__struct_ptr_at(rand, 0)).index < 624; (__struct_ptr_at(rand, 0)).index++) {
    (__struct_ptr_at(rand, 0)).mt[(__struct_ptr_at(rand, 0)).index] = (((Math.imul(((6069) >>> 0), (((__struct_ptr_at(rand, 0)).mt[i32((__struct_ptr_at(rand, 0)).index - 1)]) >>> 0)) >>> 0)) & 4294967295) >>> 0;
  }
}

export function seedRand(seed: number): MTRand {
  let rand = new MTRand();
  m_seedRand(rand, ((seed) >>> 0));
  return rand;
}

export function genRandLong(rand: MTRand | null): number {
  let y = 0;
  if ((((__struct_ptr_at(rand, 0)).index >= 624 || (__struct_ptr_at(rand, 0)).index < 0) ? 1 : 0)) {
    let kk = 0;
    if ((((__struct_ptr_at(rand, 0)).index >= i32(624 + 1) || (__struct_ptr_at(rand, 0)).index < 0) ? 1 : 0)) {
      m_seedRand(rand, ((4357) >>> 0));
    }
    for (kk = 0; kk < i32(624 - 397); kk++) {
      y = ((((((__struct_ptr_at(rand, 0)).mt[kk]) >>> 0) & 2147483648) >>> 0) | (((((__struct_ptr_at(rand, 0)).mt[i32(kk + 1)]) >>> 0) & ((2147483647) >>> 0)) >>> 0)) >>> 0;
      (__struct_ptr_at(rand, 0)).mt[kk] = (((((__struct_ptr_at(rand, 0)).mt[i32(kk + 397)]) >>> 0) ^ ((((y) >>> 0) >>> 1) >>> 0)) >>> 0 ^ ((_static_mag_0[(((y) >>> 0) & ((1) >>> 0)) >>> 0]) >>> 0)) >>> 0;
    }
    for (; kk < i32(624 - 1); kk++) {
      y = ((((((__struct_ptr_at(rand, 0)).mt[kk]) >>> 0) & 2147483648) >>> 0) | (((((__struct_ptr_at(rand, 0)).mt[i32(kk + 1)]) >>> 0) & ((2147483647) >>> 0)) >>> 0)) >>> 0;
      (__struct_ptr_at(rand, 0)).mt[kk] = (((((__struct_ptr_at(rand, 0)).mt[i32(kk + (i32(397 - 624)))]) >>> 0) ^ ((((y) >>> 0) >>> 1) >>> 0)) >>> 0 ^ ((_static_mag_0[(((y) >>> 0) & ((1) >>> 0)) >>> 0]) >>> 0)) >>> 0;
    }
    y = ((((((__struct_ptr_at(rand, 0)).mt[i32(624 - 1)]) >>> 0) & 2147483648) >>> 0) | (((((__struct_ptr_at(rand, 0)).mt[0]) >>> 0) & ((2147483647) >>> 0)) >>> 0)) >>> 0;
    (__struct_ptr_at(rand, 0)).mt[i32(624 - 1)] = (((((__struct_ptr_at(rand, 0)).mt[i32(397 - 1)]) >>> 0) ^ ((((y) >>> 0) >>> 1) >>> 0)) >>> 0 ^ ((_static_mag_0[(((y) >>> 0) & ((1) >>> 0)) >>> 0]) >>> 0)) >>> 0;
    (__struct_ptr_at(rand, 0)).index = 0;
  }
  y = (((__struct_ptr_at(rand, 0)).mt[(__struct_ptr_at(rand, 0)).index++]) >>> 0);
  y = (y ^ ((((y) >>> 0) >>> 11) >>> 0)) >>> 0;
...
export function genRand(rand: MTRand | null): number {
  return ((genRandLong(rand)) / ((Math.trunc(+(4294967295))) >>> 0));
}
